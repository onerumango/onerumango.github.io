...
/* harmony import */ var app_shared_services_theme_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! app/shared/services/theme.service */ "ETNk");
...
class AuthCallbackComponent {
    constructor(spinner, jwtService, router, ls, themeService) {
    ...
    ngOnInit() {
        ...
        let encodedUser = this.ls.getParameterByName('code');
    ...
    parseAccessTokenFromUserObject(user) {
        var _a;
