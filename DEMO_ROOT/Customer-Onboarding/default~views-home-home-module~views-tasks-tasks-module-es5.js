(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~views-home-home-module~views-tasks-tasks-module"], {
    /***/
    "/Pd4":
    /*!**********************************************************!*\
      !*** ./src/app/shared/services/funding-stage.service.ts ***!
      \**********************************************************/

    /*! exports provided: API_URL, FundingStageService */

    /***/
    function Pd4(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "FundingStageService", function () {
        return FundingStageService;
      });
      /* harmony import */
      ...
      var FundingStageService = /*#__PURE__*/function () {
        function FundingStageService(http, showMessageService) {
          var _this = this;

          _classCallCheck(this, FundingStageService);

          this.http = http;
          this.showMessageService = showMessageService;
          this.addEditOrViewsummary = new rxjs__WEBPACK_IMPORTED_MODULE_3__["BehaviorSubject"]('');
          this.isSubmitted = new rxjs__WEBPACK_IMPORTED_MODULE_3__["BehaviorSubject"]('');
          this.fundsEdit = new rxjs__WEBPACK_IMPORTED_MODULE_3__["BehaviorSubject"]('');
        ...
        _createClass(FundingStageService, [{
          key: "addEditOrViewsummaryData",
          value: function addEditOrViewsummaryData(action) {
            this.addEditOrViewsummary.next(action);
          }
        }, {
          key: "isSubmittedResp",
          value: function isSubmittedResp(resp) {
            this.isSubmitted.next(resp);
          }
        }, {
          key: "fundsEditResp",
          value: function fundsEditResp(data) {
            this.fundsEdit.next(data);
          }
        }, {
          key: "saveOrUpdateFundStageDetails",
          value: function saveOrUpdateFundStageDetails(fundStageFormData) {
            console.log("in service");
            return this.http.post("".concat(API_URL, "/fundingStage/saveOrUpdateFunds"), fundStageFormData).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.errorHandler));
            ;
          }
        }, {
          key: "getFundById",
          value: function getFundById(fundId) {
            return this.http.get("".concat(API_URL, "/fundingStage/getFundById/").concat(fundId)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.errorHandler));
            ;
          }
        }, {
          key: "getFundByTellerTrxnRefNo",
          value: function getFundByTellerTrxnRefNo(tellrTrxnRefNo) {
            return this.http.get("".concat(API_URL, "/fundingStage/getFundByTellerTxRefNo/").concat(tellrTrxnRefNo)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.errorHandler));
            ;
          }
        }, {
          key: "getFundByAccountId",
          value: function getFundByAccountId(accountId) {
            return this.http.get("".concat(API_URL, "/fundingStage/getFundByAccId/").concat(accountId)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.errorHandler));
            ;
          }
        }]);
      ...
      FundingStageService.ɵfac = function FundingStageService_Factory(t) {
        return new (t || FundingStageService)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpClient"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_showMessage_show_message_service__WEBPACK_IMPORTED_MODULE_5__["ShowMessageService"]));
      };

      FundingStageService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjectable"]({
        token: FundingStageService,
        factory: FundingStageService.ɵfac,
        providedIn: 'root'
      });
      /*@__PURE__*/

      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](FundingStageService, [{
    ...
    "2ocR":
    /*!*****************************************************************************!*\
      !*** ./src/app/views/home/digital-signing/esign-pop/esign-pop.component.ts ***!
      \*****************************************************************************/

    /*! exports provided: EsignPopComponent */

    /***/
    function ocR(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "EsignPopComponent", function () {
        return EsignPopComponent;
      });
      /* harmony import */
      ...
      var app_shared_services_application_entry_stage_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      ...
      var EsignPopComponent = /*#__PURE__*/function () {
        function EsignPopComponent(data, dialogRef, ls, accountService, apiService, router, appEntryService, cdr) {
          _classCallCheck(this, EsignPopComponent);
        ...
        _createClass(EsignPopComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            ...
            if (this.data.isDone === undefined || this.data.isDone === null) this.isDone = this.data.isSignLater;else this.isDone = this.data.isDone;
          ...
          value: function onSubmit() {
            ...
            if (this.data.screen !== "NewCustomerOnboarding") {
              ...
              this.apiService.getAccountIdByCusId(customerId).subscribe(function (res) {
            ...
            this.apiService.uploadDocument(uploadData).subscribe(function (op) {
              console.log(op);
          ...
          value: function getByAccountId(accountId) {
            ...
            this.appEntryService.getByAccountId(accountId).subscribe(function (resp) {
              console.log('updateStatus :: ', resp);
              _this3.accountdetailsForStatusUpdate = resp;

              _this3.updateAccountStatus(resp);
            });
          }
        }, {
          ...
          value: function updateAccountStatus(accData) {
            ...
            this.appEntryService.updateAccountStatusService(accData).subscribe(function (updateResp) {
      ...
      EsignPopComponent.ɵfac = function EsignPopComponent_Factory(t) {
        return new (t || EsignPopComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_1__["MAT_DIALOG_DATA"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_1__["MatDialogRef"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](app_shared_services_local_store_service__WEBPACK_IMPORTED_MODULE_6__["LocalStoreService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_account_service__WEBPACK_IMPORTED_MODULE_7__["AccountService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](app_shared_services_api_service__WEBPACK_IMPORTED_MODULE_4__["ApiService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](app_shared_services_application_entry_stage_service__WEBPACK_IMPORTED_MODULE_5__["ApplicationEntryStageService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["ChangeDetectorRef"]));
      };

      EsignPopComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        type: EsignPopComponent,
        selectors: [["app-esign-pop"]],
        viewQuery: function EsignPopComponent_Query(rf, ctx) {
          if (rf & 1) {
        ...
        styles: [".sbmt[_ngcontent-%COMP%] {\n  margin-left: 29px;\n  margin: 12px 0px 12px 0px;\n  width: 35%;\n  background-color: #426af5;\n  color: white;\n  border-radius: 55px;\n}\n/*# sourceMappingURL=data:application/json;base64, */"]
      });
      /*@__PURE__*/

      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](EsignPopComponent, [{
          ...
          return [{
            ...
            type: app_shared_services_application_entry_stage_service__WEBPACK_IMPORTED_MODULE_5__["ApplicationEntryStageService"]
          }, {
    ...
    /***/
    function Tczp(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var ChartComponent = /*#__PURE__*/function () {
        ...
        _createClass(ChartComponent, [{
          ...
          value: function ngOnChanges(changes) {
            ...
            */
            function () {
              if (_this5.autoUpdateSeries && Object.keys(changes).filter(
              /**
              * @param {?} c
              * @return {?}
              */
              function (c) {
                ...
                _this5.updateSeries(_this5.series, true);

                return;
              }

              _this5.createElement();
            });
          }
          /**
           * @return {?}
    ...
    "h/GN":
    /*!*********************************************************************************************!*\
      !*** ./src/app/views/home/digital-signing/upload-sign-esign/upload-sign-esign.component.ts ***!
      \*********************************************************************************************/

    /*! exports provided: UploadSignEsignComponent */

    /***/
    function hGN(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "UploadSignEsignComponent", function () {
        return UploadSignEsignComponent;
      });
      /* harmony import */
      ...
      var _esign_pop_esign_pop_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ../esign-pop/esign-pop.component */
      "2ocR");
      /* harmony import */
      ...
      function UploadSignEsignComponent_button_2_Template(rf, ctx) {
        if (rf & 1) {
          var _r5 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "button", 7);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function UploadSignEsignComponent_button_2_Template_button_click_0_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r5);
      ...
      function UploadSignEsignComponent_button_3_Template(rf, ctx) {
        if (rf & 1) {
          var _r7 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "button", 7);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function UploadSignEsignComponent_button_3_Template_button_click_0_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r7);
      ...
      function UploadSignEsignComponent_div_4_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 4);
      ...
      function UploadSignEsignComponent_div_7_div_15_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function UploadSignEsignComponent_div_7_ng_template_16_Template(rf, ctx) {
        if (rf & 1) {
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("src", ctx_r11.imageURL1, _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsanitizeUrl"]);
        }
      }

      function UploadSignEsignComponent_div_7_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](2, "Signatures!");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function UploadSignEsignComponent_div_7_Template_button_click_5_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r13);

            var ctx_r12 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

            return ctx_r12.openPopUp();
          });

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](6, " DIGITAL SIGN ");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function UploadSignEsignComponent_div_7_Template_button_click_8_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r13);
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function UploadSignEsignComponent_div_7_Template_input_change_10_listener($event) {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r13);

            var ctx_r15 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

            return ctx_r15.onFileSelect($event);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](15, UploadSignEsignComponent_div_7_div_15_Template, 2, 1, "div", 19);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](16, UploadSignEsignComponent_div_7_ng_template_16_Template, 1, 1, "ng-template", null, 20, _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplateRefExtractor"]);
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function UploadSignEsignComponent_div_7_Template_button_click_19_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r13);

            var ctx_r16 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

            return ctx_r16.deleteImg();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function UploadSignEsignComponent_div_7_Template_button_click_21_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r13);
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngIf", ctx_r3.imageURL1 == "not_available")("ngIfElse", _r10);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](6);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("disabled", ctx_r3.imageURL1 == "not_available");
        }
      }

      var UploadSignEsignComponent = /*#__PURE__*/function () {
        function UploadSignEsignComponent(data, router, apiService, dialogService, dialog, dialogRef, ls) {
          _classCallCheck(this, UploadSignEsignComponent);
        ...
        _createClass(UploadSignEsignComponent, [{
          ...
          value: function openPopUp(data) {
            ...
            if (!this.show) {
              var dialogRef = this.dialog.open(_esign_pop_esign_pop_component__WEBPACK_IMPORTED_MODULE_6__["EsignPopComponent"], {
                width: '720px',
                disableClose: true,
      ...
      UploadSignEsignComponent.ɵfac = function UploadSignEsignComponent_Factory(t) {
        return new (t || UploadSignEsignComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_1__["MAT_DIALOG_DATA"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](app_shared_services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](app_shared_services_dialogs_dialog_service__WEBPACK_IMPORTED_MODULE_4__["DialogService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_1__["MatDialog"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_1__["MatDialogRef"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](app_shared_services_local_store_service__WEBPACK_IMPORTED_MODULE_5__["LocalStoreService"]));
      };

      UploadSignEsignComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        type: UploadSignEsignComponent,
        selectors: [["app-upload-sign-esign"]],
        viewQuery: function UploadSignEsignComponent_Query(rf, ctx) {
          if (rf & 1) {
        ...
        decls: 8,
        vars: 4,
        consts: [["fxLayout", "row wrap"], ["fxFlex", "100", "fxLayoutAlign", "end center"], ["mat-icon-button", "", 3, "click", 4, "ngIf"], ["fxFlex", "100", 4, "ngIf"], ["fxFlex", "100"], ["fxLayout", "row", "fxLayoutAlign", "center center"], ["fxFlex", "50", "fxFlexOffset", "20px", 4, "ngIf"], ["mat-icon-button", "", 3, "click"], [1, "propic", "text-center"], ["src", "assets/images/esign.png", "alt", ""], ["fxFlex", "50", "fxFlexOffset", "20px"], [1, "text-center", "mt-16", "size"], ["fxLayout", "row", "fxLayoutAlign", "center center", "fxLayoutGap", "20px"], [1, "sub-section-1"], ["mat-raised-button", "", 1, "btn1", 3, "click"], [1, "sub-section-2"], ["type", "file", "accept", "image/*", "required", "", 1, "changeInput", 2, "display", "none", 3, "change"], ["fileInput", ""], [1, "insertDriveImg"], [4, "ngIf", "ngIfElse"], ["showAvatar", ""], ["mat-raised-button", "", "color", "red", 1, "dltbtn", 3, "click"], ["mat-raised-button", "", "color", "primary", 1, "dbtn", 3, "disabled", "click"], ["alt", "No Image", 1, "formImg", 3, "src"], ["required", "", "alt", "", 1, "formImg", 3, "src"]],
        template: function UploadSignEsignComponent_Template(rf, ctx) {
          if (rf & 1) {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "div", 1);

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](2, UploadSignEsignComponent_button_2_Template, 3, 0, "button", 2);

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](3, UploadSignEsignComponent_button_3_Template, 3, 0, "button", 2);

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](4, UploadSignEsignComponent_div_4_Template, 3, 0, "div", 3);

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](5, "div", 4);

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](6, "div", 5);

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](7, UploadSignEsignComponent_div_7_Template, 23, 3, "div", 6);
        ...
        directives: [_angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_7__["DefaultLayoutDirective"], _angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_7__["DefaultFlexDirective"], _angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_7__["DefaultLayoutAlignDirective"], _angular_common__WEBPACK_IMPORTED_MODULE_8__["NgIf"], _angular_material_button__WEBPACK_IMPORTED_MODULE_9__["MatButton"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_10__["MatIcon"], _angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_7__["DefaultFlexOffsetDirective"], _angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_7__["DefaultLayoutGapDirective"]],
        styles: [".scanButton[_ngcontent-%COMP%] {\n  display: inline-block;\n  background-color: white;\n  color: blue;\n  border-color: lightgray;\n  margin-left: 5px;\n  border-style: ridge;\n  margin-top: 0px;\n  border-radius: 55px;\n  height: 35px;\n}\n\n.formImg[_ngcontent-%COMP%] {\n  height: 200px !important;\n  width: 400px !important;\n  background-color: whitesmoke;\n  border-radius: 10%;\n}\n\n.dltbtn[_ngcontent-%COMP%] {\n  margin-left: 52px;\n  margin: 12px 0px 12px 0px;\n  width: 40%;\n  background-color: red;\n  color: white;\n  border-radius: 55px;\n}\n\n.dbtn[_ngcontent-%COMP%] {\n  margin-left: 29px;\n  margin: 12px 0px 12px 0px;\n  width: 40%;\n  background-color: #426af5;\n  color: white;\n  border-radius: 55px;\n}\n\n.size[_ngcontent-%COMP%] {\n  font-size: large;\n  font-weight: 300;\n}\n\n.btn1[_ngcontent-%COMP%] {\n  margin-left: 29px;\n  margin: 12px 0px 12px 0px;\n  width: 100%;\n  background-color: #426af5;\n  color: white;\n  border-radius: 55px;\n}\n/*# sourceMappingURL=data:application/json;base64, */"]
      });
      /*@__PURE__*/

      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](UploadSignEsignComponent, [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
          args: [{
            selector: 'app-upload-sign-esign',
            templateUrl: './upload-sign-esign.component.html',
            styleUrls: ['./upload-sign-esign.component.scss']
          }]
        }], function () {
          return [{
            type: undefined,
    ...
    function ujAs(module, exports, __webpack_require__) {
      ...
      */
      ...
      var C = {
        ...
        "function" == typeof u && (d = u(d, f)), null !== (e = n.config.series[a].data[s]) && void 0 !== e && e.x && (c = n.config.series[a].data[s].x + ":"), "function" == typeof g && (c = g(c, f)), Number.isFinite(r) && Number.isFinite(o) && (l = r, h = o);
        var p = "",
            x = "",
        ...
        return r(t, [{
          ...
          value: function value(t) {
            ...
            for (var x = 0; x < a.x.length; x++) if (g = a.x[x] + d.offsetX, u = a.y[x] + d.offsetY + l, !isNaN(g)) {
              ...
              if ("bubble" === h.config.chart.type) v = y(b = h.globals.seriesZ[s][f]), u = a.y[x], u = new D(this.ctx).centerTextInBubble(u, s, f).y;else void 0 !== b && (v = y(b));
        ...
        return r(t, [{
          ...
          value: function value(t, e, i) {
            ...
            if ("array" === t) for (var o = 0; o < e[i].data.length; o++) Array.isArray(e[i].data[o]) ? (a.push(e[i].data[o][1][0]), s.push(e[i].data[o][1][1])) : (a.push(e[i].data[o]), s.push(e[i].data[o]));else if ("xy" === t) for (var n = function n(t) {
        ...
        return r(t, [{
          ...
          value: function value(t) {
            ...
            if (o) {
              ...
              }, i.e = s, i.tooltipUtil.hasBars() && !r.globals.comboCharts && !i.isBarShared) if (this.tConfig.onDatasetHover.highlightDataSeries) new O(e).toggleSeriesOnHover(s, s.target.parentNode);
            ...
            for (var h = n ? 0 : l.length - 1; n ? h < l.length : h >= 0; n ? h++ : h--) {
              ...
              for (var g = 0, u = e.config.plotOptions.heatmap.shadeIntensity, f = 0; f < l[h].length; f++) {
                var p = this.helpers.getShadeColor(e.config.chart.type, h, f, this.negRange),
                    b = p.color,
                    y = p.colorProps;
                if ("image" === e.config.fill.type) b = new F(this.ctx).fillPath({
                  seriesNumber: h,
                  dataPointIndex: f,
      ...
      Xt = "undefined" != typeof window ? window : void 0, Et = function Et(t, e) {
        ...
        return r(t, [{
          ...
          value: function value() {
            ...
            return new Promise(function (s, r) {
              ...
              "treemap" !== a.config.chart.type && i.axes.drawAxis(a.config.chart.type, o), i.annotations = new P(i), i.annotations.drawImageAnnos(), i.annotations.drawTextAnnos(), "back" === a.config.grid.position && o && a.globals.dom.elGraphical.add(o.el);
              var n = new V(t.ctx, o),
                  l = new q(t.ctx, o);
              ...
              if ("front" === a.config.grid.position && o && a.globals.dom.elGraphical.add(o.el), o && o.elGridBorders && o.elGridBorders.node && a.globals.dom.elGraphical.add(o.elGridBorders), "front" === a.config.xaxis.crosshairs.position && i.crosshairs.drawXCrosshairs(), "front" === a.config.yaxis[0].crosshairs.position && i.crosshairs.drawYCrosshairs(), "front" === a.config.annotations.position && (a.globals.dom.Paper.add(a.globals.dom.elAnnotations), i.annotations.drawAxesAnnotations()), !a.globals.noData) {
...
//# sourceMappingURL=default~views-home-home-module~views-tasks-tasks-module-es5.js.map