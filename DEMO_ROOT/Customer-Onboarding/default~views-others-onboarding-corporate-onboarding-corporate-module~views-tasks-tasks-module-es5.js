(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~views-others-onboarding-corporate-onboarding-corporate-module~views-tasks-tasks-module"], {
    ...
    function aja(module, __webpack_exports__, __webpack_require__) {
      ...
      function ContactInformationComponent_div_11_mat_option_32_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-option", 36);
      ...
      function ContactInformationComponent_div_11_mat_error_46_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-error");
      ...
      function ContactInformationComponent_div_11_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("selectionChange", function ContactInformationComponent_div_11_Template_mat_select_selectionChange_24_listener($event) {
            ...
            return ctx_r23.getStateName($event.value, i_r7);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("selectionChange", function ContactInformationComponent_div_11_Template_mat_select_selectionChange_31_listener($event) {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r24);
            ...
            return ctx_r25.getCityName($event.value, i_r7);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("keypress", function ContactInformationComponent_div_11_Template_input_keypress_45_listener($event) {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r24);

            var ctx_r26 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

            return ctx_r26._keyPress($event);
          })("keyup", function ContactInformationComponent_div_11_Template_input_keyup_45_listener($event) {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r24);
        ...
        _createClass(ContactInformationComponent, [{
          ...
          value: function getCoropratedetails(id) {
            ...
            this.apiService.getCoropratedetails(id).subscribe(function (details) {
              ...
              _this5.getStateName(details.customerInfo[0].userAddress[0].country, 0);

              _this5.getCityName(details.customerInfo[0].userAddress[0].state, 0);
      ...
      var ProofOfIdentityComponent = /*#__PURE__*/function () {
        function ProofOfIdentityComponent(router, formBuilder, ls, corporateService, cdr, snack, apiService) {
          ...
          this.isDocumentOptionDisabled = function (value) {
            return _this7.selectedOptions.includes(value);
          };
        ...
        _createClass(ProofOfIdentityComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.corporateService.corporateAccountIdVal.subscribe(function (corporateId) {
              console.log('corporateId :: ', _this8.corporateId = corporateId);

              _this8.proofOfIdentityFormGroup.get('corporateId').setValue(corporateId);

              if (_this8.corporateId) {
                _this8.getCoropratedetails(_this8.corporateId);
              }
            });
          ...
          value: function changeValue2(value, index) {
            ...
            if (this.selectedDocumentTypes[index]) {
              this.selectedOptions = this.selectedOptions.filter(function (val) {
                return val !== _this10.selectedDocumentTypes[index];
              });
            }
          ...
          value: function onSubmit(directorFormGroup) {
            ...
            this.corporateService.saveOrUpdateCorporateAccountInfo(obj).subscribe(function (data) {
              ...
              if (data != null) {
                _this11.snack.open("Proof of identity saved" + ' !', 'OK', {
                  duration: 4000,
                  verticalPosition: 'top',
                  horizontalPosition: 'right'
                });
                ...
                _this11.snack.open('Not able to connect to server!', 'INTERNAL SERVER ERROR', {
                  duration: 4000,
                  verticalPosition: 'top',
                  horizontalPosition: 'right'
                });
              ...
              _this11.snack.open("".concat(error.error.message, " "), 'OK', {
                duration: 4000,
                verticalPosition: 'top',
                horizontalPosition: 'right'
              });
          ...
          value: function getCoropratedetails(e) {
            ...
            this.apiService.getCoropratedetails(e).subscribe(function (details) {
              ...
              if (details) {
                _this12.proofOfIdentityFormGroup.patchValue(details);
              }
            });
          }
        }, {
        ...
        _createClass(OnboardingCorporateMainComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.formService.getDisableMatTab().subscribe(function (resp) {
              ...
              _this13.tabIndex = resp.index;

              if (_this13.ls.getItem('corporateTabIndex')) {
                _this13.tabIndex = _this13.ls.getItem('corporateTabIndex');
              } else {
                _this13.tabIndex = 0;
              }

              _this13.formService.getFinishFlag().subscribe(function (resp) {
                console.log("finish flag", resp.finishFlag);

                _this13.assignValueFinish(resp.finishFlag);
              });

              if (resp.index === 0) {
                _this13.assignValuesForTab2(_this13.tabIndex);
              }
              ...
              if (resp.index === 2) {
                _this13.assignValuesForTab3(_this13.tabIndex);
              }

              if (resp.index === 3) {
                _this13.assignValuesForTab4(_this13.tabIndex);
              }

              if (resp.index === 4) {
                _this13.assignValuesForTab5(_this13.tabIndex);
    ...
    function KaOm(module, __webpack_exports__, __webpack_require__) {
      ...
      function CreateDirectorComponent_div_154_mat_option_37_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-option", 63);
      ...
      function CreateDirectorComponent_div_154_mat_error_38_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-error");
      ...
      function CreateDirectorComponent_div_154_mat_option_49_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-option", 63);
      ...
      function CreateDirectorComponent_div_154_mat_error_50_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-error");
      ...
      function CreateDirectorComponent_div_154_mat_error_57_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-error");
      ...
      function CreateDirectorComponent_div_154_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("selectionChange", function CreateDirectorComponent_div_154_Template_mat_select_selectionChange_26_listener($event) {
            ...
            return ctx_r73.getStateName($event.value);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("selectionChange", function CreateDirectorComponent_div_154_Template_mat_select_selectionChange_34_listener($event) {
            _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵrestoreView"](_r74);

            var ctx_r75 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"]();

            return ctx_r75.getCityName($event.value);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("keypress", function CreateDirectorComponent_div_154_Template_input_keypress_56_listener($event) {
            _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵrestoreView"](_r74);

            var ctx_r76 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"]();

            return ctx_r76._keyPress($event);
          })("keyup", function CreateDirectorComponent_div_154_Template_input_keyup_56_listener($event) {
            _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵrestoreView"](_r74);

            var ctx_r77 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"]();

            return ctx_r77.isAllSameDigit($event);
          });
      ...
      function CreateDirectorComponent_div_190_mat_option_20_Template(rf, ctx) {
        ...
        if (rf & 2) {
          var countryOfIssue_r83 = ctx.$implicit;
      ...
      function CreateDirectorComponent_div_190_Template(rf, ctx) {
        if (rf & 1) {
          var _r85 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵgetCurrentView"]();
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("keypress", function CreateDirectorComponent_div_190_Template_input_keypress_10_listener($event) {
            ...
            return ctx_r84.omit_special_char($event);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function CreateDirectorComponent_div_190_Template_button_click_26_listener() {
            ...
            ctx_r86.addDirector(ctx_r86.createDirectorFormGroup.value, item_r78);
            return ctx_r86.openClose("CLOSE");
          });
      ...
      function CreateDirectorComponent_mat_card_191_Template(rf, ctx) {
        if (rf & 1) {
          var _r91 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵgetCurrentView"]();
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function CreateDirectorComponent_mat_card_191_Template_button_click_15_listener() {
            ...
            return ctx_r90.editDirector(ctx_r90.item);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function CreateDirectorComponent_mat_card_191_Template_button_click_18_listener() {
            ...
            return ctx_r92.deleteDirector(ctx_r92.item);
          });
        ...
        if (rf & 2) {
          var _r88 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵreference"](6);
      ...
      var CreateDirectorComponent = /*#__PURE__*/function () {
        ...
        _createClass(CreateDirectorComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.corporateService.corporateAccountIdVal.subscribe(function (corporateId) {
              _this14.corporateId = corporateId;
              console.log('corporateId :: ', _this14.corporateId);

              _this14.createDirectorFormGroup.get('corporateId').setValue(corporateId);

              if (_this14.corporateId) {
                _this14.getCoropratedetails(_this14.corporateId);
              } else {
                if (_this14.ls.getItem('corporateId')) {
                  _this14.getCoropratedetails(_this14.ls.getItem('corporateId'));
                }
              }
            });
            this.corporateService.getnoOfDirectors().subscribe(function (noOfDir) {
              _this14.noOfDir = noOfDir;
              console.log('noOfDir:: ', noOfDir);

              if (_this14.noOfDir && _this14.item > 1) {
                _this14.disabled = false;
                _this14.isChecked = false;
                _this14.disabledToggle = false;
              }
            });
            ...
            this.createDirectorFormGroup.valueChanges.subscribe(function (data) {
              if (data.firstName != '') {
                _this14.profileImage = "available";

                _this14.createInititals(data.firstName);
              }
              ...
              if (data.lastName != '') {
                ...
                _this14.createInititals(data.lastName);
              }
            });
          }
        }, {
          ...
          value: function getCountryName(key) {
            ...
            this.apiService.getAllCountries().subscribe(function (data) {
              for (var i = 0; i < data.length; i++) {
                if (data[i].authStatus === 'A') {
                  _this15.arrayCountry.push(data[i].countryName);
                }
              }
            });
          }
          ...
          value: function onSelectionResidance(data) {
            ...
            this.apiService.countryFlaglists(data).subscribe(function (value) {
              ...
              _this16.Currency = value.currencyCode.toLowerCase();
              console.log(_this16.Currency);
            });
          }
        }, {
          ...
          value: function onSelectionCitizionship(data) {
            ...
            this.apiService.countryFlaglists(data).subscribe(function (value) {
              console.log(value.currencyCode);
              _this17.currencyCode = value.currencyCode.toLowerCase();
              console.log(_this17.currencyCode);
            });
          }
        }, {
          key: "getStateName",
          value: function getStateName(country) {
            ...
            this.apiService.getAllCountries().subscribe(function (data) {
              for (var i = 0; i < data.length; i++) {
                if (data[i].countryName == country) {
                  _this18.apiService.getStateByCountryId(data[i].id).subscribe(function (resp) {
                    _this18.arrayState = resp;
                  });
          ...
          value: function getCityName(state) {
            ...
            // console.log(state)
            this.apiService.getDropDownValues1("city", state).subscribe(function (data) {
              _this19.arrayCity = data; // console.log("-->", this.arrayCity)
            });
          }
        }, {
          ...
          value: function getResidenceDetails(key) {
            ...
            this.apiService.getDropDownValues(key).subscribe(function (data) {
              _this20.arrayResidence = data; // console.log('arrayResidence :: ', this.arrayResidence);
            });
          }
        }, {
          key: "_keyPress",
          ...
          value: function getCoropratedetails(id) {
            ...
            this.apiService.getCoropratedetails(id).subscribe(function (details) {
              ...
              _this21.createDirectorFormGroup.reset();

              if (_this21.noOfDir <= _this21.totalDir) {
                for (var i = 0; i < details.customerInfo.length; i++) {
                  _this21.fetchByCif(details.customerInfo[i].cifNumber);

                  if (details) {
                    console.log("jnkhk");

                    _this21.getStateName(details.customerInfo[i].userAddress[0].country);

                    _this21.getCityName(details.customerInfo[i].userAddress[0].state);
                    ...
                    console.log(details.customerInfo[i], _this21.createDirectorFormGroup);

                    _this21.createDirectorFormGroup.patchValue(details.customerInfo[i]);
                  }
                }
              }
            });
          ...
          value: function fetchByCif(cifNumber) {
            ...
            if (cifNumber) {
              ...
              this.timer = setTimeout(function () {
                _this22.appApiService.fetchByCif(cifNumber).subscribe(function (res) {
                  ...
                  _this22.ls.setItem('KycValues', kycValues); // this.autocomplete.openPanel();


                  if (res) {
                    _this22.showAutocomplete = true;
                    _this22.customerInfoList = res.customerInfoList; // this.customerInfoList[0].userAddress[0].zipcode = res.customerInfoList[0].userAddress[0].zipCode;
                  }
                  ...
                  if (_this22.customerInfoList[0].citizenship != null) {
                    _this22.onSelectionCitizionship(_this22.customerInfoList[0].citizenship);
                  }

                  if (_this22.customerInfoList[0].countryOfResidence != null) {
                    _this22.onSelectionResidance(_this22.customerInfoList[0].countryOfResidence);
                    ...
                    _this22.snack.open('Kindly Enter Valid CifNumber to proceed', 'OK', {
                      duration: 4000,
                      verticalPosition: 'top',
                      horizontalPosition: 'right'
                    }); // this.customerInfoList = [];
            ...
            this.corporateService.saveOrUpdateCorporateAccountInfo(coporateObjModel).subscribe(function (data) {
              ...
              if (data != null) {
                ...
                if (data.customerInfo != null && data.customerInfo[0].cifNumber != null) {
                  _this23.cifNumber = data.customerInfo[0].cifNumber;
                }

                _this23.snack.open("Director ".concat(_this23.item, " profile created") + ' !', 'OK', {
                  duration: 4000,
                  verticalPosition: 'top',
                  horizontalPosition: 'right'
                });

                _this23.cdr.markForCheck(); // if (this.noOfDir >= 1) {


                if (_this23.noOfDir <= 1) {
                  _this23.next();
                }
              } else {
        ...
        _createClass(OnboradingPrimaryComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.route.queryParamMap.subscribe(function (params) {
              _this25.imageURL = 'not_available';
              console.log(params.get('index'));

              if (params.get('index')) {
                _this25.corporateService.sendDisableMatTab({
                  index: params.get('index')
                });

                _this25.corporateService.setFinishFlag({
                  finishFlag: false
                });

                _this25.resetCorprateOnboarding();

                _this25.onboardingPrimary.reset({
                  companyName: '',
                  corporateId: '',
                  category: '',
                  country: ''
          ...
          value: function profileChange(event) {
            ...
            reader.onload = function (event2) {
              ...
              _this27.imageURL = reader.result;
              _this27.disableDeletebtn = true; // this.profileImageExist = true;
            };
          ...
          value: function getCoropratedetails(e) {
            ...
            this.apiService.getCoropratedetails(e).subscribe(function (details) {
              ...
              if (details) {
                _this28.ls.setItem('totalCust', details.customerInfo.length);
              }

              if (details.corporateStatus === 'APPROVED') {
                _this28.onboardingPrimary.patchValue(details);

                _this28.imageURL = details.profileImage;
                _this28.imageURL != "not_available" ? _this28.disableDeletebtn = true : false;
                _this28.corporateDetails = details;

                _this28.ls.removeItem('EDIT-CORPORATEID');
              } // if (details) {
              // }
              // else if (
              ...
              // }
                  ...
                  _this28.snack.open('Please Enter Approved Corporate Id Number', 'Ok', {
                    duration: 4000,
                    verticalPosition: 'top',
                    horizontalPosition: 'right'
                  });
          ...
          value: function onSubmit(onboardingPrimary) {
            ...
            this.corporateService.saveOrUpdateCorporateAccountInfo(onboardingPrimary).subscribe(function (data) {
              ...
              console.log('data :: ', data);
              _this29.corporateId = data.corporateId;

              if (data != null) {
                _this29.ls.setItem('corporateId', data.corporateId);

                _this29.corporateService.sendCorporateAccountId(data.corporateId);

                _this29.snack.open('Basic Information Saved' + ' !', 'OK', {
                  duration: 4000,
                  verticalPosition: 'top',
                  horizontalPosition: 'right'
                });
                ...
                _this29.updateCorporateStatus(data.corporateId);

                if (_this29.profilePicture) {
                  var profileUpload = {};
                  profileUpload.documentName = 'Profile';
                  profileUpload.documentType = 1;
                  profileUpload.fileType = (_a = _this29.profilePicture) === null || _a === void 0 ? void 0 : _a.type;
                  profileUpload.fileName = (_b = _this29.profilePicture) === null || _b === void 0 ? void 0 : _b.name;
                  profileUpload.corporateId = data.corporateId;
                  console.log(profileUpload);
                  var uploadData = new FormData();
                  uploadData.append('data', JSON.stringify(profileUpload));
                  uploadData.append('file', _this29.profilePicture);

                  _this29.apiService.uploadCorporateDocument(uploadData).subscribe(function (response) {}, function (err) {
                ...
                _this29.snack.open('Not able to connect to server!', 'INTERNAL SERVER ERROR', {
                  duration: 4000,
                  verticalPosition: 'top',
                  horizontalPosition: 'right'
                });
              ...
              (function (error) {
                ...
                _this29.snack.open("".concat(error.error.message, " "), 'OK', {
                  duration: 4000,
                  verticalPosition: 'top',
                  horizontalPosition: 'right'
                });
          ...
          value: function getProfileImage(customerId, document_type) {
            ...
            this.apiService.getCustomerDocuments(customerId, document_type).subscribe(function (data) {
              ...
              if (data.length > 0) {
                _this30.profileId = data[0].id;
                _this30.imageURL = data[0].fileUrl;
              }
            });
          }
        }, {
          ...
          value: function deleteProfileImg() {
            ...
            this.apiService.delCorporateCustDoc(this.corporateId, 'Profile', docObj.id).subscribe(function (data) {
              _this31.snack.open('Profile Image Deleted Successfully', 'OK', {
                duration: 4000,
                verticalPosition: 'top',
                horizontalPosition: 'right'
              });
          ...
          value: function getCountryName(key) {
            ...
            this.apiService.getAllCountries().subscribe(function (data) {
              for (var i = 0; i < data.length; i++) {
                if (data[i].authStatus === 'A') {
                  _this32.countryArr.push(data[i].countryName);
                }
              }
            });
          }
    ...
    function qazE(module, __webpack_exports__, __webpack_require__) {
      ...
      var OtherInfoCorporateComponent = /*#__PURE__*/function () {
        function OtherInfoCorporateComponent(router, formBuilder, dialogService, corporateService, cdr, snack, ls, apiService) {
          ...
          this.isDocumentOptionDisabled = function (value) {
            return _this33.selectedOptions.includes(value);
          };
        ...
        _createClass(OtherInfoCorporateComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.corporateService.corporateAccountIdVal.subscribe(function (corporateId) {
              _this34.corporateId = corporateId;
              console.log('corporateId :: ', _this34.corporateId);

              _this34.otherInfoFormGroup.get('corporateId').setValue(corporateId);

              if (_this34.corporateId) {
                _this34.getCoropratedetails(_this34.corporateId);
              }
            });
            this.getDoc();
            this.addDocument();
          ...
          value: function getCountryName(key) {
            ...
            this.apiService.getAllCountries().subscribe(function (data) {
              for (var i = 0; i < data.length; i++) {
                if (data[i].authStatus === 'A') {
                  _this35.arrayCountry.push(data[i].countryName);
                }
              }
            });
          }
          ...
          value: function getStateName(country) {
            ...
            this.apiService.getAllCountries().subscribe(function (data) {
              for (var i = 0; i < data.length; i++) {
                if (data[i].countryName == country) {
                  _this36.apiService.getStateByCountryId(data[i].id).subscribe(function (resp) {
                    _this36.arrayState = resp;
                  });
          ...
          value: function getCityName(state) {
            ...
            console.log(state);
            this.apiService.getDropDownValues1("city", state).subscribe(function (data) {
              _this37.arrayCity = data;
              console.log("-->", _this37.arrayCity);
            });
          }
        }, {
          ...
          value: function onOtherDocSelect(files, idx, fileName) {
            ...
            reader.onload = function (event2) {
              ...
              console.log("jaskd", _this38.otherInfoFormGroup.get('corporateDocs')['controls'][idx].controls.fileData);

              _this38.otherInfoFormGroup.get('corporateDocs')['controls'][idx].controls.fileData.setValue(reader.result);
            };
          ...
          value: function getCoropratedetails(e) {
            ...
            this.apiService.getCoropratedetails(e).subscribe(function (details) {
              ...
              _this39.nameOfDocument = details.corporateDocs;
              ...
              for (var i = 0; i < details.corporateDocs.length; i++) {
                if (details.corporateDocs.length > 1 && details.corporateDocs[i].documentName !== "profile") {
                  _this39.otherInfoFormGroup.patchValue(details);

                  _this39.otherInfoFormGroup.controls.corporateDocs['controls'][i].controls.documentType.setValue(_this39.documentTypeList[i + 1]);

                  _this39.otherInfoFormGroup.controls.corporateDocs['controls'][i].controls.fileData.setValue(details.corporateDocs[i + 1].fileUrl);
                }
              }

              _this39.getStateName(details.corporateAddress[0].country);

              _this39.getCityName(details.corporateAddress[0].state);
            });
          }
        }, {
          key: "onSubmit",
          value: function onSubmit(otherInfoFormGroup) {
            ...
            this.corporateService.saveOrUpdateCorporateAccountInfo(obj).subscribe(function (data) {
              ...
              if (data != null) {
                for (var i = 0; i < _this40.otherInfoFormGroup.get('corporateDocs').value.length; i++) {
                  if (_this40.otherDocumentArray.length > 0) {
                    var documentToBeUploaded = {};
                    documentToBeUploaded.documentName = _this40.otherInfoFormGroup.get('corporateDocs').value[i].documentType;
                    documentToBeUploaded.documentType = 2;
                    documentToBeUploaded.fileType = _this40.otherDocumentArray[i].type;
                    documentToBeUploaded.fileName = _this40.otherDocumentArray[i].name;
                    documentToBeUploaded.corporateId = data.corporateId;
                    documentToBeUploaded.id = _this40.otherDocumentArray[i].id;
                    var uploadData = new FormData();
                    uploadData.append('data', JSON.stringify(documentToBeUploaded));
                    uploadData.append('file', _this40.otherDocumentArray[i]);

                    _this40.apiService.uploadCorporateDocument(uploadData).subscribe(function (resp) {
                      console.log(resp);
                    });
                  }
                }

                _this40.updateCorporateStatus(data.corporateId);

                _this40.dialogService.customerOnboardingSuccessDialogue('CORPORATE', _this40.corporateId);

                _this40.otherInfoFormGroup.reset();

                _this40.ls.removeItem('corporateId');

                _this40.ls.removeItem('corporateTabIndex');

                _this40.corporateService.setnoOfDirectors(null); // this.snack.open(`Other information saved`+ ' !', 'OK', {
                //   duration: 4000,
                //   verticalPosition: 'top',
                //   horizontalPosition: 'right'
                // });
                ...
                _this40.snack.open('Not able to connect to server!', 'INTERNAL SERVER ERROR', {
                  duration: 4000,
                  verticalPosition: 'top',
                  horizontalPosition: 'right'
                });
              ...
              _this40.snack.open("".concat(error.error.message, " "), 'OK', {
                duration: 4000,
                verticalPosition: 'top',
                horizontalPosition: 'right'
              });
          ...
          value: function changeValue(value, index) {
            ...
            if (this.selectedDocumentTypes[index]) {
              this.selectedOptions = this.selectedOptions.filter(function (val) {
                return val !== _this42.selectedDocumentTypes[index];
              });
            }
        ...
        _createClass(DirectorDetailsComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.directorFormGroup.valueChanges.subscribe(function (data) {
              ...
              _this43.corporateService.setnoOfDirectors(data.noOfDirector);
            });
            this.corporateService.getfinishSave().subscribe(function (disSave) {
              // console.log('disSave :: ',disSave);
              if (_this43.totalCust != null) {
                _this43.directorFormGroup.get('noOfDirector').setValue(_this43.totalCust);
              }
              ...
              if (disSave.length > 0) {
                ...
                if (count == disSave.length) {
                  _this43.disabledBtn = false;
                } else {
                  _this43.disabledBtn = true;
                }
              }
            });
          }
