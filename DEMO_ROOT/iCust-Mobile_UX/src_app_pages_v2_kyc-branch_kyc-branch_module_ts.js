...
/* harmony import */ var src_app_components_kyc_modal_kyc_modal_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/components/kyc-modal/kyc-modal.component */ 56215);
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @angular/common/http */ 28784);
/* harmony import */ var _kyc_branch_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./kyc-branch.service */ 8813);
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @angular/forms */ 90587);
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @angular/router */ 52816);
/* harmony import */ var src_app_components_duplication_duplication_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/components/duplication/duplication.component */ 10473);
/* harmony import */ var src_app_components_otp_verification_popup_otp_verification_popup_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/components/otp-verification-popup/otp-verification-popup.component */ 6987);
...
/* harmony import */ var src_app_components_rekyc_popup_rekyc_popup_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/components/rekyc-popup/rekyc-popup.component */ 65573);
/* harmony import */ var src_app_components_verification_done_verification_done_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/components/verification-done/verification-done.component */ 86848);
/* harmony import */ var src_app_components_capture_image_capture_image_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! src/app/components/capture-image/capture-image.component */ 85652);
...
let KycBranchPage = class KycBranchPage {
    ...
    openDuplicationDiaglogue(customerData) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_12__.__awaiter)(this, void 0, void 0, function* () {
            let modal = yield this.modalCtrl.create({
                component: src_app_components_duplication_duplication_component__WEBPACK_IMPORTED_MODULE_4__.DuplicationComponent,
    ...
    openSuccessDialog() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_12__.__awaiter)(this, void 0, void 0, function* () {
            let modal = yield this.modalCtrl.create({
                component: src_app_components_rekyc_popup_rekyc_popup_component__WEBPACK_IMPORTED_MODULE_6__.RekycPopupComponent,
            });
            modal.onDidDismiss().then((res) => {
                console.log('Getting Back Data', res);
                this.saveCustomerData();
    ...
    openDialog() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_12__.__awaiter)(this, void 0, void 0, function* () {
            let modal = yield this.modalCtrl.create({
                component: src_app_components_kyc_modal_kyc_modal_component__WEBPACK_IMPORTED_MODULE_2__.KycModalComponent,
                componentProps: {
                    data: '',
                    screen: 'branch',
                },
            ...
            modal.onDidDismiss().then((res) => {
                ...
                if ((_a = res === null || res === void 0 ? void 0 : res.data) === null || _a === void 0 ? void 0 : _a.customerData) {
                    ...
                    let doc = JSON.parse(localStorage.getItem("UploadedDocument"));
                    if (doc) {
                        this.patchUploadedDocument(doc, doc === null || doc === void 0 ? void 0 : doc.frontSide, doc === null || doc === void 0 ? void 0 : doc.backSide);
                    }
                    if ((_c = this.basicInfoData) === null || _c === void 0 ? void 0 : _c.customerId) {
                        this.getCustomerDocuments();
                    }
                }
            });
    ...
    patchUploadedDocument(data, frontSide, backSide) {
        this.documents().at(0).patchValue(data);
        this.documentPages(0)
            .at(0)
            .get('fileUrl')
            .patchValue(frontSide);
        this.documentPages(0)
            .at(1)
            .get('fileUrl')
            .patchValue(backSide);
    ...
    openVerificationDone() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_12__.__awaiter)(this, void 0, void 0, function* () {
            let modal = yield this.modalCtrl.create({
                component: src_app_components_verification_done_verification_done_component__WEBPACK_IMPORTED_MODULE_7__.VerificationDoneComponent,
                componentProps: {},
            });
            modal.onDidDismiss().then(res => {
    ...
    openCamera(scanType) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_12__.__awaiter)(this, void 0, void 0, function* () {
            ...
            let modal = yield this.modalCtrl.create({
                component: src_app_components_capture_image_capture_image_component__WEBPACK_IMPORTED_MODULE_8__.CaptureImageComponent,
                componentProps: {
    ...
    onFileSelect(e, docside, documentIndex, index, documentName) {
        ...
        const data = {
            ...
            documentSide: this.documentPages(documentIndex).at(index).get('documentSide').value,
            idNumber: '',
            name: '',
            dob: '',
        };
    ...
    openOtpModal(source_key, source_value) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_12__.__awaiter)(this, void 0, void 0, function* () {
            let modal = yield this.modalCtrl.create({
                component: src_app_components_otp_verification_popup_otp_verification_popup_component__WEBPACK_IMPORTED_MODULE_5__.OtpVerificationPopup,
                componentProps: {
    ...
    getCustomerDocuments() {
        this.documentSide.map(doc => {
            this.branchService.fetchCustomerDocuments(this.basicInfoData.customerId, doc).subscribe((res) => {
                ...
                console.log(res);
                if (res) {
                    let frontArray = res.filter(r => (r.verificationType =  true && (r === null || r === void 0 ? void 0 : r.documentSide) == 0));
                    let backArray = res.filter(r => (r.verificationType =  true && (r === null || r === void 0 ? void 0 : r.documentSide) == 1));
                    this.patchUploadedDocument(frontArray[frontArray.length - 1], (_a = frontArray[frontArray.length - 1]) === null || _a === void 0 ? void 0 : _a.fileUrl, (_b = backArray[backArray.length - 1]) === null || _b === void 0 ? void 0 : _b.fileUrl);
                }
            });
        });
    }
...
KycBranchPage.ctorParameters = () => [
    ...
    { type: _kyc_branch_service__WEBPACK_IMPORTED_MODULE_3__.BranchService },
