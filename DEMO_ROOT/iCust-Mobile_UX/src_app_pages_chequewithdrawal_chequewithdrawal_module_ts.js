...
let ChequewithdrawalPage = class ChequewithdrawalPage {
    ...
    selectCurrencyCode(currency) {
        ...
        const countryCode = this.currencies.find(x => x.currencyCode.includes(currency)).countryCode;
        this.selectedCountryCode = countryCode;
        console.log(this.selectedCountryCode, currencyCode);
        ...
        if ((_b = (_a = this.routerData) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.transactionCurrency) {
            this.slideOneForm.controls.transactionCurrency.patchValue(this.routerData.data.transactionCurrency);
        }
        else {
            this.slideOneForm.controls.transactionCurrency.patchValue(currencyCode);
        }
    }
    savingAccountFun(filteredResponseSavingAccount) {
        ...
        if (this.routerData) {
            this.defaultTransCurrency = (_b = (_a = this.routerData) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.transactionCurrency;
            this.slideOneForm
                .get('accountNumber').patchValue((_d = (_c = this.routerData) === null || _c === void 0 ? void 0 : _c.data) === null || _d === void 0 ? void 0 : _d.accountNumber);
            this.slideOneForm
                .get('transactionAmount').patchValue((_f = (_e = this.routerData) === null || _e === void 0 ? void 0 : _e.data) === null || _f === void 0 ? void 0 : _f.transactionAmount);
            this.slideOneForm
                .get('totalTransactionAmount').patchValue((_h = (_g = this.routerData) === null || _g === void 0 ? void 0 : _g.data) === null || _h === void 0 ? void 0 : _h.totalTransactionAmount);
            this.slideOneForm
                .get('transactionCurrency').patchValue((_k = (_j = this.routerData) === null || _j === void 0 ? void 0 : _j.data) === null || _k === void 0 ? void 0 : _k.transactionCurrency);
            this.slideOneForm
            ...
            this.slideOneForm
                .get('chequeNumber').patchValue((_p = (_o = this.routerData) === null || _o === void 0 ? void 0 : _o.data) === null || _p === void 0 ? void 0 : _p.chequeNumber);
            this.slideOneForm
                .get('transactionDate').patchValue((_r = (_q = this.routerData) === null || _q === void 0 ? void 0 : _q.data) === null || _r === void 0 ? void 0 : _r.transactionDate);
            this.slideOneForm
                .get('transactionTime').patchValue((_t = (_s = this.routerData) === null || _s === void 0 ? void 0 : _s.data) === null || _t === void 0 ? void 0 : _t.transactionTime);
        }
