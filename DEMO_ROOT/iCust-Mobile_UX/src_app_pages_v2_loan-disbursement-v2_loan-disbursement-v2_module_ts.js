...
let LoanDisbursementV2Page = class LoanDisbursementV2Page {
    ...
    balanceCheck(event) {
        ...
        this.currentBalance = (_a = this.filteredLoanAccount) === null || _a === void 0 ? void 0 : _a.sanctionedAmount;
