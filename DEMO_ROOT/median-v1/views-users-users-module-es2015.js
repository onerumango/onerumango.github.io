...
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js");
/* harmony import */ var _users_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../users.service */ "./src/app/views/users/users.service.ts");
...
/* harmony import */ var _users_dto__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../users.dto */ "./src/app/views/users/users.dto.ts");
/* harmony import */ var _security_policy_security_policy_security_policy_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../security-policy/security-policy/security-policy.service */ "./src/app/views/security-policy/security-policy/security-policy.service.ts");
/* harmony import */ var _roles1_roles_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../roles1/roles.service */ "./src/app/views/roles1/roles.service.ts");
...
let CreateUserComponent = class CreateUserComponent {
    constructor(userApi, fb, roleService, apiService, ref, snackBar, formBuilder) {
        ...
        if (this.userObj.intime > this.userObj.outtime) {
            ...
            this.userApi.createUserService(this.userObj).subscribe(data => {
                ...
                if (this.statusFlag === true) {
                    sweetalert2__WEBPACK_IMPORTED_MODULE_5___default.a.fire('You Created the user ');
    ...
    getUserAuditData() {
        this.userApi.getUserAuditService(this.userObj.userId).subscribe(data => {
            this.userObj = data;
            //console.log("dev code user audit: " + this.userObj.userId);
            //console.log(this.userObj);
            if (this.userObj === undefined || this.userObj === null) {
                ...
                if (this.userObj.verifiedStatus === 'U') {
                    this.userObj.verifiedStatus = 'UNAUTHORIZED';
                }
                if (this.userObj.verifiedStatus === 'A') {
                    this.userObj.verifiedStatus = 'AUTHORIZED';
                }
                /*
                */
                if (this.userObj.verifiedOnce === 'N') {
                    this.userObj.verifiedOnce = 'NO';
                }
                if (this.userObj.verifiedOnce === 'Y') {
                    this.userObj.verifiedOnce = 'YES';
                }
                /**
                 * setting record status
                 */
                if (this.userObj.recordStatus === 'O') {
                    this.userObj.recordStatus = 'OPEN';
                }
                if (this.userObj.recordStatus === 'C') {
                    this.userObj.recordStatus = 'CLOSED';
                }
            }
        });
    }
    getAllRolesNames() {
        this.roleService.getAllRoles().subscribe(data => {
            ...
            // //console.log('all rolenames below');
    ...
    onClickOfAuthOfUsers() {
        ...
        this.userApi.onClickOfAuthOfUsers(this.userObj)
            .subscribe(dataOfUsersFromBackend => {
            //console.log(dataOfUsersFromBackend);
        });
    }
    onClickOfOpenOfUsers() {
        //console.log("on clcik of open");
    }
    onClickOfCloseOfUSers() {
        //console.log("on clcik of Close");
    }
    fn(userId) {
...
CreateUserComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./create-user.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/views/users/create-user/create-user.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./create-user.component.css */ "./src/app/views/users/create-user/create-user.component.css")).default]
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_users_service__WEBPACK_IMPORTED_MODULE_3__["UsersService"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"], _roles1_roles_service__WEBPACK_IMPORTED_MODULE_8__["RoleService"],
        _security_policy_security_policy_security_policy_service__WEBPACK_IMPORTED_MODULE_7__["SecurityPolicyService"],
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectorRef"],
        _angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_4__["MatSnackBar"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"]])
], CreateUserComponent);
...
/* harmony import */ var _users_dto__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../users.dto */ "./src/app/views/users/users.dto.ts");
...
/* harmony import */ var _security_policy_security_policy_security_policy_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../security-policy/security-policy/security-policy.service */ "./src/app/views/security-policy/security-policy/security-policy.service.ts");
...
let ModifyUserComponent = class ModifyUserComponent {
    constructor(userApi, snackBar, route, cdr, router, roleService, apiService, fb, ref) {
        this.userApi = userApi;
        this.snackBar = snackBar;
        this.route = route;
        this.cdr = cdr;
    ...
    ngOnInit() {
        ...
        this.route.queryParams.subscribe(params => {
            ...
            this.modifyUserObject.email = params.email;
            this.modifyUserObject.mobile = params.mobile;
            this.modifyUserObject.ldapUserId = params.ldapUserId;
            this.modifyUserObject.verifiedStatus = params.authStatus;
            this.modifyUserObject.recordStatus = params.recordStatus;
            this.modifyUserObject.creatorId = params.creatorId;
            this.modifyUserObject.emailNotification = params.emailNotification;
            this.modifyUserObject.maintAllowed = params.maintAllowed;
            this.modifyUserObject.smsNotification = params.smsNotification;
            this.modifyUserObject.userAccessOption = params.userAccessOption;
            this.modifyUserObject.newRoleForUser = params.newRoleForUser;
            this.modifyUserObject.creatorDtStamp = params.creatorDtStamp;
            this.modifyUserObject.verifierId = params.verifierId;
            this.modifyUserObject.verifierDtStamp = params.verifierDtStamp;
            this.modifyUserObject.encryptedPassword = params.encryptedPassword;
            this.modifyUserObject.updatedBy = params.updatedBy;
            this.modifyUserObject.verifiedOnce = params.fristTimeAuth;
            this.modifyUserObject.roleForUser = params.roleForUser;
            this.modifyUserObject.failedAttempts = params.failedAttempts;
            this.modifyUserObject.versionNo = params.versionNo;
            this.modifyUserObject.newRoleForUser = params.newRoleForUser;
            this.modifyUserObject.statusForUser = params.statusForUser;
            this.modifyUserObject.department = params.department;
            this.modifyUserObject.intime = params.intime;
            this.modifyUserObject.outtime = params.outtime;
            this.modifyUserObject.pwdChangeDate = params.pwdChangeDate;
    ...
    keyPressRoles(event) {
        ...
        console.log(event);
        console.log(this.allRoleNames);
        this.allRoleNames = this.allRoleNames.filter(s => s.includes(event.target.value));
        console.log(this.allRoleNames);
        //this.allRoleNames=this.result;
        this.ref.markForCheck();
        console.log("" + this.allRoleNames);
        if (event.target.value == '') {
            this.getAllRolesNames();
    ...
    onClickOfAuthOfModifyUsers() {
        ...
        this.userApi.onClickOfAuthOfModifyUsers(this.modifyUserObject.userId, localStorage.getItem('currentUser')).subscribe(dataOfModifyUserFromBackEnd => {
            ...
            if (this.authStatusFlag === true) {
                sweetalert2__WEBPACK_IMPORTED_MODULE_5___default.a.fire('you Authorized the user ');
    ...
    onClickOfReOpenOfModifyUsers() {
        ...
        this.userApi.onClickOfReopenOfModifyUser(this.modifyUserObject.userId, this.modifyUserObject.creatorId).subscribe(dataOfReopen => {
            ...
            //console.log(this.modifyUserObject);
            if (this.statusFlag === true) {
                sweetalert2__WEBPACK_IMPORTED_MODULE_5___default.a.fire('Record is opened ');
                //console.log('coming or not');
                this.getUpdatedModifiedObject();
                this.cdr.markForCheck();
                this.getUserAuditData();
    ...
    onClickOfCloseOfModifyUSers() {
        ...
        this.userApi.onClickOfCloseOfModifyUsers(this.modifyUserObject.userId, this.modifyUserObject.creatorId).subscribe(dataofCloseFromBackend => {
            ...
            if (this.statusFlag === true) {
                sweetalert2__WEBPACK_IMPORTED_MODULE_5___default.a.fire('You closed the user record');
                //console.log('coming or not');
                this.getUpdatedModifiedObject();
                this.cdr.markForCheck();
                this.getUserAuditData();
    ...
    getUserAuditData() {
        this.userApi.getUserAuditService(this.modifyUserObject.userId).subscribe(data => {
            ...
            //console.log('dev code user audit: ');
    ...
    userActivate() {
        this.userApi.statusChangeUser(this.modifyUserObject.userId).subscribe(resp => {
            this.resp = resp;
            if (this.resp) {
...
ModifyUserComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./modify-user.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/views/users/modify-user/modify-user.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./modify-user.component.css */ "./src/app/views/users/modify-user/modify-user.component.css")).default]
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_users_service__WEBPACK_IMPORTED_MODULE_3__["UsersService"],
        ...
        _security_policy_security_policy_security_policy_service__WEBPACK_IMPORTED_MODULE_10__["SecurityPolicyService"],
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _users_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./users.component */ "./src/app/views/users/users.component.ts");
/* harmony import */ var _create_user_create_user_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./create-user/create-user.component */ "./src/app/views/users/create-user/create-user.component.ts");
/* harmony import */ var _modify_user_modify_user_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modify-user/modify-user.component */ "./src/app/views/users/modify-user/modify-user.component.ts");
...
/* harmony import */ var _users_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./users.service */ "./src/app/views/users/users.service.ts");
...
/* harmony import */ var _roles1_roles_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../roles1/roles.service */ "./src/app/views/roles1/roles.service.ts");
/* harmony import */ var _roles1_models_fmosNewRolePermissions__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../roles1/models/fmosNewRolePermissions */ "./src/app/views/roles1/models/fmosNewRolePermissions.ts");
...
let UsersComponent = class UsersComponent {
    constructor(userApi, snackBar, route, excelService, roleService) {
        this.userApi = userApi;
        this.snackBar = snackBar;
        this.route = route;
        this.excelService = excelService;
        this.roleService = roleService;
        //dataSourceUsers = new MatTableDataSource<User>(this.allUsersList);
    ...
    getAllUsers() {
        this.userApi.getAllUsersListService().subscribe(resp => {
            this.allUsersList = resp;
            this.dataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_5__["MatTableDataSource"](this.allUsersList);
...
UsersComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: "app-users",
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./users.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/views/users/users.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./users.component.css */ "./src/app/views/users/users.component.css")).default]
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_users_service__WEBPACK_IMPORTED_MODULE_4__["UsersService"],
        ...
        _roles1_roles_service__WEBPACK_IMPORTED_MODULE_11__["RoleService"]])
], UsersComponent);
...
/* harmony import */ var src_app_shared_angular_material_angular_material_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/shared/angular-material/angular-material.module */ "./src/app/shared/angular-material/angular-material.module.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
...
/* harmony import */ var _create_user_create_user_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./create-user/create-user.component */ "./src/app/views/users/create-user/create-user.component.ts");
/* harmony import */ var _modify_user_modify_user_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modify-user/modify-user.component */ "./src/app/views/users/modify-user/modify-user.component.ts");
...
UsersModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        imports: [
            ...
            src_app_shared_angular_material_angular_material_module__WEBPACK_IMPORTED_MODULE_5__["AngularMaterialModule"],
            ngx_bootstrap_timepicker__WEBPACK_IMPORTED_MODULE_10__["TimepickerModule"].forRoot(),
            _angular_router__WEBPACK_IMPORTED_MODULE_6__["RouterModule"].forChild(_users_routing_module__WEBPACK_IMPORTED_MODULE_7__["usersRoutes"])
        ]
    })
], UsersModule);
