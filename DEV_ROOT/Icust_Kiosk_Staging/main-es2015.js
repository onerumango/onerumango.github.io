...
const environment = {
    ...
    redirectUrl: "http://192.168.0.14:8081/Customer-Onboarding/#/sessions/callback",
...
class ApiService {
    ...
    fetchKioskSystemDetails() {
        return this.http
            .get(`${API_URL}/kisokSystem/fetchKioskSystemDetails`)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.errorHandler));
    }
}
