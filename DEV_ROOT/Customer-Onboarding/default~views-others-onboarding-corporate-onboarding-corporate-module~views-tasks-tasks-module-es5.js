  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~views-others-onboarding-corporate-onboarding-corporate-module~views-tasks-tasks-module"], {
    ...
    function KaOm(module, __webpack_exports__, __webpack_require__) {
      ...
      function CreateDirectorComponent_mat_form_field_28_mat_option_7_div_3_Template(rf, ctx) {
        ...
        if (rf & 2) {
          var option_r40 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"]().$implicit;
      ...
      function CreateDirectorComponent_mat_form_field_28_mat_option_7_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function CreateDirectorComponent_mat_form_field_28_mat_option_7_Template_mat_option_click_0_listener() {
            ...
            return ctx_r45.selectCif(option_r40);
          });
      ...
      function CreateDirectorComponent_mat_form_field_28_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("keyup", function CreateDirectorComponent_mat_form_field_28_Template_input_keyup_3_listener($event) {
            ...
            return ctx_r47.ngAfterViewInit($event.target.value);
            ...
            return ctx_r49.updatedVal($event);
          });
        ...
        if (rf & 2) {
          var _r38 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵreference"](6);
      ...
      function CreateDirectorComponent_mat_option_105_Template(rf, ctx) {
        ...
        if (rf & 2) {
          var recidence_r52 = ctx.$implicit;
      ...
      function CreateDirectorComponent_mat_option_115_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-option", 63);
        ...
        if (rf & 2) {
          var citizenship_r53 = ctx.$implicit;
      ...
      function CreateDirectorComponent_mat_error_116_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-error");
      ...
      function CreateDirectorComponent_mat_option_129_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-option", 63);
        ...
        if (rf & 2) {
          var countryOfResidence_r54 = ctx.$implicit;
      ...
      function CreateDirectorComponent_mat_error_130_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-error");
      ...
      function CreateDirectorComponent_mat_error_137_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-error");
      ...
      function CreateDirectorComponent_mat_option_148_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-option", 63);
      ...
      function CreateDirectorComponent_mat_error_149_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-error");
      ...
      function CreateDirectorComponent_div_151_mat_error_8_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-error");
      ...
      function CreateDirectorComponent_div_151_Template(rf, ctx) {
        if (rf & 1) {
        ...
        if (rf & 2) {
          var _r56 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵreference"](5);
      ...
      function CreateDirectorComponent_div_154_mat_error_11_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-error");
      ...
      function CreateDirectorComponent_div_154_mat_error_18_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-error");
      ...
      function CreateDirectorComponent_div_154_mat_option_27_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-option", 63);
      ...
      function CreateDirectorComponent_div_154_mat_error_28_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-error");
      ...
      function CreateDirectorComponent_div_154_mat_error_35_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-error");
      ...
      function CreateDirectorComponent_div_154_mat_error_36_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-error");
      ...
      function CreateDirectorComponent_div_154_mat_option_47_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-option", 63);
      ...
      function CreateDirectorComponent_div_154_mat_error_48_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-error");
      ...
      function CreateDirectorComponent_div_154_mat_option_57_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-option", 63);
        ...
        if (rf & 2) {
          var City_r72 = ctx.$implicit;

          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("value", City_r72);

          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](1);

          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtextInterpolate1"](" ", City_r72, " ");
        }
      }

      function CreateDirectorComponent_div_154_mat_error_58_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-error");
      ...
      function CreateDirectorComponent_div_154_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("selectionChange", function CreateDirectorComponent_div_154_Template_mat_select_selectionChange_26_listener($event) {
            ...
            return ctx_r73.getStateName($event.value, true, i_r59);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](34, "input", 70);

          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("keypress", function CreateDirectorComponent_div_154_Template_input_keypress_34_listener($event) {
            _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵrestoreView"](_r74);

            var ctx_r75 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"]();

            return ctx_r75._keyPress($event);
          })("keyup", function CreateDirectorComponent_div_154_Template_input_keyup_34_listener($event) {
            _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵrestoreView"](_r74);

            var ctx_r76 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"]();

            return ctx_r76.isAllSameDigit($event);
          })("change", function CreateDirectorComponent_div_154_Template_input_change_34_listener($event) {
            _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵrestoreView"](_r74);
            ...
            return ctx_r77.getCityandStateByZipcode(item_r58.get("country").value, $event.target.value, i_r59);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](35, CreateDirectorComponent_div_154_mat_error_35_Template, 3, 0, "mat-error", 3);

          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](36, CreateDirectorComponent_div_154_mat_error_36_Template, 3, 0, "mat-error", 3);
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](44, "mat-select", 71);

          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("selectionChange", function CreateDirectorComponent_div_154_Template_mat_select_selectionChange_44_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵrestoreView"](_r74);
            ...
            return ctx_r78.onStateChange(i_r59);
          });

          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](45, "mat-option", 30);

          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](46, "select---");

          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](47, CreateDirectorComponent_div_154_mat_option_47_Template, 2, 2, "mat-option", 17);

          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](48, CreateDirectorComponent_div_154_mat_error_48_Template, 3, 0, "mat-error", 3);
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](54, "mat-select", 72);

          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("selectionChange", function CreateDirectorComponent_div_154_Template_mat_select_selectionChange_54_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵrestoreView"](_r74);
            ...
            return ctx_r79.onCityChange(i_r59);
          });

          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](55, "mat-option", 30);

          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](56, "select---");

          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](57, CreateDirectorComponent_div_154_mat_option_57_Template, 2, 2, "mat-option", 17);
      ...
      function CreateDirectorComponent_mat_error_167_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-error");
      ...
      function CreateDirectorComponent_mat_error_168_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-error");
      ...
      function CreateDirectorComponent_mat_error_175_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-error");
      ...
      function CreateDirectorComponent_mat_error_176_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-error");
      ...
      function CreateDirectorComponent_mat_error_185_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-error");
      ...
      function CreateDirectorComponent_div_190_mat_error_13_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-error");
      ...
      function CreateDirectorComponent_div_190_mat_option_20_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-option", 63);
        ...
        if (rf & 2) {
          var countryOfIssue_r85 = ctx.$implicit;

          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("value", countryOfIssue_r85);

          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](1);

          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtextInterpolate1"](" ", countryOfIssue_r85, " ");
        }
      }

      function CreateDirectorComponent_div_190_mat_error_21_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-error");
      ...
      function CreateDirectorComponent_div_190_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("keypress", function CreateDirectorComponent_div_190_Template_input_keypress_10_listener($event) {
            _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵrestoreView"](_r87);

            var ctx_r86 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"]();

            return ctx_r86.omit_special_char($event);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function CreateDirectorComponent_div_190_Template_button_click_26_listener() {
            ...
            ctx_r88.addDirector(ctx_r88.createDirectorFormGroup.value, item_r80);
            return ctx_r88.openClose("CLOSE");
          });
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("formGroupName", i_r81);

          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](13);

          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("ngIf", item_r80.get("taxId").touched && !item_r80.get("taxId").valid);
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("ngIf", item_r80.get("countryOfIssue").touched && !item_r80.get("countryOfIssue").valid);
      ...
      function CreateDirectorComponent_mat_card_191_div_3_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function CreateDirectorComponent_mat_card_191_ng_template_5_Template(rf, ctx) {
        if (rf & 1) {
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtextInterpolate2"](" ", _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵpipeBind1"](2, 2, _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵpipeBind3"](3, 4, ctx_r91.createDirectorFormGroup.value.firstName, 0, 1)), "", _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵpipeBind1"](4, 8, _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵpipeBind3"](5, 10, ctx_r91.createDirectorFormGroup.value.lastName, 0, 1)), " ");
        }
      }

      function CreateDirectorComponent_mat_card_191_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function CreateDirectorComponent_mat_card_191_Template_button_click_15_listener() {
            ...
            return ctx_r92.editDirector(ctx_r92.item);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function CreateDirectorComponent_mat_card_191_Template_button_click_18_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵrestoreView"](_r93);

            var ctx_r94 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"]();

            return ctx_r94.deleteDirector(ctx_r94.item);
          });
        ...
        if (rf & 2) {
          var _r90 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵreference"](6);

          var ctx_r34 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](3);

          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("ngIf", ctx_r34.profileImage == "not_available")("ngIfElse", _r90);
      ...
      var CreateDirectorComponent = /*#__PURE__*/function () {
        function CreateDirectorComponent(router, formBuilder, appApiService, corporateService, cdr, snack, apiService, ls, datepipe) {
        ...
        _createClass(CreateDirectorComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.corporateService.corporateAccountIdVal.subscribe(function (corporateId) {
              _this15.corporateId = corporateId;
              console.log('corporateId :: ', _this15.corporateId);

              _this15.createDirectorFormGroup.get('corporateId').setValue(corporateId);

              if (_this15.corporateId) {
                _this15.getCoropratedetails(_this15.corporateId);
              } else {
                if (_this15.ls.getItem('corporateId')) {
                  _this15.getCoropratedetails(_this15.ls.getItem('corporateId'));
                }
              }
            });
          ...
          value: function onSelectionResidance(data) {
            ...
            this.apiService.countryFlaglists(data).subscribe(function (value) {
              ...
              _this17.Currency = value.currencyCode.toLowerCase();
              console.log(_this17.Currency);
            });
          }
        }, {
          ...
          value: function onSelectionCitizionship(data) {
            ...
            this.apiService.countryFlaglists(data).subscribe(function (value) {
              console.log(value.currencyCode);
              _this18.currencyCode = value.currencyCode.toLowerCase();
              console.log(_this18.currencyCode);
            });
          }
        }, {
          key: "getStateName",
          ...
          value: function getCoropratedetails(id) {
            ...
            console.log(this.item); // if(this.noOfDir)
            ...
            this.apiService.getCoropratedetails(id).subscribe(function (details) {
              ...
              if (_this22.noOfDir <= _this22.totalDir) {
                for (var i = 0; i < details.customerInfo.length; i++) {
                  _this22.fetchByCif(details.customerInfo[i].cifNumber);

                  if (details) {
                    console.log("jnkhk");

                    _this22.getStateName(details.customerInfo[i].userAddress[0].country); // this.getCityName(details.customerInfo[i].userAddress[0].state);
                    ...
                    console.log(details.customerInfo[i], _this22.createDirectorFormGroup);

                    _this22.createDirectorFormGroup.patchValue(details.customerInfo[i]);
                  }
                }
              }
            });
          ...
          value: function fetchByCif(cifNumber) {
            ...
            if (cifNumber) {
              ...
              this.timer = setTimeout(function () {
                _this23.appApiService.fetchByCif(cifNumber).subscribe(function (res) {
                  ...
                  _this23.ls.setItem('KycValues', kycValues); // this.autocomplete.openPanel();


                  if (res) {
                    _this23.showAutocomplete = true;
                    _this23.customerInfoList = res.customerInfoList; // this.customerInfoList[0].userAddress[0].zipcode = res.customerInfoList[0].userAddress[0].zipCode;
                  }
                  ...
                  if (_this23.customerInfoList[0].citizenship != null) {
                    _this23.onSelectionCitizionship(_this23.customerInfoList[0].citizenship);
                  }

                  if (_this23.customerInfoList[0].countryOfResidence != null) {
                    _this23.onSelectionResidance(_this23.customerInfoList[0].countryOfResidence);
                    ...
                    _this23.snack.open('Kindly Enter Valid CifNumber to proceed', 'OK', {
                      duration: 4000,
                      verticalPosition: 'top',
                      horizontalPosition: 'right'
                    }); // this.customerInfoList = [];
          ...
          value: function addDirector(createDirectorFormGroup, item) {
            ...
            createDirectorFormGroup.corporateId = this.corporateId; //this.createDirectorFormGroup.get('primaryCustomer').setValue(true);
            ...
            this.corporateService.saveOrUpdateCorporateAccountInfo(coporateObjModel).subscribe(function (data) {
              ...
              if (data != null) {
                ...
                if (data.customerInfo != null && data.customerInfo[0].cifNumber != null) {
                  _this24.cifNumber = data.customerInfo[0].cifNumber;
                }

                _this24.snack.open("Director ".concat(_this24.item, " profile created") + ' !', 'OK', {
                  duration: 4000,
                  verticalPosition: 'top',
                  horizontalPosition: 'right'
                });

                _this24.cdr.markForCheck(); // if (this.noOfDir >= 1) {


                if (_this24.noOfDir <= 1) {
                  _this24.next();
                }
              } else {
                _this24.snack.open('Not able to connect to server!', 'INTERNAL SERVER ERROR', {
                  duration: 4000,
                  verticalPosition: 'top',
                  horizontalPosition: 'right'
                });
              ...
              _this24.snack.open("".concat(error.error.message, " "), 'OK', {
                duration: 4000,
                verticalPosition: 'top',
                horizontalPosition: 'right'
              });
          ...
          value: function getCityandStateByZipcode(countryName, zipcode, index) {
            ...
            if (countryName && zipcode.length >= 6) {
              this.apiService.fetchStateCityByZipcode(countryName, zipcode).subscribe(function (res) {
                if (res) {
                  _this26.createDirectorFormGroup.get('userAddress').controls[index].get('state').setValue(res.stateName);

                  _this26.createDirectorFormGroup.get('userAddress').controls[index].get('city').setValue(res.cityName);
                } else {
                  _this26.snack.open("Entered Zipcode is not exists", "OK", {
                    duration: 4000,
                    verticalPosition: "top",
                    horizontalPosition: "right"
                  });
      ...
      CreateDirectorComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({
        ...
        template: function CreateDirectorComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("selectionChange", function CreateDirectorComponent_Template_mat_select_selectionChange_114_listener($event) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("selectionChange", function CreateDirectorComponent_Template_mat_select_selectionChange_126_listener($event) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("keypress", function CreateDirectorComponent_Template_input_keypress_136_listener($event) {
              return ctx._keyPress($event);
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("keypress", function CreateDirectorComponent_Template_input_keypress_164_listener($event) {
              return ctx._keyPress($event);
            })("keyup", function CreateDirectorComponent_Template_input_keyup_164_listener($event) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("keypress", function CreateDirectorComponent_Template_input_keypress_174_listener($event) {
              return ctx._keyPress($event);
            });
    ...
    function h31h(module, __webpack_exports__, __webpack_require__) {
      ...
      function OnboradingPrimaryComponent_mat_error_52_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "mat-error");
      ...
      function OnboradingPrimaryComponent_mat_option_59_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function OnboradingPrimaryComponent_mat_option_66_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "mat-option", 42);
      ...
      function OnboradingPrimaryComponent_mat_error_67_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "mat-error");
        ...
        _createClass(OnboradingPrimaryComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.route.queryParamMap.subscribe(function (params) {
              _this27.imageURL = 'not_available';
              console.log(params.get('index'));

              if (params.get('index')) {
                _this27.corporateService.sendDisableMatTab({
                  index: params.get('index')
                });

                _this27.corporateService.setFinishFlag({
                  finishFlag: false
                });

                _this27.resetCorprateOnboarding();

                _this27.onboardingPrimary.reset({
                  companyName: '',
                  corporateId: '',
                  category: '',
                  country: ''
          ...
          value: function profileChange(event) {
            ...
            reader.onload = function (event2) {
              ...
              _this29.imageURL = reader.result;
              _this29.disableDeletebtn = true; // this.profileImageExist = true;
            };
          ...
          value: function getCoropratedetails(e) {
            ...
            this.apiService.getCoropratedetails(e).subscribe(function (details) {
              ...
              if (details) {
                _this30.ls.setItem('totalCust', details.customerInfo.length);
              }

              if (details.corporateStatus === 'APPROVED') {
                _this30.onboardingPrimary.patchValue(details);

                _this30.imageURL = details.profileImage;
                _this30.imageURL != "not_available" ? _this30.disableDeletebtn = true : false;
                _this30.corporateDetails = details;

                _this30.ls.removeItem('EDIT-CORPORATEID');
              } // if (details) {
              // }
              // else if (
              ...
              // }
                  ...
                  _this30.snack.open('Please Enter Approved Corporate Id Number', 'Ok', {
                    duration: 4000,
                    verticalPosition: 'top',
                    horizontalPosition: 'right'
                  });
          ...
          value: function onSubmit(onboardingPrimary) {
            ...
            this.corporateService.saveOrUpdateCorporateAccountInfo(onboardingPrimary).subscribe(function (data) {
              ...
              console.log('data :: ', data);
              _this31.corporateId = data.corporateId;

              if (data != null) {
                _this31.ls.setItem('corporateId', data.corporateId);

                _this31.corporateService.sendCorporateAccountId(data.corporateId);

                _this31.snack.open('Basic Information Saved' + ' !', 'OK', {
                  duration: 4000,
                  verticalPosition: 'top',
                  horizontalPosition: 'right'
                });
                ...
                _this31.updateCorporateStatus(data.corporateId);

                if (_this31.profilePicture) {
                  var profileUpload = {};
                  profileUpload.documentName = 'Profile';
                  profileUpload.documentType = 1;
                  profileUpload.fileType = (_a = _this31.profilePicture) === null || _a === void 0 ? void 0 : _a.type;
                  profileUpload.fileName = (_b = _this31.profilePicture) === null || _b === void 0 ? void 0 : _b.name;
                  profileUpload.corporateId = data.corporateId;
                  console.log(profileUpload);
                  var uploadData = new FormData();
                  uploadData.append('data', JSON.stringify(profileUpload));
                  uploadData.append('file', _this31.profilePicture);

                  _this31.apiService.uploadCorporateDocument(uploadData).subscribe(function (response) {}, function (err) {
                ...
                _this31.snack.open('Not able to connect to server!', 'INTERNAL SERVER ERROR', {
                  duration: 4000,
                  verticalPosition: 'top',
                  horizontalPosition: 'right'
                });
              ...
              (function (error) {
                ...
                _this31.snack.open("".concat(error.error.message, " "), 'OK', {
                  duration: 4000,
                  verticalPosition: 'top',
                  horizontalPosition: 'right'
                });
          ...
          value: function getProfileImage(customerId, document_type) {
            ...
            this.apiService.getCustomerDocuments(customerId, document_type).subscribe(function (data) {
              ...
              if (data.length > 0) {
                _this32.profileId = data[0].id;
                _this32.imageURL = data[0].fileUrl;
              }
            });
          }
        }, {
          ...
          value: function deleteProfileImg() {
            ...
            this.apiService.delCorporateCustDoc(this.corporateId, 'Profile', docObj.id).subscribe(function (data) {
              _this33.snack.open('Profile Image Deleted Successfully', 'OK', {
                duration: 4000,
                verticalPosition: 'top',
                horizontalPosition: 'right'
              });
          ...
          value: function getCountryName(key) {
            ...
            this.apiService.getAllCountries().subscribe(function (data) {
              for (var i = 0; i < data.length; i++) {
                if (data[i].authStatus === 'A') {
                  _this34.countryArr.push(data[i].countryName);
                }
              }
            });
          }
      ...
      OnboradingPrimaryComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
        ...
        template: function OnboradingPrimaryComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function OnboradingPrimaryComponent_Template_p_click_41_listener() {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function OnboradingPrimaryComponent_Template_p_click_45_listener() {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function OnboradingPrimaryComponent_Template_button_click_69_listener() {
              return ctx.previous();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function OnboradingPrimaryComponent_Template_button_click_71_listener() {
    ...
    function qazE(module, __webpack_exports__, __webpack_require__) {
      ...
      var OtherInfoCorporateComponent = /*#__PURE__*/function () {
        function OtherInfoCorporateComponent(router, formBuilder, dialogService, corporateService, cdr, snack, ls, apiService) {
          ...
          this.isDocumentOptionDisabled = function (value) {
            return _this35.selectedOptions.includes(value);
          };
        ...
        _createClass(OtherInfoCorporateComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.corporateService.corporateAccountIdVal.subscribe(function (corporateId) {
              _this36.corporateId = corporateId;
              console.log('corporateId :: ', _this36.corporateId);

              _this36.otherInfoFormGroup.get('corporateId').setValue(corporateId);

              if (_this36.corporateId) {
                _this36.getCoropratedetails(_this36.corporateId);
              }
            });
            this.getDoc();
            this.addDocument();
          ...
          value: function getCountryName(key) {
            ...
            this.apiService.getAllCountries().subscribe(function (data) {
              for (var i = 0; i < data.length; i++) {
                if (data[i].authStatus === 'A') {
                  _this37.arrayCountry.push(data[i].countryName);
                }
              }
            });
          }
          ...
          value: function getCityName(state) {
            ...
            this.apiService.getDropDownValues1("city", state).subscribe(function (data) {
              _this39.arrayCity = data;
              console.log("-->", _this39.arrayCity);
            });
          }
        }, {
          ...
          value: function onOtherDocSelect(files, idx, fileName) {
            ...
            reader.onload = function (event2) {
              ...
              console.log("jaskd", _this40.otherInfoFormGroup.get('corporateDocs')['controls'][idx].controls.fileData);

              _this40.otherInfoFormGroup.get('corporateDocs')['controls'][idx].controls.fileData.setValue(reader.result);
            };
          ...
          value: function getCoropratedetails(e) {
            ...
            this.apiService.getCoropratedetails(e).subscribe(function (details) {
              ...
              _this41.nameOfDocument = details.corporateDocs;
              ...
              for (var i = 0; i < details.corporateDocs.length; i++) {
                if (details.corporateDocs.length > 1 && details.corporateDocs[i].documentName !== "profile") {
                  _this41.otherInfoFormGroup.patchValue(details);

                  _this41.otherInfoFormGroup.controls.corporateDocs['controls'][i].controls.documentType.setValue(_this41.documentTypeList[i + 1]);

                  _this41.otherInfoFormGroup.controls.corporateDocs['controls'][i].controls.fileData.setValue(details.corporateDocs[i + 1].fileUrl);
                }
              }

              _this41.getStateName(details.corporateAddress[0].country);

              _this41.getCityName(details.corporateAddress[0].state);
            });
          }
        }, {
          key: "onSubmit",
          value: function onSubmit(otherInfoFormGroup) {
            ...
            this.corporateService.saveOrUpdateCorporateAccountInfo(obj).subscribe(function (data) {
              ...
              if (data != null) {
                for (var i = 0; i < _this42.otherInfoFormGroup.get('corporateDocs').value.length; i++) {
                  if (_this42.otherDocumentArray.length > 0) {
                    var documentToBeUploaded = {};
                    documentToBeUploaded.documentName = _this42.otherInfoFormGroup.get('corporateDocs').value[i].documentType;
                    documentToBeUploaded.documentType = 2;
                    documentToBeUploaded.fileType = _this42.otherDocumentArray[i].type;
                    documentToBeUploaded.fileName = _this42.otherDocumentArray[i].name;
                    documentToBeUploaded.corporateId = data.corporateId;
                    documentToBeUploaded.id = _this42.otherDocumentArray[i].id;
                    var uploadData = new FormData();
                    uploadData.append('data', JSON.stringify(documentToBeUploaded));
                    uploadData.append('file', _this42.otherDocumentArray[i]);

                    _this42.apiService.uploadCorporateDocument(uploadData).subscribe(function (resp) {
                      console.log(resp);
                    });
                  }
                }

                _this42.updateCorporateStatus(data.corporateId);

                _this42.dialogService.customerOnboardingSuccessDialogue('CORPORATE', _this42.corporateId);

                _this42.otherInfoFormGroup.reset();

                _this42.ls.removeItem('corporateId');

                _this42.ls.removeItem('corporateTabIndex');

                _this42.corporateService.setnoOfDirectors(null); // this.snack.open(`Other information saved`+ ' !', 'OK', {
                //   duration: 4000,
                //   verticalPosition: 'top',
                //   horizontalPosition: 'right'
                // });
                ...
                _this42.snack.open('Not able to connect to server!', 'INTERNAL SERVER ERROR', {
                  duration: 4000,
                  verticalPosition: 'top',
                  horizontalPosition: 'right'
                });
              ...
              _this42.snack.open("".concat(error.error.message, " "), 'OK', {
                duration: 4000,
                verticalPosition: 'top',
                horizontalPosition: 'right'
              });
          ...
          value: function changeValue(value, index) {
            ...
            if (this.selectedDocumentTypes[index]) {
              this.selectedOptions = this.selectedOptions.filter(function (val) {
                return val !== _this44.selectedDocumentTypes[index];
              });
            }
    ...
    function tCF6(module, __webpack_exports__, __webpack_require__) {
      ...
      var _create_director_create_director_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
      /*! ../create-director/create-director.component */
      "KaOm");
        ...
        _createClass(DirectorDetailsComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.directorFormGroup.valueChanges.subscribe(function (data) {
              ...
              _this45.corporateService.setnoOfDirectors(data.noOfDirector);
            });
            this.corporateService.getfinishSave().subscribe(function (disSave) {
              // console.log('disSave :: ',disSave);
              if (_this45.totalCust != null) {
                _this45.directorFormGroup.get('noOfDirector').setValue(_this45.totalCust);
              }
              ...
              if (disSave.length > 0) {
                ...
                if (count == disSave.length) {
                  _this45.disabledBtn = false;
                } else {
                  _this45.disabledBtn = true;
                }
              }
            });
          }
