...
let ApiService = class ApiService {
    ...
    // validateMpin(phoneNumber:any,mpin: any,deviceId) {
    //   var  params = new HttpParams()
    //     .append('phoneNumber', phoneNumber)
    //     .append('mpin', mpin)
    //     .append('deviceId', deviceId);
    //     return this.http.post<any>(`${API_URL}/customerLogin/generateMpin?${params}`).pipe(catchError(this.errorHandler));
    //   }
    validateMpin(data) {
        console.log(data);
