...
/* harmony import */ var src_app_components_verification_modal_verification_modal_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/components/verification-modal/verification-modal.component */ 49241);
...
let KycVideoPage = class KycVideoPage {
    ...
    buildScheduleForm() {
        this.scheduleForm = this.fb.group({
            scheduledDate: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.required]],
            scheduledTime: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.required]],
        });
    }
    // time slots
    openTimeSlot() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_9__.__awaiter)(this, void 0, void 0, function* () {
            ...
            modal.onDidDismiss().then((res) => {
                ...
                this.scheduleForm.get('scheduledTime').setValue(res === null || res === void 0 ? void 0 : res.data.form);
    ...
    finish() {
        ...
        //     }
        //   });
        let resData = Object.assign({}, this.basicInfoData.data);
    ...
    openDialog() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_9__.__awaiter)(this, void 0, void 0, function* () {
            let modal = yield this.modalCtrl.create({
                component: src_app_components_verification_modal_verification_modal_component__WEBPACK_IMPORTED_MODULE_7__.VerificationModalComponent,
                componentProps: {
                    screen: 'video',
                },
            });
    ...
    datePopup() {
        this.modalCtrl
            ...
            modalResp.onDidDismiss().then((res) => {
                ...
                this.scheduleForm.get('scheduledDate').setValue(res === null || res === void 0 ? void 0 : res.data);
            });
        });
    }
};
...
let VideoService = class VideoService {
    ...
    scheduleAppointment(payload) {
        return this.httpClient.post(`${MICROSERVICE_URL}/video-verify/save`, payload);
    }
};
