...
let LoanDisbursementV2Page = class LoanDisbursementV2Page {
    ...
    submit(form) {
        ...
        console.log(typeof ((_c = this.filteredLoanAccount) === null || _c === void 0 ? void 0 : _c.accountCurrency));
        if (this.loanForm.get("transactionCurrency").value == "INR") {
            console.log((_d = this.filteredLoanAccount) === null || _d === void 0 ? void 0 : _d.accountCurrency);
            let ttam = this.loanForm.get('totalTransactionAmount').value;
            ...
            let ttam = this.loanForm.get('totalTransactionAmount').value;
            console.log(ttam);
            form.totalTransactionAmount = ttam.replace(/\D/g, '');
        }
        form.accountCurrency = ((_e = this.filteredLoanAccount) === null || _e === void 0 ? void 0 : _e.accountCurrency) || "";
        form.isMobileTrans = true;
        form.holderName = (_f = this.filteredLoanAccount) === null || _f === void 0 ? void 0 : _f.customerName;
            ...
            modeInfo = [
                {
                    ...
                    accountCurrency: (_g = this.filteredPaymentAccount) === null || _g === void 0 ? void 0 : _g.accountCurrency
                }
            ];
        }
            ...
            modeInfo = [
                {
                    ...
                    rePaymentMode: form === null || form === void 0 ? void 0 : form.paymentMethod,
                    category: this.module,
                    accountCurrency: (_h = this.filteredPaymentAccount) === null || _h === void 0 ? void 0 : _h.accountCurrency,
        ...
        form.tokenBranch = form.transactionBranch;
        if (this.editMode) {
    ...
    getExChangeRate(currency) {
        this.api.getExchangeRate(this.accountInfo.accountCurrency).subscribe((res) => {
            ...
            console.log(toFix);
            console.log(this.loanForm.get('transactionAmount'));
            ...
            if (!isNaN(val)) {
                ...
                this.loanForm.get('totalTransactionAmount').patchValue(updatedAmount);
