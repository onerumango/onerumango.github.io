    ...
    function YfT7(module, __webpack_exports__, __webpack_require__) {
      ...
      var TokenGenerationComponent = /*#__PURE__*/function () {
        ...
        _createClass(TokenGenerationComponent, [{
          ...
          value: function goToClose() {
            this.dialogRef.close();
            this.dialogService.feedBack(); //  this.router.navigateByUrl("/others/kioskHome");
          }
        }, {
          key: "goToScanner",
      ...
      var ApiService = /*#__PURE__*/function () {
        ...
        _createClass(ApiService, [{
          ...
          value: function goToLogin(data) {
            return this.http.post("".concat(API_URL, "/kioskSystem/login"), data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.errorHandler));
          }
        }, {
          key: "generateOtp",
