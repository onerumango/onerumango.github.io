...
class ApiService {
    ...
    goToLogin(data) {
        return this.http
            .post(`${API_URL}/kioskSystem/login`, data)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.errorHandler));
    }
    generateOtp(data) {
        return this.http
            .post(`${API_URL}/kioskSystem/generateOtp`, data)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.errorHandler));
    }
    fetchMobileOrEmail(sysCode) {
        return this.http
            .get(`${API_URL}/kioskSystem/fetchMobileOrEmail?kioskSystemCode=${sysCode}`)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.errorHandler));
    }
}
