(function () {
  ...
  (self["webpackChunkmedian"] = self["webpackChunkmedian"] || []).push([["src_app_views_charge-maintainenece_charge-maintainenece_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var src_app_shared_services_charge_maintenance_service_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! src/app/shared/services/charge-maintenance-service.service */
      16412);
      /* harmony import */
      ...
      function ChargeMaintaineneceComponent_div_33_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function ChargeMaintaineneceComponent_div_33_Template_button_click_1_listener() {
      ...
      function ChargeMaintaineneceComponent_div_34_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function ChargeMaintaineneceComponent_div_34_Template_button_click_1_listener() {
      ...
      function ChargeMaintaineneceComponent_div_36_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function ChargeMaintaineneceComponent_div_36_Template_button_click_1_listener() {
        ...
        _createClass(_ChargeMaintaineneceComponent, [{
          ...
          value: function buildForm(item) {
            this.chargeForm = this.formBuilder.group({
              ...
              chargePercentage: [item ? item.chargePercentage : "", [_angular_forms__WEBPACK_IMPORTED_MODULE_3__.Validators.required, _angular_forms__WEBPACK_IMPORTED_MODULE_3__.Validators.max(100), _angular_forms__WEBPACK_IMPORTED_MODULE_3__.Validators.min(0)]],
          ...
          value: function onSubmittingofChargeMaintenance(value) {
            ...
            if (value === 'submit') {
              this.chargeMaintenanceService.onchargeMaintenanceSubmit(null, this.chargeForm.value).subscribe(function (chargeMaintenanceResp) {
                console.log(chargeMaintenanceResp);

                if (chargeMaintenanceResp.currency == null) {
                  _this4.toastService.errorMessage("Record Already Exist", "");
            ...
            if (value === 'edit') {
              this.chargeMaintenanceService.submittingTheEditedRecord(this.chargeForm.value, null).subscribe(function (chargeMaintenanceResp) {
                console.log(chargeMaintenanceResp);

                if (!chargeMaintenanceResp) {
                  _this4.toastService.errorMessage("Cannot update the record", "");

                  _this4.submitDisab = true;
                } else {
                  _this4.submitDisab = true;

                  _this4.toastService.successMessage("Record Updated SuccessFully!", "");
                }
              });
            }
          }
          ...
          value: function onAuthorizingTheRecord() {
            ...
            this.chargeMaintenanceService.onAuthofChargeMaintenance(null, this.chargeForm.value.id).subscribe(function (authResp) {
              console.log(authResp);
              _this6.respData = authResp;

              if (_this6.respData.inputBy != null) {
                _this6.toastService.successMessage("You authorized the Record!", "" // type: "success"
                );
              } else {
                _this6.toastService.errorMessage("Maker cannot authorize the record", "");
              }
            });
          }
        }, {
          ...
          value: function onClosingTheRecord() {
            ...
            this.chargeMaintenanceService.onClosingTheRecord(null, this.chargeForm.value.id.id).subscribe(function (closeResp) {
              console.log(closeResp);
              _this7.respData = closeResp;

              if (_this7.respData.verifiedStatus == "U") {
                _this7.toastService.errorMessage("Unauthorize Record Cannot be Closed", "");
              } else {
                _this7.toastService.successMessage("Record closed succefully", "" // type: "success"
                );
              }
            });
          }
          ...
          value: function onReopningTheRecord() {
            ...
            this.chargeMaintenanceService.onReopningTheRecord(null, this.chargeForm.value.id).subscribe(function (reopnResp) {
              console.log(reopnResp);
              _this8.respData = reopnResp;
              _this8.respData = reopnResp;

              if (_this8.respData.recordStatus == "O") {
                _this8.toastService.successMessage("Record opened succefully", "" // type: "success"
                );
              } else {
                _this8.toastService.errorMessage("Record cannot be opened ", "");
              }
            });
          }
        }, {
          ...
          value: function onDeletingTheRecord() {
            ...
            this.chargeMaintenanceService.onDeletTheRecord(null, this.chargeForm.value.id).subscribe(function (deleteResp) {
              console.log(deleteResp);
              _this9.respData = deleteResp; // console.log(this.chargeMaintenanceDTO.currency);

              if (_this9.respData.chargeAmount == null) {
                _this9.toastService.successMessage("Record deleted succefully", "" // type: "success"
                );
              } else {
                _this9.toastService.errorMessage("Record cannot be Deleted ", "");
              }
            });
          }
        }]);
