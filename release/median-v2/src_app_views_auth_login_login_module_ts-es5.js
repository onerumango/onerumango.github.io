(function () {
  ...
  (self["webpackChunkmedian"] = self["webpackChunkmedian"] || []).push([["src_app_views_auth_login_login_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      function LoginComponent_div_7_div_10_img_9_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵelement"](0, "img", 36);
        }
      }

      function LoginComponent_div_7_div_10_img_10_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function LoginComponent_div_7_div_10_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵlistener"]("click", function LoginComponent_div_7_div_10_Template_span_click_8_listener() {
      ...
      function LoginComponent_div_7_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵlistener"]("keyup", function LoginComponent_div_7_Template_input_keyup_9_listener() {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵlistener"]("click", function LoginComponent_div_7_Template_button_click_12_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵrestoreView"](_r8);
      ...
      function LoginComponent_div_9_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵlistener"]("click", function LoginComponent_div_9_Template_button_click_20_listener() {
            ...
            return ctx_r14.resendOtpMethod();
          });
      ...
      var _LoginComponent = /*#__PURE__*/function () {
        ...
        _createClass(_LoginComponent, [{
          ...
          value: function fetchAutoPassword(username) {
            var _this9 = this;

            this.apiService.fetchAutoPassword(username).subscribe(function (resp) {
              console.log(resp);
            }, function (error) {
              console.log(error);
              sweetalert2__WEBPACK_IMPORTED_MODULE_2___default().fire({
                text: "Mail sent, kindly login with newly generated password",
                icon: "success"
              });
              _this9.auto = true;
            });
