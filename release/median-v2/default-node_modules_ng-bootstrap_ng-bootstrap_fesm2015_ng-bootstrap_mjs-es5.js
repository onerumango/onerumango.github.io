  ...
  (self["webpackChunkmedian"] = self["webpackChunkmedian"] || []).push([["default-node_modules_ng-bootstrap_ng-bootstrap_fesm2015_ng-bootstrap_mjs"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _RaceSubscriber = /*#__PURE__*/function (_OuterSubscriber__WEB) {
        ...
        var _super = _createSuper(_RaceSubscriber);
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _ZipSubscriber = /*#__PURE__*/function (_Subscriber__WEBPACK_) {
        ...
        var _super2 = _createSuper(_ZipSubscriber);
      ...
      var ZipBufferIterator = /*#__PURE__*/function (_innerSubscribe__WEBP, _internal_symbol_iter2) {
        ...
        var _super3 = _createSuper(ZipBufferIterator);
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var DistinctUntilChangedSubscriber = /*#__PURE__*/function (_Subscriber__WEBPACK_2) {
        ...
        var _super4 = _createSuper(DistinctUntilChangedSubscriber);
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var WithLatestFromSubscriber = /*#__PURE__*/function (_OuterSubscriber__WEB2) {
        ...
        var _super5 = _createSuper(WithLatestFromSubscriber);
        ...
        function WithLatestFromSubscriber(destination, observables, project) {
          ...
          _this5.observables = observables;
          _this5.project = project;
          _this5.toRespond = [];
          var len = observables.length;
          _this5.values = new Array(len);

          for (var i = 0; i < len; i++) {
            _this5.toRespond.push(i);
          }

          for (var _i3 = 0; _i3 < len; _i3++) {
            var observable = observables[_i3];

            _this5.add((0, _util_subscribeToResult__WEBPACK_IMPORTED_MODULE_1__.subscribeToResult)(_assertThisInitialized(_this5), observable, undefined, _i3));
          }
    ...
    function _(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
      ...
      var rxjs_operators__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(
      /*! rxjs/operators */
      85816);
      /* harmony import */
      ...
      var _popperjs_core__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(
      /*! @popperjs/core */
      67092);
      ...
      var _NgbAccordion = /*#__PURE__*/function () {
        ...
        _createClass(_NgbAccordion, [{
          ...
          value: function expandAll() {
            ...
            if (this.closeOtherPanels) {
              ...
              this.panels.forEach(function (panel) {
                return _this6._changeOpenState(panel, true);
              });
            }
          }
          /**
          ...
          value: function collapseAll() {
            ...
            this.panels.forEach(function (panel) {
              _this7._changeOpenState(panel, false);
            });
          }
          /**
          ...
          value: function ngAfterContentChecked() {
            ...
            this.panels.forEach(function (panel) {
              panel.isOpen = !panel.disabled && _this8.activeIds.indexOf(panel.id) > -1;
            }); // closeOthers updates
            ...
            this._ngZone.onStable.pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_11__.take)(1)).subscribe(function () {
              _this8.panels.forEach(function (panel) {
                var panelElement = panel.panelDiv;

                if (panelElement) {
                  if (!panel.initClassDone) {
                    panel.initClassDone = true;
                    ngbRunTransition(_this8._ngZone, panelElement, ngbCollapsingTransition, {
                      animation: false,
          ...
          value: function _runTransitions(animation) {
            ...
            this.panels.forEach(function (panel) {
              ...
              if (panel.transitionRunning) {
                var panelElement = panel.panelDiv;
                ngbRunTransition(_this9._ngZone, panelElement, ngbCollapsingTransition, {
                  animation: animation,
                  ...
                  if (panel.isOpen) {
                    ...
                    _this9.shown.emit(id);
                  } else {
                    panel.hidden.emit();

                    _this9.hidden.emit(id);
                  }
                });
              }
            });
        ...
        _createClass(_NgbRadioGroup, [{
          ...
          value: function _updateRadiosValue() {
            ...
            this._radios.forEach(function (radio) {
              return radio.updateValue(_this11._value);
            });
          }
        }, {
          ...
          value: function ngAfterContentInit() {
            ...
            if ((0, _angular_common__WEBPACK_IMPORTED_MODULE_12__.isPlatformBrowser)(this._platformId)) {
              this._ngZone.runOutsideAngular(function () {
                var hasNextSlide$ = (0, rxjs__WEBPACK_IMPORTED_MODULE_15__.combineLatest)([_this12.slide.pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_16__.map)(function (slideEvent) {
                  return slideEvent.current;
                }), (0, rxjs_operators__WEBPACK_IMPORTED_MODULE_17__.startWith)(_this12.activeId)), _this12._wrap$, _this12.slides.changes.pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_17__.startWith)(null))]).pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_16__.map)(function (_ref11) {
                  var _ref12 = _slicedToArray(_ref11, 2),
                      currentSlideId = _ref12[0],
                      wrap = _ref12[1];

                  var slideArr = _this12.slides.toArray();

                  var currentSlideIdx = _this12._getSlideIdxById(currentSlideId);

                  return wrap ? slideArr.length > 1 : currentSlideIdx < slideArr.length - 1;
                }), (0, rxjs_operators__WEBPACK_IMPORTED_MODULE_18__.distinctUntilChanged)());
                (0, rxjs__WEBPACK_IMPORTED_MODULE_15__.combineLatest)([_this12._pause$, _this12._pauseOnHover$, _this12._mouseHover$, _this12._pauseOnFocus$, _this12._focused$, _this12._interval$, hasNextSlide$]).pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_16__.map)(function (_ref13) {
                ...
                }), (0, rxjs_operators__WEBPACK_IMPORTED_MODULE_7__.takeUntil)(_this12._destroy$)).subscribe(function () {
                  return _this12._ngZone.run(function () {
                    return _this12.next(_NgbSlideEventSource.TIMER);
                  });
                });
              });
            }
            ...
            this.slides.changes.pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_7__.takeUntil)(this._destroy$)).subscribe(function () {
              ...
              (_a = _this12._transitionIds) === null || _a === void 0 ? void 0 : _a.forEach(function (id) {
                return ngbCompleteTransition(_this12._getSlideElement(id));
              });
              _this12._transitionIds = null;

              _this12._cd.markForCheck(); // The following code need to be done asynchronously, after the dom becomes stable,
              // otherwise all changes will be undone.


              _this12._ngZone.onStable.pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_11__.take)(1)).subscribe(function () {
                var _iterator2 = _createForOfIteratorHelper(_this12.slides),
                    _step;
                ...
                try {
                  for (_iterator2.s(); !(_step = _iterator2.n()).done;) {
                    ...
                    var element = _this12._getSlideElement(id);

                    if (id === _this12.activeId) {
          ...
          value: function _cycleToSelected(slideIdx, direction, source) {
            ...
            if (selectedSlide && selectedSlide.id !== this.activeId) {
              ...
              (0, rxjs__WEBPACK_IMPORTED_MODULE_21__.zip).apply(void 0, transitions).pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_11__.take)(1)).subscribe(function () {
                _this13._transitionIds = null;

                _this13.slid.emit({
                  prev: previousId,
                  current: selectedSlide.id,
                  direction: direction,
                  paused: _this13._pause$.value,
                  source: source
                });
              });
      ...
      var _NgbCalendarGregorian = /*#__PURE__*/function (_NgbCalendar2) {
        ...
        var _super6 = _createSuper(_NgbCalendarGregorian);
      ...
      var _NgbDatepickerI18nDefault = /*#__PURE__*/function (_NgbDatepickerI18n2) {
        ...
        var _super7 = _createSuper(_NgbDatepickerI18nDefault);
        ...
        function _NgbDatepickerI18nDefault(_locale) {
          ...
          _this15._locale = _locale;
          _this15._monthsShort = (0, _angular_common__WEBPACK_IMPORTED_MODULE_12__.getLocaleMonthNames)(_locale, _angular_common__WEBPACK_IMPORTED_MODULE_12__.FormStyle.Standalone, _angular_common__WEBPACK_IMPORTED_MODULE_12__.TranslationWidth.Abbreviated);
          _this15._monthsFull = (0, _angular_common__WEBPACK_IMPORTED_MODULE_12__.getLocaleMonthNames)(_locale, _angular_common__WEBPACK_IMPORTED_MODULE_12__.FormStyle.Standalone, _angular_common__WEBPACK_IMPORTED_MODULE_12__.TranslationWidth.Wide);
          return _this15;
        }
        ...
        function NgbDatepickerService(_calendar, _i18n) {
          ...
          this._VALIDATORS = {
            dayTemplateData: function dayTemplateData(_dayTemplateData) {
              if (_this16._state.dayTemplateData !== _dayTemplateData) {
                return {
            ...
            displayMonths: function displayMonths(_displayMonths) {
              ...
              if (isInteger(_displayMonths) && _displayMonths > 0 && _this16._state.displayMonths !== _displayMonths) {
                return {
            ...
            disabled: function disabled(_disabled) {
              if (_this16._state.disabled !== _disabled) {
                return {
                  disabled: _disabled
                };
              }
            ...
            firstDayOfWeek: function firstDayOfWeek(_firstDayOfWeek) {
              ...
              if (isInteger(_firstDayOfWeek) && _firstDayOfWeek >= 0 && _this16._state.firstDayOfWeek !== _firstDayOfWeek) {
                return {
            ...
            focusVisible: function focusVisible(_focusVisible) {
              if (_this16._state.focusVisible !== _focusVisible && !_this16._state.disabled) {
                return {
            ...
            markDisabled: function markDisabled(_markDisabled) {
              if (_this16._state.markDisabled !== _markDisabled) {
                return {
            ...
            maxDate: function maxDate(date) {
              var maxDate = _this16.toValidDate(date, null);

              if (isChangedDate(_this16._state.maxDate, maxDate)) {
                return {
                  maxDate: maxDate
                };
              }
            ...
            minDate: function minDate(date) {
              var minDate = _this16.toValidDate(date, null);

              if (isChangedDate(_this16._state.minDate, minDate)) {
                return {
                  minDate: minDate
                };
              }
            ...
            navigation: function navigation(_navigation) {
              if (_this16._state.navigation !== _navigation) {
                return {
            ...
            outsideDays: function outsideDays(_outsideDays) {
              if (_this16._state.outsideDays !== _outsideDays) {
                return {
            ...
            weekdays: function weekdays(_weekdays) {
              ...
              if (_this16._state.weekdayWidth !== weekdayWidth || _this16._state.weekdaysVisible !== weekdaysVisible) {
                return {
        ...
        _createClass(NgbDatepickerService, [{
          ...
          value: function set(options) {
            ...
            var patch = Object.keys(options).map(function (key) {
              return _this17._VALIDATORS[key](options[key]);
          ...
          value: function getMonth(struct) {
            var _iterator3 = _createForOfIteratorHelper(this._state.months),
                _step2;
      ...
      var NgbDateStructAdapter = /*#__PURE__*/function (_NgbDateAdapter2) {
        ...
        var _super8 = _createSuper(NgbDateStructAdapter);
      ...
      var _NgbDatepicker = /*#__PURE__*/function () {
        function _NgbDatepicker(_service, _calendar, i18n, config, cd, _elementRef, _ngbDateAdapter, _ngZone) {
          ...
          _service.model$.pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_7__.takeUntil)(this._destroyed$)).subscribe(function (model) {
            ...
            var oldDate = _this18.model ? _this18.model.firstDate : null; // update public state

            _this18._publicState = {
            ...
            var oldFocusedDate = _this18.model ? _this18.model.focusDate : null;
            _this18.model = model; // handling selection change

            if (isChangedDate(newSelectedDate, _this18._controlValue)) {
              _this18._controlValue = newSelectedDate;

              _this18.onTouched();

              _this18.onChange(_this18._ngbDateAdapter.toModel(newSelectedDate));
        ...
        _createClass(_NgbDatepicker, [{
          ...
          value: function focus() {
            ...
            this._ngZone.onStable.asObservable().pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_11__.take)(1)).subscribe(function () {
              var elementToFocus = _this19._elementRef.nativeElement.querySelector('div.ngb-dp-day[tabindex="0"]');
          ...
          value: function ngAfterViewInit() {
            ...
            this._ngZone.runOutsideAngular(function () {
              var focusIns$ = (0, rxjs__WEBPACK_IMPORTED_MODULE_6__.fromEvent)(_this20._contentEl.nativeElement, 'focusin');
              var focusOuts$ = (0, rxjs__WEBPACK_IMPORTED_MODULE_6__.fromEvent)(_this20._contentEl.nativeElement, 'focusout');
              var nativeElement = _this20._elementRef.nativeElement; // we're changing 'focusVisible' only when entering or leaving months view
              ...
              }), (0, rxjs_operators__WEBPACK_IMPORTED_MODULE_7__.takeUntil)(_this20._destroyed$)).subscribe(function (_ref17) {
                var type = _ref17.type;
                return _this20._ngZone.run(function () {
                  return _this20._service.set({
          ...
          value: function ngOnInit() {
            ...
            if (this.model === undefined) {
              ...
              ['dayTemplateData', 'displayMonths', 'markDisabled', 'firstDayOfWeek', 'navigation', 'minDate', 'maxDate', 'outsideDays', 'weekdays'].forEach(function (name) {
                return inputs[name] = _this21[name];
              });
          ...
          value: function ngOnChanges(changes) {
            ...
            ['dayTemplateData', 'displayMonths', 'markDisabled', 'firstDayOfWeek', 'navigation', 'minDate', 'maxDate', 'outsideDays', 'weekdays'].filter(function (name) {
              ...
              return inputs[name] = _this22[name];
            });
      ...
      function ngbPositioning() {
        ...
        return {
          createPopper: function createPopper(positioningOption) {
            if (!popperInstance) {
              var _updatePopperOptions = positioningOption.updatePopperOptions || noop;

              var popperOptions = _updatePopperOptions(getPopperOptions(positioningOption));
          ...
          setOptions: function setOptions(positioningOption) {
            if (popperInstance) {
              var _updatePopperOptions2 = positioningOption.updatePopperOptions || noop;

              var popperOptions = _updatePopperOptions2(getPopperOptions(positioningOption));
      ...
      var _NgbInputDatepickerConfig = /*#__PURE__*/function (_NgbDatepickerConfig2) {
        ...
        var _super9 = _createSuper(_NgbInputDatepickerConfig);
        ...
        function _NgbInputDatepickerConfig() {
          ...
          _this23.autoClose = true;
          _this23.placement = ['bottom-start', 'bottom-end', 'top-start', 'top-end'];
          _this23.restoreFocus = true;
          return _this23;
        }
      ...
      var NgbDateISOParserFormatter = /*#__PURE__*/function (_NgbDateParserFormatt) {
        ...
        var _super10 = _createSuper(NgbDateISOParserFormatter);
      ...
      var _NgbInputDatepicker = /*#__PURE__*/function () {
        function _NgbInputDatepicker(_parserFormatter, _elRef, _vcRef, _renderer, _ngZone, _calendar, _dateAdapter, _document, _changeDetector, config) {
          ...
          ['autoClose', 'container', 'positionTarget', 'placement'].forEach(function (input) {
            return _this24[input] = config[input];
          });
          this._zoneSubscription = _ngZone.onStable.subscribe(function () {
            return _this24._positioning.update();
          });
        }
        ...
        _createClass(_NgbInputDatepicker, [{
          ...
          value: function open() {
            ...
            if (!this.isOpen()) {
              ...
              this._cRef.instance.registerOnChange(function (selectedDate) {
                _this25.writeValue(selectedDate);

                _this25._onChange(selectedDate);
              ...
              this._ngZone.onStable.pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_11__.take)(1)).subscribe(function () {
                if (_this25._cRef) {
                  _this25._positioning.createPopper({
                    hostElement: hostElement,
                    targetElement: _this25._cRef.location.nativeElement,
                    placement: _this25.placement,
                    appendToBody: _this25.container === 'body'
                  });
                }
              });
          ...
          value: function _applyDatepickerInputs(datepickerInstance) {
            ...
            ['dayTemplate', 'dayTemplateData', 'displayMonths', 'firstDayOfWeek', 'footerTemplate', 'markDisabled', 'minDate', 'maxDate', 'navigation', 'outsideDays', 'showNavigation', 'showWeekNumbers', 'weekdays'].forEach(function (optionName) {
              if (_this26[optionName] !== undefined) {
                datepickerInstance[optionName] = _this26[optionName];
              }
            });
          ...
          value: function _subscribeForDatepickerOutputs(datepickerInstance) {
            ...
            datepickerInstance.navigate.subscribe(function (navigateEvent) {
              return _this27.navigate.emit(navigateEvent);
            });
            datepickerInstance.dateSelect.subscribe(function (date) {
              _this27.dateSelect.emit(date);

              if (_this27.autoClose === true || _this27.autoClose === 'inside') {
                _this27.close();
              }
            });
          }
      ...
      var NgbCalendarHijri = /*#__PURE__*/function (_NgbCalendar3) {
        ...
        var _super11 = _createSuper(NgbCalendarHijri);
      ...
      var _NgbCalendarIslamicCivil = /*#__PURE__*/function (_NgbCalendarHijri) {
        ...
        var _super12 = _createSuper(_NgbCalendarIslamicCivil);
      ...
      var _NgbCalendarIslamicUmalqura = /*#__PURE__*/function (_NgbCalendarIslamicCi) {
        ...
        var _super13 = _createSuper(_NgbCalendarIslamicUmalqura);
      ...
      var _NgbCalendarPersian = /*#__PURE__*/function (_NgbCalendar4) {
        ...
        var _super14 = _createSuper(_NgbCalendarPersian);
      ...
      var _NgbCalendarHebrew = /*#__PURE__*/function (_NgbCalendar5) {
        ...
        var _super15 = _createSuper(_NgbCalendarHebrew);
      ...
      var _NgbDatepickerI18nHebrew = /*#__PURE__*/function (_NgbDatepickerI18n3) {
        ...
        var _super16 = _createSuper(_NgbDatepickerI18nHebrew);
      ...
      var _NgbCalendarBuddhist = /*#__PURE__*/function (_NgbCalendarGregorian2) {
        ...
        var _super17 = _createSuper(_NgbCalendarBuddhist);
      ...
      var _NgbDateNativeAdapter = /*#__PURE__*/function (_NgbDateAdapter3) {
        ...
        var _super18 = _createSuper(_NgbDateNativeAdapter);
      ...
      var _NgbDateNativeUTCAdapter = /*#__PURE__*/function (_NgbDateNativeAdapter2) {
        ...
        var _super19 = _createSuper(_NgbDateNativeUTCAdapter);
      ...
      var _NgbDropdownToggle = /*#__PURE__*/function (_NgbDropdownAnchor2) {
        ...
        var _super20 = _createSuper(_NgbDropdownToggle);

        function _NgbDropdownToggle(dropdown, elementRef) {
          _classCallCheck(this, _NgbDropdownToggle);

          return _super20.call(this, dropdown, elementRef);
        }
      ...
      var _NgbDropdown = /*#__PURE__*/function () {
        ...
        _createClass(_NgbDropdown, [{
          ...
          value: function ngAfterContentInit() {
            ...
            this._ngZone.onStable.pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_11__.take)(1)).subscribe(function () {
              _this30._applyPlacementClasses();

              if (_this30._open) {
                _this30._setCloseHandlers();
              }
            });
          }
        }, {
            ...
            if (!this._open) {
              ...
              if (this._anchor) {
                ...
                if (this.display === 'dynamic') {
                  this._ngZone.onStable.pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_11__.take)(1)).subscribe(function () {
                    _this31._positioning.createPopper({
                      hostElement: _this31._anchor.nativeElement,
                      targetElement: _this31._bodyContainer || _this31._menu.nativeElement,
                      placement: _this31.placement,
                      appendToBody: _this31.container === 'body'
                    });

                    _this31._applyPlacementClasses();
                  });
                }
              }
            }
          ...
          value: function _setCloseHandlers() {
            ...
            ngbAutoClose(this._ngZone, this._document, this.autoClose, function (source) {
              ...
              /* ESCAPE */
                ...
                _this32._anchor.nativeElement.focus();
              }
          ...
          value: function onKeyDown(event) {
            ...
            if (!isEventFromToggle && itemElements.length) {
              itemElements.forEach(function (item, index) {
                ...
                if (item === _this33._document.activeElement) {
                  position = index;
                }
              });
              ...
              if (event.target && this.isOpen() && this.autoClose) {
                if (this._anchor.nativeElement === event.target) {
                  ...
                  (0, rxjs__WEBPACK_IMPORTED_MODULE_6__.fromEvent)(event.target, 'focusout').pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_11__.take)(1)).subscribe(function (_ref24) {
                    ...
                    if (!_this33._elementRef.nativeElement.contains(relatedTarget)) {
                      _this33.close();
                    }
                  });
                }
      ...
      var PopupService = /*#__PURE__*/function () {
        ...
        _createClass(PopupService, [{
          ...
          value: function open(content, context) {
            ...
            var transition$ = this._ngZone.onStable.pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_11__.take)(1), (0, rxjs_operators__WEBPACK_IMPORTED_MODULE_30__.mergeMap)(function () {
              return ngbRunTransition(_this34._ngZone, nativeElement, function (_ref25) {
          ...
          value: function close() {
            ...
            return ngbRunTransition(this._ngZone, this._windowRef.location.nativeElement, function (_ref26) {
              ...
              if (_this35._windowRef) {
                ...
                _this35._viewContainerRef.remove(_this35._viewContainerRef.indexOf(_this35._windowRef.hostView));

                _this35._windowRef = null;
              }

              if ((_a = _this35._contentRef) === null || _a === void 0 ? void 0 : _a.viewRef) {
                _this35._applicationRef.detachView(_this35._contentRef.viewRef);

                _this35._contentRef.viewRef.destroy();

                _this35._contentRef = null;
              }
            }));
          }
        }, {
        ...
        _createClass(NgbModalBackdrop, [{
          ...
          value: function ngOnInit() {
            ...
            this._zone.onStable.asObservable().pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_11__.take)(1)).subscribe(function () {
              ngbRunTransition(_this36._zone, _this36._el.nativeElement, function (element, animation) {
                if (animation) {
                  reflow(element);
                }
      ...
      var _NgbModalRef = /*#__PURE__*/function () {
        function _NgbModalRef(_windowCmptRef, _contentRef, _backdropCmptRef, _beforeDismiss) {
          ...
          _windowCmptRef.instance.dismissEvent.subscribe(function (reason) {
            _this37.dismiss(reason);
          });

          this.result = new Promise(function (resolve, reject) {
            _this37._resolve = resolve;
            _this37._reject = reject;
          });
        ...
        _createClass(_NgbModalRef, [{
          ...
          value: function _removeModalElements() {
            ...
            windowTransition$.subscribe(function () {
              var nativeElement = _this39._windowCmptRef.location.nativeElement;
              nativeElement.parentNode.removeChild(nativeElement);

              _this39._windowCmptRef.destroy();

              if (_this39._contentRef && _this39._contentRef.viewRef) {
                _this39._contentRef.viewRef.destroy();
              }

              _this39._windowCmptRef = null;
              _this39._contentRef = null;
            }); // hiding backdrop

            backdropTransition$.subscribe(function () {
              if (_this39._backdropCmptRef) {
                var nativeElement = _this39._backdropCmptRef.location.nativeElement;
                nativeElement.parentNode.removeChild(nativeElement);

                _this39._backdropCmptRef.destroy();

                _this39._backdropCmptRef = null;
              }
            }); // all done

            (0, rxjs__WEBPACK_IMPORTED_MODULE_21__.zip)(windowTransition$, backdropTransition$).subscribe(function () {
              _this39._hidden.next();

              _this39._hidden.complete();
            });
          }
        }]);
        ...
        _createClass(NgbModalWindow, [{
          ...
          value: function _enableEventHandling() {
            ...
            this._zone.runOutsideAngular(function () {
              (0, rxjs__WEBPACK_IMPORTED_MODULE_6__.fromEvent)(nativeElement, 'keydown').pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_7__.takeUntil)(_this43._closed$),
              /* eslint-disable-next-line deprecation/deprecation */
              (0, rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.filter)(function (e) {
                return e.which === Key.Escape;
                  ...
                  requestAnimationFrame(function () {
                    if (!event.defaultPrevented) {
                      _this43._zone.run(function () {
                        return _this43.dismiss(_ModalDismissReasons.ESC);
                      });
                    }
                  });
                } else if (_this43.backdrop === 'static') {
                  _this43._bumpBackdrop();
                }
              }); // We're listening to 'mousedown' and 'mouseup' to prevent modal from closing when pressing the mouse
              // inside the modal dialog and releasing it outside

              var preventClose = false;
              (0, rxjs__WEBPACK_IMPORTED_MODULE_6__.fromEvent)(_this43._dialogEl.nativeElement, 'mousedown').pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_7__.takeUntil)(_this43._closed$), (0, rxjs_operators__WEBPACK_IMPORTED_MODULE_23__.tap)(function () {
                return preventClose = false;
              }), (0, rxjs_operators__WEBPACK_IMPORTED_MODULE_19__.switchMap)(function () {
                return (0, rxjs__WEBPACK_IMPORTED_MODULE_6__.fromEvent)(nativeElement, 'mouseup').pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_7__.takeUntil)(_this43._closed$), (0, rxjs_operators__WEBPACK_IMPORTED_MODULE_11__.take)(1));
              ...
              (0, rxjs__WEBPACK_IMPORTED_MODULE_6__.fromEvent)(nativeElement, 'click').pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_7__.takeUntil)(_this43._closed$)).subscribe(function (_ref29) {
                var target = _ref29.target;

                if (nativeElement === target) {
                  if (_this43.backdrop === 'static') {
                    _this43._bumpBackdrop();
                  } else if (_this43.backdrop === true && !preventClose) {
                    _this43._zone.run(function () {
                      return _this43.dismiss(_ModalDismissReasons.BACKDROP_CLICK);
                    });
                  }
                }
      ...
      var NgbModalStack = /*#__PURE__*/function () {
        function NgbModalStack(_applicationRef, _injector, _document, _scrollBar, _rendererFactory, _ngZone) {
          ...
          this._activeWindowCmptHasChanged.subscribe(function () {
            if (_this45._windowCmpts.length) {
              var activeWindowCmpt = _this45._windowCmpts[_this45._windowCmpts.length - 1];
              ngbFocusTrap(_this45._ngZone, activeWindowCmpt.location.nativeElement, _this45._activeWindowCmptHasChanged);

              _this45._revertAriaHidden();

              _this45._setAriaHidden(activeWindowCmpt.location.nativeElement);
            }
          });
        }
        ...
        _createClass(NgbModalStack, [{
          ...
          value: function open(moduleCFR, contentInjector, content, options) {
            ...
            var removeBodyClass = function removeBodyClass() {
              if (!_this46._modalRefs.length) {
                renderer.removeClass(_this46._document.body, 'modal-open');

                _this46._restoreScrollBar();

                _this46._revertAriaHidden();
              }
            };
            ...
            if (parent && element !== this._document.body) {
              Array.from(parent.children).forEach(function (sibling) {
                if (sibling !== element && sibling.nodeName !== 'SCRIPT') {
                  _this47._ariaHiddenValues.set(sibling, sibling.getAttribute('aria-hidden'));
          ...
          value: function _registerModalRef(ngbModalRef) {
            ...
            var unregisterModalRef = function unregisterModalRef() {
              var index = _this48._modalRefs.indexOf(ngbModalRef);

              if (index > -1) {
                _this48._modalRefs.splice(index, 1);

                _this48._activeInstances.emit(_this48._modalRefs);
              }
            };
          ...
          value: function _registerWindowCmpt(ngbWindowCmpt) {
            ...
            ngbWindowCmpt.onDestroy(function () {
              var index = _this49._windowCmpts.indexOf(ngbWindowCmpt);

              if (index > -1) {
                _this49._windowCmpts.splice(index, 1);

                _this49._activeWindowCmptHasChanged.next();
              }
            });
          }
        }]);
      ...
      */
        ...
        _createClass(_NgbNav, [{
          ...
          value: function onKeyDown(event) {
            ...
            enabledLinks.forEach(function (link, index) {
              if (link.elRef.nativeElement === _this50._document.activeElement) {
                position = index;
              }
            });
          ...
          value: function ngAfterContentInit() {
            ...
            this.items.changes.pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_7__.takeUntil)(this.destroy$)).subscribe(function () {
              return _this51._notifyItemChanged(_this51.activeId);
            });
          }
        }, {
          key: "ngOnChanges",
        ...
        _createClass(_NgbNavOutlet, [{
          ...
          value: function ngAfterViewInit() {
            ...
            this.nav.navItemChange$.pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_7__.takeUntil)(this.nav.destroy$), (0, rxjs_operators__WEBPACK_IMPORTED_MODULE_17__.startWith)(((_a = this._activePane) === null || _a === void 0 ? void 0 : _a.item) || null), (0, rxjs_operators__WEBPACK_IMPORTED_MODULE_18__.distinctUntilChanged)(), (0, rxjs_operators__WEBPACK_IMPORTED_MODULE_31__.skip)(1)).subscribe(function (nextItem) {
              var options = {
                animation: _this52.nav.animation,
                runningTransition: 'stop'
              }; // next panel we're switching to will only appear in DOM after the change detection is done
              // and `this._panes` will be updated

              _this52._cd.detectChanges(); // fading out


              if (_this52._activePane) {
                ngbRunTransition(_this52._ngZone, _this52._activePane.elRef.nativeElement, ngbNavFadeOutTransition, options).subscribe(function () {
                  var _a;

                  var activeItem = (_a = _this52._activePane) === null || _a === void 0 ? void 0 : _a.item;
                  _this52._activePane = _this52._getPaneForItem(nextItem); // mark for check when transition finishes as outlet or parent containers might be OnPush
                  // without this the panes that have "faded out" will stay in DOM

                  _this52._cd.markForCheck(); // fading in


                  if (_this52._activePane) {
                    // we have to add the '.active' class before running the transition,
                    // because it should be in place before `ngbRunTransition` does `reflow()`
                    _this52._activePane.elRef.nativeElement.classList.add('active');

                    ngbRunTransition(_this52._ngZone, _this52._activePane.elRef.nativeElement, ngbNavFadeInTransition, options).subscribe(function () {
                      if (nextItem) {
                        nextItem.shown.emit();

                        _this52.nav.shown.emit(nextItem.id);
                      }
                    });
                  }
                  ...
                  if (activeItem) {
                    ...
                    _this52.nav.hidden.emit(activeItem.id);
                  }
                });
              } else {
                _this52._updateActivePane();
              }
            });
          }
        }, {
        ...
        _createClass(_NgbPopover, [{
          ...
          value: function open(context) {
            ...
            if (!this._windowRef && !this._isDisabled()) {
              ...
              this._ngZone.onStable.pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_11__.take)(1)).subscribe(function () {
                _this54._positioning.createPopper({
                  hostElement: _this54._elementRef.nativeElement,
                  targetElement: _this54._windowRef.location.nativeElement,
                  placement: _this54.placement,
                  appendToBody: _this54.container === 'body',
                  baseClass: 'bs-popover',
                  updatePopperOptions: updatePopperOptions
                });
              });
      ...
      var NgbTimeStructAdapter = /*#__PURE__*/function (_NgbTimeAdapter2) {
        ...
        var _super21 = _createSuper(NgbTimeStructAdapter);
      ...
      var NgbTimepickerI18nDefault = /*#__PURE__*/function (_NgbTimepickerI18n2) {
        ...
        var _super22 = _createSuper(NgbTimepickerI18nDefault);
        ...
        function NgbTimepickerI18nDefault(locale) {
          ...
          _this56 = _super22.call(this);
          _this56._periods = (0, _angular_common__WEBPACK_IMPORTED_MODULE_12__.getLocaleDayPeriods)(locale, _angular_common__WEBPACK_IMPORTED_MODULE_12__.FormStyle.Standalone, _angular_common__WEBPACK_IMPORTED_MODULE_12__.TranslationWidth.Narrow);
          return _this56;
        }
        ...
        _createClass(_NgbTooltip, [{
          ...
          value: function open(context) {
            ...
            if (!this._windowRef && this._ngbTooltip && !this.disableTooltip) {
              ...
              this._ngZone.onStable.pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_11__.take)(1)).subscribe(function () {
                _this62._positioning.createPopper({
                  hostElement: _this62._elementRef.nativeElement,
                  targetElement: _this62._windowRef.location.nativeElement,
                  placement: _this62.placement,
                  appendToBody: _this62.container === 'body',
          ...
          value: function close() {
            ...
            if (this._windowRef != null) {
              ...
              this._popupService.close(this.animation).subscribe(function () {
                _this63._windowRef = null;

                _this63._positioning.destroy();

                _this63.hidden.emit();

                _this63._changeDetector.markForCheck();
              });
            }
          }
          /**
        ...
        _createClass(_NgbHighlight, [{
          ...
          value: function ngOnChanges(changes) {
            ...
            var prepareTerm = function prepareTerm(term) {
              return _this64.accentSensitive ? term : removeAccents(term);
            };
        ...
        _createClass(_NgbTypeahead, [{
          ...
          value: function _openPopup() {
            ...
            if (!this.isPopupOpen()) {
              ...
              this._windowRef.instance.selectEvent.subscribe(function (result) {
                return _this66._selectResultClosePopup(result);
              });

              this._windowRef.instance.activeChangeEvent.subscribe(function (activeId) {
                return _this66.activeDescendant = activeId;
              });
              ...
              this._ngZone.onStable.pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_11__.take)(1)).subscribe(function () {
                if (_this66._windowRef) {
                  _this66._positioning.createPopper({
                    hostElement: _this66._elementRef.nativeElement,
                    targetElement: _this66._windowRef.location.nativeElement,
                    placement: _this66.placement,
                    appendToBody: _this66.container === 'body'
                  });
                }
              });

              ngbAutoClose(this._ngZone, this._document, 'outside', function () {
                return _this66.dismissPopup();
          ...
          value: function _closePopup() {
            ...
            this._popupService.close().subscribe(function () {
              _this67._positioning.destroy();

              _this67._closed$.next();

              _this67._windowRef = null;
              _this67.activeDescendant = null;
            });
          }
        }, {
          key: "_selectResult",
          ...
          value: function _subscribeToUserInput() {
            ...
            var results$ = this._valueChanges.pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_23__.tap)(function (value) {
              _this68._inputValueBackup = _this68.showHint ? value : null;

              _this68._onChange(_this68.editable ? value : undefined);
