    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      function AccountClosureMaintenanceComponent_div_22_a_19_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("click", function AccountClosureMaintenanceComponent_div_22_a_19_Template_a_click_0_listener() {
      ...
      function AccountClosureMaintenanceComponent_div_29_a_57_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("click", function AccountClosureMaintenanceComponent_div_29_a_57_Template_a_click_0_listener() {
            ...
            var i_r20 = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵnextContext"]().index;
      ...
      var _AccountClosureMaintenanceComponent = /*#__PURE__*/function () {
        function _AccountClosureMaintenanceComponent(fb, roleService, toastService, accClosureService) {
        ...
        _createClass(_AccountClosureMaintenanceComponent, [{
          ...
          value: function getRespBasedOnAccountType(index) {
            ...
            this.accClosureService.gettingcompleteData(index).subscribe(function (resp) {
              _this7.array = resp.userDefinedFields;

              while (_this7.formArrUDF.length > 0) {
                _this7.formArrUDF.removeAt(_this7.formArrUDF.length - 1);
              }

              _this7.array.forEach(function (x) {
                _this7.formArrUDF.push(_this7.fb.group(x));
              });

              _this7.arrayAccountEntry = resp.accountingEntries;

              while (_this7.formArrAccountEntry.length > 0) {
                _this7.formArrAccountEntry.removeAt(_this7.formArrAccountEntry.length - 1);
              }

              _this7.arrayAccountEntry.forEach(function (x) {
                _this7.formArrAccountEntry.push(_this7.fb.group(x));
              });
            });
          ...
          value: function getAuditLog(index) {
            ...
            this.accClosureService.gettingAccountClosureMaintenance().subscribe(function (summaryResp) {
              _this8.filterAuditLog(summaryResp, index);
            });
          }
        }, {
          key: "filterAuditLog",
          ...
          value: function onAuthorizingTheRecord() {
            ...
            this.accClosureService.onAuthofAccMaint(this.index, this.currentUser).subscribe(function (authResp) {
              _this11.accAuditDetails = authResp;

              if (_this11.accAuditDetails.accountType === "" || _this11.accAuditDetails.accountType == null) {
                sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire({
              ...
              if (_this11.accAuditDetails.recordStatus == "O") {
                _this11.accAuditDetails.recordStatus = "OPEN";
              }

              if (_this11.accAuditDetails.recordStatus == "C") {
                _this11.accAuditDetails.recordStatus = "CLOSE";
              }

              if (_this11.accAuditDetails.verifiedStatus == "U") {
                _this11.accAuditDetails.verifiedStatus = "UNAUTHORIZED";
              }

              if (_this11.accAuditDetails.verifiedStatus == "A") {
                _this11.accAuditDetails.verifiedStatus = "AUTHORIZED";
              }

              if (_this11.accAuditDetails.verifiedOnce == "Y") {
                _this11.accAuditDetails.verifiedOnce = "YES";
              }

              if (_this11.accAuditDetails.verifiedOnce == "N") {
                _this11.accAuditDetails.verifiedOnce = "NO";
              }
            });
          }
        }, {
          ...
          value: function onSubmittingTheAccMaintenanceClosureData() {
            ...
            this.accClosureService.submittingTheEditedRecord(this.payload, this.index, this.currentUser).subscribe(function (editScreenResp) {
              ...
              _this12.accAuditDetails = editScreenResp;

              if (!_this12.accAuditDetails) {
                {
                  sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire({
              ...
              _this12.getAuditLog(_this12.index);
            });
            this.editFlag = false;
          }
        }]);
