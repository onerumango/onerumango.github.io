(function () {
  ...
  (self["webpackChunkmedian"] = self["webpackChunkmedian"] || []).push([["src_app_views_account-closure-maintenance_account-closure-maintenance_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      function AccountClosureMaintenanceComponent_div_37_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("click", function AccountClosureMaintenanceComponent_div_37_Template_button_click_1_listener() {
      ...
      function AccountClosureMaintenanceComponent_div_38_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("click", function AccountClosureMaintenanceComponent_div_38_Template_button_click_1_listener() {
            ...
            return ctx_r31.onAuthorizingTheRecord();
          });
      ...
      function AccountClosureMaintenanceComponent_div_39_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function AccountClosureMaintenanceComponent_button_45_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("click", function AccountClosureMaintenanceComponent_button_45_Template_button_click_0_listener() {
            ...
            return ctx_r37.onSubmittingTheAccMaintenanceClosureData();
          });
        ...
        _createClass(_AccountClosureMaintenanceComponent, [{
          ...
          value: function onClosingTheRecord() {
            ...
            sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire({
              ...
              if (result.isConfirmed === true) {
                _this9.accClosureService.onClosingTheRecord(_this9.index, _this9.currentUser).subscribe(function (closeResp) {
                  _this9.accAuditDetails = closeResp;

                  if (_this9.accAuditDetails) {
                    _this9.auditLog();
          ...
          value: function onReopningTheRecord() {
            ...
            sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire({
              ...
              if (result.isConfirmed === true) {
                _this10.accClosureService.onReopningTheRecord(_this10.index, _this10.currentUser).subscribe(function (reopnResp) {
          ...
          value: function onAuthorizingTheRecord() {
            ...
            sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire({
              ...
              if (result.isConfirmed === true) {
                if (_this11.currentUser === _this11.accAuditDetails.inputBy) {
                  sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire({
                ...
                _this11.accClosureService.onAuthofAccMaint(_this11.index, _this11.currentUser).subscribe(function (authResp) {
