      ...
      _UserListComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({
        ...
        template: function UserListComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("click", function UserListComponent_Template_a_click_7_listener() {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      function UserNewComponent_div_60_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵlistener"]("click", function UserNewComponent_div_60_Template_button_click_3_listener($event) {
      ...
      function UserNewComponent_div_61_div_2_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵlistener"]("click", function UserNewComponent_div_61_div_2_Template_a_click_1_listener() {
      ...
      function UserNewComponent_div_61_div_3_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵlistener"]("click", function UserNewComponent_div_61_div_3_Template_a_click_1_listener() {
      ...
      function UserNewComponent_div_61_div_4_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵlistener"]("click", function UserNewComponent_div_61_div_4_Template_a_click_1_listener() {
      ...
      function UserNewComponent_div_61_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵlistener"]("click", function UserNewComponent_div_61_Template_a_click_8_listener() {
        ...
        _createClass(_UserNewComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.navSubscription = this.userApi.getNavParam.subscribe(function (data) {
              return _this2.editUserScreen = data;
            });
          ...
          value: function getAllRolesNames() {
            ...
            this.roleService.getAllRoles().subscribe(function (data) {
              _this3.allRoleNames = data;
              console.log(_this3.allRoleNames, data);
            });
          }
        }, {
          key: "getAllDeptNames",
          value: function getAllDeptNames() {
            ...
            this.roleService.getAllDept().subscribe(function (data) {
              _this4.allDeptNames = data;
              console.log(_this4.allDeptNames);
            });
          }
        }, {
          key: "onClickOfCloseOfModifyUSers",
          value: function onClickOfCloseOfModifyUSers() {
            ...
            this.userApi.onClickOfCloseOfModifyUsers(this.modifyUserObject.userId, this.modifyUserObject.creatorId).subscribe(function (dataofCloseFromBackend) {
              ...
              _this5.statusFlag = dataofCloseFromBackend;

              if (_this5.statusFlag === true) {
                sweetalert2__WEBPACK_IMPORTED_MODULE_2___default().fire('You closed the user record'); //console.log('coming or not');

                _this5.getUpdatedModifiedObject(); // this.cdr.markForCheck();


                _this5.getUserAuditData(); // this.iziToast.show({
          ...
          value: function onClickOfReOpenOfModifyUsers() {
            ...
            this.userApi.onClickOfReopenOfModifyUser(this.modifyUserObject.userId, this.modifyUserObject.creatorId).subscribe(function (dataOfReopen) {
              ...
              _this6.statusFlag = dataOfReopen; //console.log(this.modifyUserObject);
          ...
          value: function onClickOfDeleteOfModifyUser() {
            ...
            this.userApi.onClickOfDeleteOfModifyUser(this.modifyUserObject.userId).subscribe(function (datafrombackendtoDelete) {
              ...
              _this7.deleteStatusFlag = datafrombackendtoDelete;

              if (_this7.deleteStatusFlag === true) {
              ...
              if (_this7.deleteStatusFlag === false) {
                sweetalert2__WEBPACK_IMPORTED_MODULE_2___default().fire({
                  icon: 'error',
          ...
          value: function onClickOfAuthOfModifyUsers() {
            ...
            this.userApi.onClickOfAuthOfModifyUsers(this.modifyUserObject.userId, localStorage.getItem('currentUser')).subscribe(function (dataOfModifyUserFromBackEnd) {
              ...
              _this8.authStatusFlag = dataOfModifyUserFromBackEnd;
              console.log(_this8.modifyUserObject);
              console.log(_this8.authStatusFlag);

              if (_this8.authStatusFlag === true) {
                ...
                _this8.getUpdatedModifiedObject(); // this.cdr.markForCheck();


                _this8.getUserAuditData();
              }

              if (_this8.authStatusFlag === false) {
                sweetalert2__WEBPACK_IMPORTED_MODULE_2___default().fire({
                  icon: 'error',
          ...
          value: function getUpdatedModifiedObject() {
            ...
            this.userApi.getUserObjModified(this.modifyUserObject.userId).subscribe(function (gettingBackendData) {
              ...
              _this9.modifyUserObject = gettingBackendData; //console.log(this.modifyUserObject);
            });
          }
        }, {
          ...
          value: function onModifyFormSubmit() {
            ...
            this.userApi.modifyUserService(this.modifyUserObject).subscribe(function (data) {
              _this10.statusFlag = data;

              if (_this10.statusFlag === true) {
                ...
                _this10.getUserAuditData();

                _this10.editFlag = false;
              }

              if (_this10.statusFlag === false) {
                sweetalert2__WEBPACK_IMPORTED_MODULE_2___default().fire({
                  icon: 'error',
          ...
          value: function getUserAuditData() {
            ...
            this.userApi.getUserAuditService(this.modifyUserObject.userId).subscribe(function (data) {
              _this11.userObjWithAudit = data;
              console.log('dev code user audit: ', _this11.userObjWithAudit);
              console.log(_this11.userObjWithAudit);

              if (_this11.userObjWithAudit.verifiedStatus === 'U') {
                _this11.userObjWithAudit.verifiedStatus = 'UNAUTHORIZED';
              }

              if (_this11.userObjWithAudit.verifiedStatus === 'A') {
                _this11.userObjWithAudit.verifiedStatus = 'AUTHORIZED';
              }
              /*
              */


              if (_this11.userObjWithAudit.verifiedOnce === 'N') {
                _this11.userObjWithAudit.verifiedOnce = 'NO';
              }

              if (_this11.userObjWithAudit.verifiedOnce === 'Y') {
                _this11.userObjWithAudit.verifiedOnce = 'YES';
              }
              /**
              ...
              if (_this11.userObjWithAudit.recordStatus === 'O') {
                _this11.userObjWithAudit.recordStatus = 'OPEN';
              }

              if (_this11.userObjWithAudit.recordStatus === 'C') {
                _this11.userObjWithAudit.recordStatus = 'CLOSED';
              }
            });
          }
        }, {
          ...
          value: function onFormSubmit(event) {
            ...
            this.userApi.createUserService(this.userObj).subscribe(function (data) {
              ...
              console.log('create');
              _this12.statusFlag = data; //console.log(this.allRoleNames);
      ...
      _UserNewComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdefineComponent"]({
        ...
        template: function UserNewComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵlistener"]("ngModelChange", function UserNewComponent_Template_input_ngModelChange_8_listener($event) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵlistener"]("ngModelChange", function UserNewComponent_Template_input_ngModelChange_11_listener($event) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵlistener"]("click", function UserNewComponent_Template_span_click_16_listener() {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵlistener"]("ngModelChange", function UserNewComponent_Template_input_ngModelChange_24_listener($event) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵlistener"]("ngModelChange", function UserNewComponent_Template_select_ngModelChange_33_listener($event) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵlistener"]("ngModelChange", function UserNewComponent_Template_input_ngModelChange_41_listener($event) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵlistener"]("ngModelChange", function UserNewComponent_Template_input_ngModelChange_44_listener($event) {
