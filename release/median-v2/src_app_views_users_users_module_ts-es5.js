    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      function UserNewComponent_div_73_div_4_Template(rf, ctx) {
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵproperty"]("disabled", ctx_r30.authBtn);
      ...
      var _UserNewComponent = /*#__PURE__*/function () {
        ...
        _createClass(_UserNewComponent, [{
          ...
          value: function onClickOfAuthOfModifyUsers() {
            ...
            this.userApi.onClickOfAuthOfModifyUsers(this.modifyUserObject.userId, this.currentUser).subscribe(function (dataOfModifyUserFromBackEnd) {
              //console.log(dataOfModifyUserFromBackEnd);
              _this14.authStatusFlag = dataOfModifyUserFromBackEnd;
              console.log(_this14.modifyUserObject);
              console.log(_this14.authStatusFlag);

              if (_this14.authStatusFlag === true) {
                sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire('you Authorized the user '); // this.iziToast.show({
                ...
                _this14.getUpdatedModifiedObject(); // this.cdr.markForCheck();


                _this14.getUserAuditData();
              }

              if (_this14.authStatusFlag === false) {
                sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire({
                  icon: 'error',
