(function () {
  ...
  (self["webpackChunkmedian"] = self["webpackChunkmedian"] || []).push([["src_app_views_authorize-modification_authorize-modification_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var src_app_views_users_users_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      ...
      function AuthorizeModificationComponent_tr_25_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵlistener"]("click", function AuthorizeModificationComponent_tr_25_Template_button_click_2_listener() {
            ...
            return ctx_r4.queryDetailsDataByParam(data_r3);
          });
      ...
      function AuthorizeModificationComponent_button_55_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵlistener"]("click", function AuthorizeModificationComponent_button_55_Template_button_click_0_listener() {
            ...
            return ctx_r7.approveSecondLevel();
          });
          ...
          value: function approveSecondLevel() {
            ...
            this.api.authorizeSecondLevel(this.pendingForAuthDetailsListAll, localStorage.getItem('currentUser')).subscribe(function (resp) {
              ...
              if (_this3.firstLevelAuthorizationStatus) {
                ...
                _this3.toastService.infoMessage('You authorized the record to second level ', '');
              }

              if (!_this3.firstLevelAuthorizationStatus) {
                _this3.progress = false;

                _this3.toastService.errorMessage('Error', 'You failed to authorize the record.');
              }
            });
          ...
          value: function queryDetailsDataByParam(pendingForAuthDTO) {
            ...
            this.api.queryDetailsDataByParamServiceSecond(this.getDetailsQueryToggleReqDTO).subscribe(function (resp) {
              ...
              if (_this5.pendingForAuthDetailsListAll.length > 0) {
                ...
                _this5.toastService.errorMessage('Edit the data from modify excel screen', 'No data found.');
              }
          ...
          value: function approveAndProcess() {
            ...
            this.api.processDeUpload(this.deUploadReqDTO, this.user_id).subscribe(function (resp) {
              ...
              if (_angular_common_http__WEBPACK_IMPORTED_MODULE_13__.HttpErrorResponse) {
                ...
                _this7.toastService.errorMessage('Error', 'Failed to connect to flexcube');
              }
            });
          }
        }, {
