(function () {
  ...
  (self["webpackChunkmedian"] = self["webpackChunkmedian"] || []).push([["src_app_views_file-upload_file-upload_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var src_app_views_users_users_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      ...
      function AuthorizeExcelComponent_tr_29_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵlistener"]("click", function AuthorizeExcelComponent_tr_29_Template_button_click_2_listener() {
            ...
            return ctx_r7.queryDetailsDataByParam(data_r6);
          });
      ...
      function AuthorizeExcelComponent_button_61_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵlistener"]("click", function AuthorizeExcelComponent_button_61_Template_button_click_0_listener() {
            ...
            return ctx_r14.approveDetailsData();
          });
      ...
      var _AuthorizeExcelComponent = /*#__PURE__*/function () {
        function _AuthorizeExcelComponent(api, roleService, userApi, excelService, toastService) {
          ...
          value: function reject() {
            ...
            this.api.rejectCallApi(this.deUploadReqDTO, this.user_id, this.rejectReason).subscribe(function (resp) {
              ...
              if (_this4.datarejection) {
                _this4.toastService.successMessage('Rejection successful.', '');
              } else {
                _this4.toastService.errorMessage('Rejection failed.', '');
              }
          ...
          value: function approveDetailsData() {
            ...
            this.api.approveDetailsData(this.deUploadReqDTO, this.user_id).subscribe(function (resp) {
              ...
              if (!_this5.firstLevelAuthorizationStatus) {
                _this5.toastService.errorMessage('Data authorization is failed.', '');
          ...
          value: function Process() {
            ...
            this.api.processDeUploadt(this.deUploadReqDTO, this.user_id).subscribe(function (resp) {
              ...
              if (!_this6.responseforDE) {
                ...
                _this6.toastService.errorMessage('Unable to connect core banking. Server Failed to process the request.', '');
              } else {
                _this6.spinner = false;
              }
            });
          ...
          value: function queryDetailsDataByParam(pendingForAuthDTO) {
            ...
            this.api.queryDetailsDataByParamService(this.getDetailsQueryToggleReqDTO).subscribe(function (resp) {
              ...
              if (_this8.pendingForAuthDetailsDTOList.length > 0) {
                ...
                _this8.toastService.errorMessage('Data Not Found', '');
              }
            });
            this.spinner1 = false;
          }
      ...
      _AuthorizeExcelComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵdefineComponent"]({
        ...
        directives: [angular_datatables__WEBPACK_IMPORTED_MODULE_11__.DataTableDirective, _angular_common__WEBPACK_IMPORTED_MODULE_15__.NgForOf, _angular_common__WEBPACK_IMPORTED_MODULE_15__.NgIf],
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var ngx_dialogs__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
      /*! ngx-dialogs */
      92676);
      /* harmony import */
      ...
      function FileUploadComponent_option_16_Template(rf, ctx) {
        ...
        if (rf & 2) {
          var extSysName_r9 = ctx.$implicit;
      ...
      function FileUploadComponent_option_23_Template(rf, ctx) {
        ...
        if (rf & 2) {
          var processName_r10 = ctx.$implicit;
      ...
      function FileUploadComponent_div_35_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵlistener"]("keypress", function FileUploadComponent_div_35_Template_input_keypress_3_listener($event) {
            ...
            return ctx_r12.valuechange($event);
            ...
            return ctx_r14.fun(ctx_r14.excelDataProcessingReqDTO.fileName);
          });
      ...
      function FileUploadComponent_div_36_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵlistener"]("change", function FileUploadComponent_div_36_Template_input_change_4_listener($event) {
            ...
            return ctx_r15.getFiledata($event, ctx_r15.uploadExcelForm.get("extSysNameData").value, ctx_r15.uploadExcelForm.get("processNameData").value, ctx_r15.uploadExcelForm.get("fileName").value);
          });
      ...
      function FileUploadComponent_div_50_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵlistener"]("click", function FileUploadComponent_div_50_Template_button_click_46_listener() {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵlistener"]("click", function FileUploadComponent_div_50_Template_button_click_49_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵrestoreView"](_r18);

            var ctx_r19 = _angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵnextContext"]();

            return ctx_r19.deleteDataService(ctx_r19.uploadExcelForm.get("remarks").value);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵlistener"]("click", function FileUploadComponent_div_50_Template_button_click_55_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵrestoreView"](_r18);
      ...
      var _FileUploadComponent = /*#__PURE__*/function () {
        function _FileUploadComponent(api, userApi, fb, toastService, excelService, roleService) {
        ...
        _createClass(_FileUploadComponent, [{
          ...
          value: function doFirstValidation() {
            ...
            if (this.uploadExcelForm.invalid) {
              ...
              this.api.showDetailServiceInExcelDataProcessing(this.excelDataProcessingReqDTO, this.user_id).subscribe(function (responseforfileupload) {
                ...
                console.log(_this17.responseforfileupload.respDto.batchNo);
                console.log(_this17.responseforfileupload.respDto);
                _this17.spinner = false;
                _this17.disbaleBtn = false;
                _this17.disablebtn2 = false;

                if (_this17.responseforfileupload == null) {
                  _this17.toastService.errorMessage('Server error.', '');
                ...
                if (_this17.responseforfileupload.respDto.errorMessage) {
                  console.log("here is error of duplicate record");
                  _this17.disablebtn2 = true;

                  _this17.toastService.errorMessage('Unable to upload', 'Error: ' + _this17.responseforfileupload.respDto.errorMessage);

                  if (_this17.responseforfileupload.respDto.errorMessage === "possible duplicate data") {
                    _this17.excelDataProcessingReqDTO.proceedDuplicates = true;
                    console.log("here duplicate");
                    var showDialog = new ngx_dialogs__WEBPACK_IMPORTED_MODULE_13__.Ngxalert();
                    showDialog.create({
                      ...
                      confirm: function confirm() {
                        _this17.api.showDetailServiceInExcelDataProcessing(_this17.excelDataProcessingReqDTO, _this17.user_id).subscribe(function (dupliacteResp) {
                          ...
                          _this17.responseDto = _this17.responseforfileupload.respDto;

                          if (_this17.responseforfileupload.respDto.errorMessage === "Amount and LCY amount mismatch") {
                            _this17.toastService.errorMessage('Unable to upload. ', 'Error: ' + _this17.responseforfileupload.respDto.errorMessage);
                          }

                          if (_this17.responseDto.totalNoOfRecords !== 0) {
                            _this17.toastService.successMessage('Data uploaded successfully', 'For the Batch ' + _this17.responseDto.batchNo);
                          ...
                          console.log("________", _this17.responseforfileupload.respDto.errorMessage);
                        });
                      }
                    });
                  }
                ...
                if (_this17.responseforfileupload.excelData) {
                  console.log('value date', _this17.pipe.transform(_this17.responseforfileupload.excelData[0].valueDate, 'dd-MMM-yy'));

                  d: new Date();

                  console.log(_this17.pipe.transform(new Date(), 'dd-MMM-yy'));
                  _this17.a = _this17.pipe.transform(_this17.responseforfileupload.excelData[0].valueDate, 'dd-MMM-yy');
                  _this17.b = _this17.pipe.transform(new Date(), 'dd-MMM-yy');
                  console.log("inside second if of value date");
                  console.log('value date', _this17.responseforfileupload.excelData[0].valueDate);
                  console.log('a', _this17.a);
                  console.log('b', _this17.b);

                  if (_this17.a == _this17.b) {
                    _this17.valueDate = "Today";
                  } else {
                    _this17.valueDate = "not Today";
                  }

                  console.log(_this17.valueDate);
                  _this17.spinner = false;
            ...
            if (this.valueDate != "Today") {
              ...
              this.api.processDataService(this.responseforfileupload, this.user_id, this.uploadExcelForm.get('remarks').value).subscribe(function (resp) {
                ...
                if (_this22.processDataStatus) {
                  _this22.toastService.successMessage('Data processed successfully', 'For the Batch ' + _this22.responseDto.batchNo);

                  _this22.isShow = true;
                } else {
                  _this22.toastService.errorMessage('Unable to process.', '');
                }
              });
            }
          }
            ...
            showDialog.create({
              ...
              confirm: function confirm() {
                ...
                if (_this23.responseDto.totalNoOfRecords == 0) {
                  _this23.toastService.errorMessage('Unable to process.', 'Total no. of record is 0.');

                  return;
                }

                if (!_this23.uploadExcelForm.get('remarks').value) {
                  _this23.toastService.errorMessage('Remark is mandatory for process.', '');
                ...
                _this23.api.processDataService(_this23.responseforfileupload, _this23.user_id, _this23.uploadExcelForm.get('remarks').value).subscribe(function (resp) {
                  _this23.processDataStatus = resp;
                  console.log('this.processDataStatus');

                  if (_this23.processDataStatus) {
                    _this23.toastService.successMessage('Data processed successfully', 'For the Batch ' + _this23.responseDto.batchNo);

                    _this23.isShow = true;
                  } else {
                    _this23.toastService.errorMessage('Unable to process.', '');
                  }
                });
              }
            });
          ...
          value: function testAlert() {
            ...
            this.api.test(this.user_id).subscribe(function (resp) {
              _this24.test = _this24.test;
              console.log(_this24.test);
            });
          }
        }, {
          key: "downloadData",
          value: function downloadData() {
            ...
            this.responseforfileupload.excelData.forEach(function (element) {
              ...
              if (element.drCr == 'C') {
                _this25.credit = element.lcyEquivalent;
                _this25.debit = 0;
              } else {
                _this25.debit = element.lcyEquivalent;
                _this25.credit = 0;
              }

              _this25.dataForProcessScreen1.push({
                'Batch_No': element.id.batchNo,
                ...
                FcyAmount: element.amount,
                Exch_Rate: element.exchRate,
                DrLcyAmt: _this25.debit,
                CrLcyAmt: _this25.credit,
                Instr_code: element.instrumentNo,
                'Value_Date': _this25.pipe.transform(element.valueDate, 'dd-MMM-yy'),
                User_Id: element.inputBy,
              ...
              console.log(_this25.dataForProcessScreen1, 'screen', _this25.excelFileFlag);

              if (_this25.excelFileFlag) {
                for (var i = 0; i < _this25.dataForProcessScreen1.length; i++) {
                  delete _this25.dataForProcessScreen1[i].Validation_Error;
                  delete _this25.dataForProcessScreen1[i].Error_Desc;
                } //for loop endning
              ...
              if (event) {
                if (event.status == 200) {
                  if (event instanceof _angular_common_http__WEBPACK_IMPORTED_MODULE_15__.HttpResponse) {
                    _this26.toastService.infoMessage(event.body, '');
                  }
                }
              }
            });
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _RejectionQueueComponent = /*#__PURE__*/function () {
        function _RejectionQueueComponent(api, toastService, userApi, excelService) {
        ...
        _createClass(_RejectionQueueComponent, [{
          ...
          value: function queryDetailsDataByParam(pendingForAuthDTO) {
            ...
            this.api.queryFailedDetailsDataByParamService(this.getDetailsQueryToggleReqDTO).subscribe(function (resp) {
              ...
              if (_this27.PendingForAuthDetailsDTOList) {
                ...
                _this27.toastService.errorMessage('No Data ', '');
              }
            });
          }
        }, {
          ...
          value: function approveAndProcess() {
            ...
            this.api.excelModifyAuthorization(this.PendingForAuthDetailsDTOList, this.user_id).subscribe(function (authRes) {
              ...
              if (_this30.authRes) {
                _this30.toastService.infoMessage('Data Send for Authorization. After Authorization you can process the data.', '');
              } else {
                _this30.toastService.errorMessage('Authorization Failed.', '');
              }
            });
          }
        }, {
