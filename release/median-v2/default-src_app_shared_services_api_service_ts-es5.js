      ...
      var _ApiService = /*#__PURE__*/function () {
        ...
        _createClass(_ApiService, [{
          ...
          value: function showDetailServiceInExcelDataProcessing(excelDataProcessingReqDTO, user_id) {
            return this.http.post("".concat(_API_URL, "/excelDataProcessing/showDetails/").concat(user_id), excelDataProcessingReqDTO);
          }
        }, {
          ...
          value: function processDataService(modalProcessDataReqDTO, userName, remarks) {
            return this.http.post("".concat(_API_URL, "/excelDataForProcessScreeen/processData/").concat(userName, "/").concat(remarks), modalProcessDataReqDTO);
          }
        }, {
          key: "test",
