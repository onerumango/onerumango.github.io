          ...
          value: function onSubmit() {
            ...
            this.ruleService.saveRuleconfig(this.ruleConfig, this.currentUser).subscribe(function (data) {
              if (data) {
                ...
                _this22.auditShowStatus = true; // this.ruleForm.reset();
              }
            }, function (err) {
