    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      function ExcelMappingEditComponent_div_51_tr_28_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("change", function ExcelMappingEditComponent_div_51_tr_28_Template_select_change_4_listener() {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵtext"](6, "\xA0 Select DataType \xA0 ");
      ...
      function ExcelMappingEditComponent_div_51_a_31_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("click", function ExcelMappingEditComponent_div_51_a_31_Template_span_click_1_listener() {
      ...
      function ExcelMappingEditComponent_div_51_div_32_button_5_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("click", function ExcelMappingEditComponent_div_51_div_32_button_5_Template_button_click_0_listener() {
      ...
      function ExcelMappingEditComponent_div_51_div_32_div_6_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function ExcelMappingEditComponent_div_51_div_32_div_7_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("click", function ExcelMappingEditComponent_div_51_div_32_div_7_Template_button_click_1_listener() {
      ...
      function ExcelMappingEditComponent_div_51_div_32_div_8_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("click", function ExcelMappingEditComponent_div_51_div_32_div_8_Template_button_click_1_listener() {
            ...
            return ctx_r37.onClickOfClose(ctx_r37.addForm.value, ctx_r37.updateMappingForm.value);
          });
      ...
      function ExcelMappingEditComponent_div_51_div_32_div_9_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("click", function ExcelMappingEditComponent_div_51_div_32_div_9_Template_button_click_1_listener() {
            ...
            return ctx_r39.onClickOfReopen(ctx_r39.addForm.value, ctx_r39.updateMappingForm.value);
          });
        ...
        if (rf & 2) {
          var ctx_r27 = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵnextContext"](3);
      ...
      function ExcelMappingEditComponent_div_51_div_32_div_10_button_1_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("click", function ExcelMappingEditComponent_div_51_div_32_div_10_button_1_Template_button_click_0_listener() {
            ...
            return ctx_r42.finalSubmit(ctx_r42.updateMappingForm.value, ctx_r42.addForm.value);
          });
      ...
      function ExcelMappingEditComponent_div_51_div_32_div_10_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementStart"](0, "div", 61);
        ...
        _createClass(_ExcelMappingEditComponent, [{
          ...
          value: function gettingSummaryData() {
            ...
            this.apiService.getexcelSummaryData().subscribe(function (resp) {
              ...
              if (_this3.summryResponse) {
                _this3.extCode = _this3.summryResponse.extCode;

                _this3.updateMappingForm.controls.extCode.setValue(_this3.extCode);

                _this3.getProcess(_this3.extCode);
              }
            });
          }
        }, {
          ...
          value: function getAllMappingData(formValue) {
            ...
            this.apiService.getAllMappingByExtSysAndProcessCode(extCode, proCode, currenyVal, sheetNumber).subscribe(function (mappingResponse) {
              _this8.mappingResponse = mappingResponse;
              console.log("this.mappingResponse", _this8.mappingResponse);

              if (_this8.mappingResponse == null) {
                sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire({
                ...
                var startingRow = _this8.mappingResponse[0].startingRow;
                var headerRepeated = _this8.mappingResponse[0].headerRepeated;

                _this8.updateMappingForm.controls.startingRow.setValue(startingRow);

                _this8.updateMappingForm.controls.headerRepeated.setValue(headerRepeated);

                _this8.auditLog();

                _this8.patchData(_this8.mappingResponse);
          ...
          value: function onClickOfClose(addForm, updateForm) {
            ...
            this.apiService.onClcikOFCloseOfUpdateExcelMApping(addForm, this.extCodeValue, this.proCodeValue, this.extNameValue, this.currencyValue).subscribe(function (closeResp) {
              var _a, _b, _c, _d, _e, _f, _g;
          ...
          value: function onClickOfReopen(addForm, updateForm) {
            ...
            this.currencyValue = updateForm.currency;
            this.currentUser = this.mappingResponse.modifiedBy;
            this.apiService.onClcikOfReopenOfUpdateExcelMapping(addForm, this.extCodeValue, this.proCodeValue, this.extNameValue, this.currencyValue).subscribe(function (openResp) {
              var _a, _b, _c, _d, _e, _f, _g;
          ...
          value: function getRowIdx(i) {
            ...
            this.apiService.deleteMappingRow(idx).subscribe(function (e) {
              if (e) {
                ...
                _this13.router.navigate(['/excel-mapping']);
              } else {
                sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire({
      ...
      _ExcelMappingEditComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdefineComponent"]({
        ...
        template: function ExcelMappingEditComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("change", function ExcelMappingEditComponent_Template_select_change_12_listener() {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("change", function ExcelMappingEditComponent_Template_select_change_23_listener() {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("change", function ExcelMappingEditComponent_Template_select_change_32_listener($event) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("click", function ExcelMappingEditComponent_Template_button_click_44_listener() {
