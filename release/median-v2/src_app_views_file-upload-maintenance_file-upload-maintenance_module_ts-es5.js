(function () {
  ...
  (self["webpackChunkmedian"] = self["webpackChunkmedian"] || []).push([["src_app_views_file-upload-maintenance_file-upload-maintenance_module_ts"], {
        ...
        _createClass(_ExternalSystemEditComponent, [{
          ...
          value: function getExternalSystemSummry() {
            ...
            this.apiService.getExternalSystemSummry().subscribe(function (summaryData) {
              _this2.externalSystemSummry = summaryData;
              console.log("this.externalSystemSummry", _this2.externalSystemSummry);
              var extCode = _this2.externalSystemSummry.extSysCode;
              var extName = _this2.externalSystemSummry.extSysName;
              var department = _this2.externalSystemSummry.department;

              _this2.externalSystemEditForm.controls.extSysCode.setValue(extCode);

              _this2.externalSystemEditForm.controls.extSysName.setValue(extName);

              _this2.externalSystemEditForm.controls.department.setValue(department);
          ...
          value: function onSubmit(externalSystemEditForm) {
            ...
            this.apiService.updateexternalSystemEdit(this.externalSystemUpdate).subscribe(function (data) {
              _this3.externalSystemSummry = data;

              if (_this3.externalSystemSummry) {
          ...
          value: function onClickOfAuth() {
            ...
            if (this.externalSystemSummry.modifiedBy === this.loggedInuser) {
              ...
              this.apiService.authorizingTheRecord(this.externalSystemSummry, this.loggedInuser).subscribe(function (authResp) {
                _this4.externalSystemSummry = authResp;
          ...
          value: function onClickOfClose() {
            ...
            this.apiService.closingTheRecord(this.externalSystemSummry).subscribe(function (closeResp) {
              ...
              _this5.externalSystemSummry = closeResp;
          ...
          value: function onClickOfReopen() {
            ...
            this.apiService.reopeningTheRecord(this.externalSystemSummry).subscribe(function (openResp) {
              ...
              _this6.externalSystemSummry = openResp;
          ...
          value: function OndeleteofUser() {
            ...
            this.apiService.onClickOfDeleteOfUpdateExcel(this.externalSystemSummry).subscribe(function (resp) {
              ...
              if (resp === true) {
                ...
                _this7.router.navigateByUrl('/external-system/external-system-summary');
              } else {
                sweetalert2__WEBPACK_IMPORTED_MODULE_0___default().fire({
        ...
        _createClass(_ExternalSystemNewComponent, [{
          ...
          value: function onSubmit(externalSystemFormValue) {
            ...
            this.apiService.saveExternalSystem(this.externalSystem).subscribe(function (res) {
              _this9.externalSystemResponse = res;

              if (_this9.externalSystemResponse != null) {
                sweetalert2__WEBPACK_IMPORTED_MODULE_0___default().fire({
        ...
        _createClass(_ExternalSystemComponent, [{
          ...
          value: function gettingExternalSummry() {
            ...
            this.apiService.getAllExt().subscribe(function (summryResp) {
              _this10.externalSummaryData = summryResp;

              _this10.dtTrigger.next();

              if (_this10.externalSummaryData != null) {
        ...
        _createClass(_ProcessCodeMappingEditComponent, [{
          ...
          value: function gettingProcessCode() {
            ...
            this.apiService.getProcessCode().subscribe(function (summaryData) {
              _this11.processCodeSummary = summaryData;
              console.log("this.processCodeSummary", _this11.processCodeSummary);
              var extCode = _this11.processCodeSummary.extSysCode;
              var extSysName = _this11.processCodeSummary.extSysName;
              var minlimit = _this11.processCodeSummary.maxUploadLimit;
              var process = _this11.processCodeSummary.processCode;
              var treasuryrefReq = _this11.processCodeSummary.treasuryrefRequired;
              var autoUpload = _this11.processCodeSummary.autoUpload;
              var backDateAllow = _this11.processCodeSummary.backDateAllow;
              var fCYRateVariance = _this11.processCodeSummary.treasuryrefRequired;
              var sftpRequired = _this11.processCodeSummary.sftpRequired;
              var futureDateAllow = _this11.processCodeSummary.futureDateAllow;
              var wuFile = _this11.processCodeSummary.wuFile;

              _this11.processCodeEditForm.controls.wuFile.setValue(wuFile);

              var mandatoryFieldImposed = _this11.processCodeSummary.mandatoryFieldImposed;

              _this11.processCodeEditForm.controls.mandatoryFieldImposed.setValue(mandatoryFieldImposed);

              var acft = _this11.processCodeSummary.acft;

              _this11.processCodeEditForm.controls.acft.setValue(acft);

              _this11.processCodeEditForm.controls.extSysCode.setValue(extCode);

              _this11.processCodeEditForm.controls.extSysName.setValue(extSysName);

              _this11.processCodeEditForm.controls.processCode.setValue(process);

              _this11.processCodeEditForm.controls.maxUploadLimit.setValue(minlimit);

              _this11.processCodeEditForm.controls.treasuryrefRequired.setValue(treasuryrefReq);

              _this11.processCodeEditForm.controls.autoUpload.setValue(autoUpload);

              _this11.processCodeEditForm.controls.backDateAllow.setValue(backDateAllow);

              _this11.processCodeEditForm.controls.fCYRateVariance.setValue(fCYRateVariance);

              _this11.processCodeEditForm.controls.sftpRequired.setValue(sftpRequired);

              _this11.processCodeEditForm.controls.futureDateAllow.setValue(futureDateAllow);

              if (autoUpload == true) {
                _this11.showFilefield = true;
                var fileName = _this11.processCodeSummary.fileName;
                var filePath = _this11.processCodeSummary.filePath;

                _this11.processCodeEditForm.controls.fileName.setValue(fileName);

                _this11.processCodeEditForm.controls.filePath.setValue(filePath);
              }

              if (backDateAllow == true) {
                _this11.showbackDateValue = true;
                var bdav = _this11.processCodeSummary.bdav;

                _this11.processCodeEditForm.controls.bdav.setValue(bdav);
              }

              if (fCYRateVariance == true) {
                _this11.showfCYExchangeValue = true;
                var fCYPercentage = _this11.processCodeSummary.fcypercenatage;

                _this11.processCodeEditForm.controls.fCYPercentage.setValue(fCYPercentage);
              }

              if (futureDateAllow == true) {
                _this11.showFutureDate = true;
                var fdav = _this11.processCodeSummary.fdav;

                _this11.processCodeEditForm.controls.fdav.setValue(fdav);
              }

              if (sftpRequired == true) {
                _this11.showsftpValues = true;
                var ipAddress = _this11.processCodeSummary.ipAddress;

                _this11.processCodeEditForm.controls.sftpIpaddress.setValue(ipAddress);

                var userName = _this11.processCodeSummary.userName;

                _this11.processCodeEditForm.controls.sftpUsername.setValue(userName);

                var path = _this11.processCodeSummary.path;

                _this11.processCodeEditForm.controls.sftpPath.setValue(path);

                var port = _this11.processCodeSummary.port;

                _this11.processCodeEditForm.controls.sftpPort.setValue(port);

                var password = _this11.processCodeSummary.password;

                _this11.processCodeEditForm.controls.sftpPassword.setValue(password);
              }
          ...
          value: function finalSubmitofEditForm(formValue) {
            ...
            this.apiService.createExtSys(this.processCodeEditForm.value).subscribe(function (resp) {
              if (resp) {
                ...
                _this13.processCodeEditForm.reset();
              } else {
                sweetalert2__WEBPACK_IMPORTED_MODULE_0___default().fire({
                  title: 'Failed to Update Data!',
                  icon: 'error'
          ...
          value: function onClickOfAuth() {
            ...
            if (this.processCodeSummary.modifiedBy === this.currentUser) {
              ...
              this.apiService.authorizingTheRecord(this.processCodeSummary, this.currentUser).subscribe(function (authResp) {
                _this14.processCodeSummary = authResp;
          ...
          value: function onClickOfClose() {
            ...
            this.apiService.closingTheRecord(this.processCodeSummary).subscribe(function (closeResp) {
              console.log(closeResp);
              _this15.processCodeSummary = closeResp;
          ...
          value: function onClickOfReopen() {
            ...
            this.apiService.reopeningTheRecord(this.processCodeSummary).subscribe(function (openResp) {
              console.log(openResp);
              _this16.processCodeSummary = openResp;
          ...
          value: function OndeleteofUser() {
            ...
            this.apiService.onClickOfDeleteOfUpdateExcel(this.processCodeSummary).subscribe(function (resp) {
              ...
              if (resp === true) {
                ...
                _this17.router.navigateByUrl('/external-system/processCodeMappingEdit');
              } else {
                sweetalert2__WEBPACK_IMPORTED_MODULE_0___default().fire({
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      _TreasuryReferenceComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({
        type: _TreasuryReferenceComponent,
        selectors: [["npr-treasury-reference"]],
        decls: 14,
        vars: 2,
        consts: [[1, "pageContentMain"], [1, "pageTitleCol"], [1, "pageTitle"], ["action", "", 1, "formStyle", 3, "formGroup"], [1, "dbCardStyle"], [1, "row", "gy-4"], [1, "col-lg-4"], ["for", "selectBatch", 1, "formLbl"], ["formControlName", "batch", "aria-label", "Default select example", 1, "form-select", 3, "change"], ["disabled", "", "selected", "", 1, "form-class"], [3, "value", 4, "ngFor", "ngForOf"], [3, "value"]],
        template: function TreasuryReferenceComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("change", function TreasuryReferenceComponent_Template_select_change_10_listener($event) {
              return ctx.onOptionsChange($event);
            });
