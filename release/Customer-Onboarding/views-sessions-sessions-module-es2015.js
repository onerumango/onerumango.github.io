    ...
    onSubmit() {
        if (!this.signinForm.invalid) {
            ...
            this.jwtService.signin().subscribe((res) => {
                ...
                //end of lcoal storage data for create account
...
/* harmony import */ var ngx_perfect_scrollbar__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ngx-perfect-scrollbar */ "aLe/");
...
/* harmony import */ var _auth_callback_auth_callback_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./auth-callback/auth-callback.component */ "hIfn");
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](SessionsModule, { declarations: [_not_found_not_found_component__WEBPACK_IMPORTED_MODULE_9__["NotFoundComponent"], _error_error_component__WEBPACK_IMPORTED_MODULE_10__["ErrorComponent"], _signin_signin_component__WEBPACK_IMPORTED_MODULE_11__["SigninComponent"], _auth_callback_auth_callback_component__WEBPACK_IMPORTED_MODULE_13__["AuthCallbackComponent"], _fingerprint_fingerprint_component__WEBPACK_IMPORTED_MODULE_12__["FingerprintComponent"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"],
        _ngx_translate_core__WEBPACK_IMPORTED_MODULE_7__["TranslateModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"],
        app_shared_shared_material_module__WEBPACK_IMPORTED_MODULE_5__["SharedMaterialModule"],
...
/* harmony import */ var _fingerprint_fingerprint_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./fingerprint/fingerprint.component */ "hxFr");
/* harmony import */ var _not_found_not_found_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./not-found/not-found.component */ "8Wtu");
...
/* harmony import */ var app_shared_services_app_loader_app_loader_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! app/shared/services/app-loader/app-loader.service */ "3sEA");
...
class AuthCallbackComponent {
    constructor(spinner, jwtService, router, ls) {
    ...
    ngOnInit() {
        this.spinner.open();
        let redirectedFromTellerDashboard = window.location.href.indexOf('appType');
        ...
        let accessToken = this.ls.getParameterByName('code');
        let appType = this.ls.getParameterByName('appType');
        this.CID_360 = this.ls.getParameterByName('CID_360');
        let userContext = this.jwtService.decodeData(accessToken);
    ...
    switchRoute(type) {
        ...
        switch (type) {
            ...
            case "DASHBOARD360": {
                this.router.navigateByUrl(`/others/mainNavigation?cId=${this.CID_360}`);
                break;
            }
            default: {
                this.router.navigateByUrl('/others/Service');
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AuthCallbackComponent, [{
    ...
    }], function () { return [{ type: app_shared_services_app_loader_app_loader_service__WEBPACK_IMPORTED_MODULE_2__["AppLoaderService"] }, { type: app_shared_services_auth_jwt_auth_service__WEBPACK_IMPORTED_MODULE_3__["JwtAuthService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"] }, { type: app_shared_services_local_store_service__WEBPACK_IMPORTED_MODULE_4__["LocalStoreService"] }]; }, null); })();
...
/* harmony import */ var _shared_services_finger_print_capture_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./../../../shared/services/finger-print-capture.service */ "rp8y");
...
/* harmony import */ var app_shared_services_auth_jwt_auth_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! app/shared/services/auth/jwt-auth.service */ "nZzT");
/* harmony import */ var app_views_home_account_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! app/views/home/account.service */ "kA6c");
...
class FingerprintComponent {
    constructor(dialogRef, fpCaptureService, data, cdr, snack, formBuilder, ls, router, jwtService, accountService) {
    ...
    captureFingerPrintHttps() {
        ...
        this.fpCaptureService.CallingSGIFPCapture()
            ...
            if (capturedData.ErrorCode == 0) {
                this.snack.open(`Finding ,is registed customer`, 'OK', {
                    duration: 1000,
...
FingerprintComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({ type: FingerprintComponent, selectors: [["app-fingerprint"]], decls: 19, vars: 2, consts: [[2, "background-color", "white"], ["fxLayout", "row", 1, "contain"], [1, "backIcon", 3, "click"], ["fxLayout", "column", "fxLayoutGap", "5%", "fxLayoutAlign", "space-between center", 1, ""], [1, "card-title"], [1, "para"], [1, "matIcon"], ["mat-flat-button", "", 1, "buttonScan", 3, "click"]], template: function FingerprintComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("click", function FingerprintComponent_Template_mat_icon_click_2_listener() { return ctx.goToClose(); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("click", function FingerprintComponent_Template_button_click_17_listener() { return ctx.captureFingerPrintHttps(); });
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵsetClassMetadata"](FingerprintComponent, [{
    ...
    }], function () { return [{ type: _angular_material_dialog__WEBPACK_IMPORTED_MODULE_4__["MatDialogRef"] }, { type: _shared_services_finger_print_capture_service__WEBPACK_IMPORTED_MODULE_2__["FingerPrintCaptureService"] }, { type: undefined, decorators: [{
                type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Inject"],
                args: [_angular_material_dialog__WEBPACK_IMPORTED_MODULE_4__["MAT_DIALOG_DATA"]]
            }] }, { type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["ChangeDetectorRef"] }, { type: _angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_1__["MatSnackBar"] }, { type: _angular_forms__WEBPACK_IMPORTED_MODULE_6__["FormBuilder"] }, { type: app_shared_services_local_store_service__WEBPACK_IMPORTED_MODULE_0__["LocalStoreService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"] }, { type: app_shared_services_auth_jwt_auth_service__WEBPACK_IMPORTED_MODULE_7__["JwtAuthService"] }, { type: app_views_home_account_service__WEBPACK_IMPORTED_MODULE_8__["AccountService"] }]; }, null); })();
...
/* harmony import */ var app_config_app_constant__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! app/config/app.constant */ "ngOV");
...
const API_URL = app_config_app_constant__WEBPACK_IMPORTED_MODULE_3__["AppConstants"].baseURL;
const httpOptions = {
...
class FingerPrintCaptureService {
    ...
    matchCapturedFp(fpId, capturedData) {
        ...
        return this.http.post(`${API_URL}/rest/upload/getRegisteredCustomerData/${fpId}`, capturedData)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])((result) => {
            // console.log('result-->', result)
            return result;
        }));
...
FingerPrintCaptureService.ɵfac = function FingerPrintCaptureService_Factory(t) { return new (t || FingerPrintCaptureService)(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"]), _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵinject"](_angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_0__["MatSnackBar"])); };
FingerPrintCaptureService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjectable"]({ token: FingerPrintCaptureService, factory: FingerPrintCaptureService.ɵfac, providedIn: 'root' });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵsetClassMetadata"](FingerPrintCaptureService, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_2__["Injectable"],
        args: [{
                providedIn: 'root'
            }]
    }], function () { return [{ type: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"] }, { type: _angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_0__["MatSnackBar"] }]; }, null); })();
