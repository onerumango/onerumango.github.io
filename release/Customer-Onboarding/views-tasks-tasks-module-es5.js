(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["views-tasks-tasks-module"], {
    ...
    /***/
    function eAI(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var AvatarComponent = /*#__PURE__*/function () {
        ...
        _createClass(AvatarComponent, [{
          ...
          value: function createInititals() {
            ...
            this.initials = initials; // console.log("this.name", this.name);
    ...
    /***/
    function rwl(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "TasksummaryService", function () {
      ...
      var app_shared_services_showMessage_show_message_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      ...
      var TasksummaryService = /*#__PURE__*/function () {
        function TasksummaryService(http, showMessageService) {
          var _this = this;

          _classCallCheck(this, TasksummaryService);
          ...
          this.errorHandler = function (errorResp) {
            ...
            _this.showMessageService.errorMessage(errorResp.status, errorResp);

            return Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["throwError"])(errorResp);
          };
        }

        _createClass(TasksummaryService, [{
          key: "accountStatusData",
          value: function accountStatusData(data) {
            this.accountStatus.next(data);
          }
        }, {
          key: "getAllAccDetails",
          value: function getAllAccDetails(status) {
            var statusVal = status;
            var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpParams"]().append('status', status);
            return this.http.get("".concat(API_URL, "/createAccTaskSummary/getAllAccInfo?").concat(params)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.errorHandler));
            ;
          }
        }, {
          key: "getAllAccDetailOnScroll",
          value: function getAllAccDetailOnScroll(status, page) {
            // console.log('status:: ', status);
            // console.log('page:: ', page);
            var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpParams"]().append('status', status).append('page', page); // params.append('size', size);
          ...
          key: "getSearchData",
          value: function getSearchData(params) {
            return this.http.get("".concat(API_URL, "/createAccTaskSummary/getAllAccInfo?").concat(params)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.errorHandler));
            ;
          }
        }, {
          key: "getAccountInfoByAccId",
          value: function getAccountInfoByAccId(accountId) {
            return this.http.get("".concat(API_URL, "/createAccTaskSummary/getAccInfo/").concat(accountId)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.errorHandler));
          }
        }, {
          key: "updateAccountInfoByAccId",
          value: function updateAccountInfoByAccId(accountForm) {
            return this.http.put("".concat(API_URL, "/productAccount/updateStatus"), accountForm).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.errorHandler));
          }
        }, {
          key: "updateCreateAccStatus",
          value: function updateCreateAccStatus(accountForm) {
            return this.http.post("".concat(API_URL, "/accountdata/updateAccountStatus"), accountForm).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.errorHandler));
          }
        }, {
          key: "getAllCustOnBoardingData",
          value: function getAllCustOnBoardingData(status, page) {
            var params;
            ...
            return this.http.get("".concat(API_URL, "/customerdata/getCustomerInfo?").concat(params)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.errorHandler));
          }
        }, {
          key: "getAccountInfo",
          value: function getAccountInfo(paramKey, paramValue) {
            // var params;
          ...
          key: "updateCustOnboradInfo",
          value: function updateCustOnboradInfo(formData) {
            return this.http.put("".concat(API_URL, "/customerdata/updateAccountSetting"), formData).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.errorHandler));
          }
        }]);
      ...
      TasksummaryService.ɵfac = function TasksummaryService_Factory(t) {
        return new (t || TasksummaryService)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpClient"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](app_shared_services_showMessage_show_message_service__WEBPACK_IMPORTED_MODULE_3__["ShowMessageService"]));
      };

      TasksummaryService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjectable"]({
        token: TasksummaryService,
        factory: TasksummaryService.ɵfac,
        providedIn: 'root'
      });
      /*@__PURE__*/

      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](TasksummaryService, [{
          ...
          return [{
            ...
            type: app_shared_services_showMessage_show_message_service__WEBPACK_IMPORTED_MODULE_3__["ShowMessageService"]
          }];
        }, null);
      })();
      /***/
    ...
    /***/
    function R5A(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "KycTaskSummaryComponent", function () {
        return KycTaskSummaryComponent;
      });
      /* harmony import */
      ...
      var _tasksummary_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! ../tasksummary.service */
      "6rwl");
      /* harmony import */


      var _kyc_branch_verify_summary_kyc_branch_verify_summary_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! ../kyc-branch-verify-summary/kyc-branch-verify-summary.component */
      "yAWA");
      /* harmony import */
      ...
      var _avatar_avatar_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(
      /*! ../avatar/avatar.component */
      "+eAI");
      /* harmony import */


      var _shared_directives_date_ago_pipe__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(
      /*! ../../../shared/directives/date-ago.pipe */
      "JC+M");

      function KycTaskSummaryComponent_button_12_Template(rf, ctx) {
        if (rf & 1) {
          var _r6 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "button", 17);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function KycTaskSummaryComponent_button_12_Template_button_click_0_listener() {
      ...
      function KycTaskSummaryComponent_mat_card_27_div_10_Template(rf, ctx) {
        if (rf & 1) {
        ...
        if (rf & 2) {
          var items_r7 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
      ...
      function KycTaskSummaryComponent_mat_card_27_ng_template_11_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function KycTaskSummaryComponent_mat_card_27_Template(rf, ctx) {
        if (rf & 1) {
          var _r15 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-card", 18);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function KycTaskSummaryComponent_mat_card_27_Template_mat_card_click_0_listener() {
            ...
            return ctx_r14.goToKycSummary(items_r7.customerId);
          });
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate4"](" ", items_r7.prefix, "\xA0", items_r7.firstName, "\xA0", items_r7.middleName, "\xA0", items_r7.lastName, " ");
      ...
      function KycTaskSummaryComponent_mat_card_38_div_10_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
        ...
        if (rf & 2) {
          var items_r16 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
      ...
      function KycTaskSummaryComponent_mat_card_38_ng_template_11_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "img", 33);
        }
      ...
      function KycTaskSummaryComponent_mat_card_38_Template(rf, ctx) {
        if (rf & 1) {
          var _r24 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-card", 18);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function KycTaskSummaryComponent_mat_card_38_Template_mat_card_click_0_listener() {
            ...
            return ctx_r23.goToKycSummary(items_r16.customerId);
          });
        ...
        if (rf & 2) {
          ...
          var _r19 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](12);
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate4"](" ", items_r16.prefix, "\xA0", items_r16.firstName, "\xA0", items_r16.middleName, "\xA0", items_r16.lastName, " ");
      ...
      function KycTaskSummaryComponent_mat_card_49_div_10_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
      ...
      function KycTaskSummaryComponent_mat_card_49_ng_template_11_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "img", 33);
        }
      ...
      function KycTaskSummaryComponent_mat_card_49_Template(rf, ctx) {
        if (rf & 1) {
          var _r33 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-card", 18);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function KycTaskSummaryComponent_mat_card_49_Template_mat_card_click_0_listener() {
            ...
            return ctx_r32.goToKycSummary(items_r25.customerId);
          });
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate4"](" ", items_r25.prefix, "\xA0", items_r25.firstName, "\xA0", items_r25.middleName, "\xA0", items_r25.lastName, " ");
      ...
      function KycTaskSummaryComponent_mat_card_60_div_10_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
        ...
        if (rf & 2) {
          var items_r34 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
      ...
      function KycTaskSummaryComponent_mat_card_60_ng_template_11_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "img", 33);
        }
      ...
      function KycTaskSummaryComponent_mat_card_60_Template(rf, ctx) {
        if (rf & 1) {
          var _r42 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-card", 18);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function KycTaskSummaryComponent_mat_card_60_Template_mat_card_click_0_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r42);

            var items_r34 = ctx.$implicit;

            var ctx_r41 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

            return ctx_r41.goToKycSummary(items_r34.customerId);
          });
        ...
        if (rf & 2) {
          ...
          var _r37 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](12);
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate4"](" ", items_r34.prefix, "\xA0", items_r34.firstName, "\xA0", items_r34.middleName, "\xA0", items_r34.lastName, " ");
      ...
      var KycTaskSummaryComponent = /*#__PURE__*/function () {
        function KycTaskSummaryComponent(dialog, dialogService, apiService, cdr, tasSumService, snack, sanitizer) {
          _classCallCheck(this, KycTaskSummaryComponent);
        ...
        _createClass(KycTaskSummaryComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            this.getDataOnLoad();
          }
          ...
          key: "updateSearch",
          value: function updateSearch(searchTextValue) {
            this._searchSubject.next(searchTextValue);
          }
        }, {
          key: "_setSearchSubscription",
          value: function _setSearchSubscription() {
            var _this2 = this;

            this._searchSubject.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["debounceTime"])(1000)).subscribe(function (searchValue) {
              _this2.searchKycid(searchValue);
          ...
          key: "goToKycSummary",
          value: function goToKycSummary(custId) {
            var _this3 = this;

            localStorage.setItem('customerId', custId);
            var dialogRef = this.dialog.open(_kyc_branch_verify_summary_kyc_branch_verify_summary_component__WEBPACK_IMPORTED_MODULE_9__["KycBranchVerifySummaryComponent"], {
              width: '80%',
              maxHeight: '100%',
          ...
          key: "getDataOnLoad",
          value: function getDataOnLoad() {
            for (var index = 0; index < this.statusArr.length; index++) {
              var statusItem = this.statusArr[index];
          ...
          value: function fetchCustomerByStatus(status, page, size) {
            ...
            this.apiService.getKycTaskSummaryList(status, page, size).subscribe(function (custResp) {
              ...
              _this4.updateStatusResponse(status, custResp);
            });
          }
        }, {
          key: "updateStatusResponse",
          value: function updateStatusResponse(status, data) {
            if (status == 'INITIATED') {
          ...
          value: function onScrollingFinished(e, status) {
            if (status == 'INITIATED') {
              this.INITIATEDPage++;
          ...
          key: "getDataOnScroll",
          value: function getDataOnScroll(status, page, totalPage) {
            var _this5 = this;
            ...
            this.tasSumService.getAllCustOnBoardingData(status, page).subscribe(function (data) {
              console.log('count data :: ', data);

              _this5.cdr.markForCheck();

              _this5.updateDataOnScroll(status, data.customerInfoList);
            });
          }
        }, {
          key: "searchKycid",
          value: function searchKycid(searchTerm) {
            var text;
            var params;
          ...
          key: "getKycData",
          value: function getKycData(params) {
            var _this6 = this;

            this.apiService.getKycDetails(params).subscribe(function (data) {
              console.log('resp data :: ', data);

              _this6.resetSearchData();

              for (var index = 0; index < data.customerInfoList.length; index++) {
                var element = data.customerInfoList[index];

                _this6.searchResponseUpdate(element.customerAdditionalInfo['kycStatus'], element);
              }
            });
          ...
          key: "resetSearchData",
          value: function resetSearchData() {
            this.INITIATEDArr = [];
            this.UNDER_PROCESSArr = [];
            this.APPROVEDArr = [];
            this.REJECTEDArr = [];
          ...
          key: "searchResponseUpdate",
          value: function searchResponseUpdate(status, data) {
            if (status == 'INITIATED') {
              // this.INITIATEDArr = [];
          ...
          key: "updateDataOnScroll",
          value: function updateDataOnScroll(status, data) {
            if (status == 'INITIATED') {
              var result = lodash__WEBPACK_IMPORTED_MODULE_10__["unionBy"](this.INITIATEDArr, data, 'customerId');
              this.INITIATEDArr = result;
            } else if (status == 'UNDER_PROCESS') {
              var _result = lodash__WEBPACK_IMPORTED_MODULE_10__["unionBy"](this.UNDER_PROCESSArr, data, 'customerId');

              this.UNDER_PROCESSArr = _result;
            } else if (status == 'APPROVED') {
              var _result2 = lodash__WEBPACK_IMPORTED_MODULE_10__["unionBy"](this.APPROVEDArr, data, 'customerId');

              this.APPROVEDArr = _result2;
            } else if (status == 'REJECTED') {
              var _result3 = lodash__WEBPACK_IMPORTED_MODULE_10__["unionBy"](this.REJECTEDArr, data, 'customerId');

              this.REJECTEDArr = _result3;
            }
          ...
          key: "isNum",
          value: function isNum(val) {
            return !isNaN(val);
          }
        }, {
          key: "getRandomColor",
          value: function getRandomColor(idx) {
            var col0 = '#0d856b';
            var col1 = '#d66f1b';
            var col2 = '#9f52e7';
            var col3 = '#e9318d';
            ...
            return '#d86315'; // var randomColor = Math.floor(Math.random()*16777215).toString(16);
      ...
      KycTaskSummaryComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        template: function KycTaskSummaryComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function KycTaskSummaryComponent_Template_input_ngModelChange_9_listener($event) {
              return ctx.searchText = $event;
            })("keyup", function KycTaskSummaryComponent_Template_input_keyup_9_listener($event) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("scrolled", function KycTaskSummaryComponent_Template_div_scrolled_26_listener($event) {
              return ctx.onScrollingFinished($event, "INITIATED");
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("scrolled", function KycTaskSummaryComponent_Template_div_scrolled_37_listener($event) {
              return ctx.onScrollingFinished($event, "UNDER_PROCESS");
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("scrolled", function KycTaskSummaryComponent_Template_div_scrolled_48_listener($event) {
              return ctx.onScrollingFinished($event, "APPROVED");
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("scrolled", function KycTaskSummaryComponent_Template_div_scrolled_59_listener($event) {
              return ctx.onScrollingFinished($event, "REJECTED");
            });
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](KycTaskSummaryComponent, [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
          args: [{
          ...
          return [{
            ...
            type: _tasksummary_service__WEBPACK_IMPORTED_MODULE_8__["TasksummaryService"]
          }, {
    ...
    function Iqf(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, "CustOnBoardingTaskSummaryComponent", function () {
        return CustOnBoardingTaskSummaryComponent;
      });
      /* harmony import */
      ...
      var _cust_on_boarding_approver_cust_on_boarding_approver_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ../cust-on-boarding-approver/cust-on-boarding-approver.component */
      "tNxk");
      /* harmony import */


      var _tasksummary_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ../tasksummary.service */
      "6rwl");
      /* harmony import */
      ...
      function CustOnBoardingTaskSummaryComponent_button_12_Template(rf, ctx) {
        if (rf & 1) {
          var _r6 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵgetCurrentView"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "button", 17);

          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function CustOnBoardingTaskSummaryComponent_button_12_Template_button_click_0_listener() {
      ...
      function CustOnBoardingTaskSummaryComponent_mat_card_27_div_10_Template(rf, ctx) {
        if (rf & 1) {
        ...
        if (rf & 2) {
          var items_r7 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]().$implicit;
      ...
      function CustOnBoardingTaskSummaryComponent_mat_card_27_ng_template_11_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function CustOnBoardingTaskSummaryComponent_mat_card_27_Template(rf, ctx) {
        if (rf & 1) {
          var _r15 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵgetCurrentView"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "mat-card", 18);

          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function CustOnBoardingTaskSummaryComponent_mat_card_27_Template_mat_card_click_0_listener() {
            ...
            return ctx_r14.goToCustOnBoardingSummary(items_r7, "INITATED", ctx_r14.getRandomColor(i_r8 + 3));
          });
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtextInterpolate4"](" ", items_r7.prefix, "\xA0", items_r7.firstName, "\xA0", items_r7.middleName, "\xA0", items_r7.lastName, " ");
      ...
      function CustOnBoardingTaskSummaryComponent_mat_card_38_div_10_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div");
        ...
        if (rf & 2) {
          var items_r16 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]().$implicit;
      ...
      function CustOnBoardingTaskSummaryComponent_mat_card_38_ng_template_11_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](0, "img", 32);
        }
      ...
      function CustOnBoardingTaskSummaryComponent_mat_card_38_Template(rf, ctx) {
        if (rf & 1) {
          var _r24 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵgetCurrentView"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "mat-card", 18);

          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function CustOnBoardingTaskSummaryComponent_mat_card_38_Template_mat_card_click_0_listener() {
            ...
            return ctx_r23.goToCustOnBoardingSummary(items_r16, "UNDER_PROCESS", ctx_r23.getRandomColor(i_r17 + 6));
          });
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtextInterpolate4"](" ", items_r16.prefix, "\xA0", items_r16.firstName, "\xA0", items_r16.middleName, "\xA0", items_r16.lastName, " ");
      ...
      function CustOnBoardingTaskSummaryComponent_mat_card_48_div_10_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div");
        ...
        if (rf & 2) {
          var items_r25 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]().$implicit;
      ...
      function CustOnBoardingTaskSummaryComponent_mat_card_48_ng_template_11_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](0, "img", 32);
        }
      ...
      function CustOnBoardingTaskSummaryComponent_mat_card_48_Template(rf, ctx) {
        if (rf & 1) {
          var _r33 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵgetCurrentView"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "mat-card", 18);

          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function CustOnBoardingTaskSummaryComponent_mat_card_48_Template_mat_card_click_0_listener() {
            ...
            return ctx_r32.goToCustOnBoardingSummary(items_r25, "APPROVED", ctx_r32.getRandomColor(i_r26 + 12));
          });
        ...
        if (rf & 2) {
          ...
          var _r28 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵreference"](12);
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtextInterpolate4"](" ", items_r25.prefix, "\xA0", items_r25.firstName, "\xA0", items_r25.middleName, "\xA0", items_r25.lastName, " ");
      ...
      function CustOnBoardingTaskSummaryComponent_mat_card_59_div_10_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div");
        ...
        if (rf & 2) {
          var items_r34 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]().$implicit;
      ...
      function CustOnBoardingTaskSummaryComponent_mat_card_59_ng_template_11_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](0, "img", 32);
        }
      ...
      function CustOnBoardingTaskSummaryComponent_mat_card_59_Template(rf, ctx) {
        if (rf & 1) {
          var _r42 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵgetCurrentView"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "mat-card", 18);

          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function CustOnBoardingTaskSummaryComponent_mat_card_59_Template_mat_card_click_0_listener() {
            ...
            return ctx_r41.goToCustOnBoardingSummary(items_r34, "REJECTED", ctx_r41.getRandomColor(i_r35 + 15));
          });
        ...
        if (rf & 2) {
          ...
          var _r37 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵreference"](12);
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtextInterpolate4"](" ", items_r34.prefix, "\xA0", items_r34.firstName, "\xA0", items_r34.middleName, "\xA0", items_r34.lastName, " ");
      ...
      var CustOnBoardingTaskSummaryComponent = /*#__PURE__*/function () {
        function CustOnBoardingTaskSummaryComponent(dialog, ls, tasSumService, cdr, apiService, snack, sanitizer) {
          _classCallCheck(this, CustOnBoardingTaskSummaryComponent);
        ...
        _createClass(CustOnBoardingTaskSummaryComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            var _this7 = this;
            ...
            this.listOfOptions.filter(function (item) {
              if (item.checked) {
                _this7.radioButtonSelected = item.value;
              }
            });
            this.criteria = {
          ...
          key: "radioChange",
          value: function radioChange(event, data) {
          ...
          value: function _setSearchSubscription() {
            ...
            this._searchSubject.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["debounceTime"])(1000)).subscribe(function (searchValue) {
              _this8.setValue.emit(searchValue);

              console.log('search value :: ', searchValue);
              console.log('search text :: ', _this8.searchText);

              if (searchValue == null || searchValue == '' || searchValue == "") {
                _this8.noDataFound = false;
                _this8.searchable = false;

                _this8.getDataOnLoad();

                return;
              }

              _this8.searchCustomerId(searchValue);
            });
          }
        }, {
          key: "clear",
          ...
          value: function getDataOnLoad() {
            return __awaiter(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
              var index, statusItem;
              return regeneratorRuntime.wrap(function _callee$(_context) {
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      for (index = 0; index < this.statusArr.length; index++) {
                        statusItem = this.statusArr[index];
                        this.fetchCustomerByStatus(statusItem, 0, 0);
                      }
          ...
          value: function fetchCustomerByStatus(status, page, size) {
            ...
            this.tasSumService.getAllCustOnBoardingData(status, page).subscribe(function (custResp) {
              console.log("Response", custResp);

              _this9.updateStatusResponse(status, custResp);
            });
          }
        }, {
          key: "updateStatusResponse",
          ...
          value: function getDataOnScroll(status, page, totalPage) {
            ...
            this.tasSumService.getAllCustOnBoardingData(status, page).subscribe(function (data) {
              ...
              _this10.updateDataOnScroll(status, data.customerInfoList);
            });
          }
        }, {
          key: "goToCustOnBoardingSummary",
          value: function goToCustOnBoardingSummary(data, status, colCode) {
            var _this11 = this;

            localStorage.setItem('CustomerColorCode', colCode);
            var dialogRef = this.dialog.open(_cust_on_boarding_approver_cust_on_boarding_approver_component__WEBPACK_IMPORTED_MODULE_5__["CustOnBoardingApproverComponent"], {
            ...
            dialogRef.afterClosed().subscribe(function (submit) {
              ...
              if (submit.recordStatus === 'REJECTED' || submit.recordStatus === 'APPROVED' || submit.data.kycStatus === 'REJECTED' || submit.data.kycStatus === 'APPROVED') {
                _this11.getDataOnLoad();
              }
            });
          }
        }, {
          key: "searchCustomerId",
          value: function searchCustomerId(searchTerm) {
            var text;
            var params;
          ...
          key: "getCustomerData",
          value: function getCustomerData(params) {
            var _this12 = this;
            ...
            this.apiService.getKycDetails(params).subscribe(function (data) {
              ...
              _this12.resetSearchData();

              for (var index = 0; index < data.customerInfoList.length; index++) {
                var element = data.customerInfoList[index];

                _this12.searchResponseUpdate(element.custStatus, element);
              }
            });
          }
        }, {
          ...
          value: function getProfileImage(customerId) {
            ...
            this.apiService.getProfileDetails(customerId).subscribe(function (data) {
              ...
              _this13.searchable = false;

              if (data.profileImage != null) {
                var objectURL = 'data:image/jpeg;base64,' + data.profileImage.fileData;
                _this13.searchable = true;
                _this13.image = _this13.sanitizer.bypassSecurityTrustUrl(objectURL);
                console.log(_this13.searchable, "Searchable");
              }
            }, function (error) {
              console.log(error);
            });
          ...
          key: "getCustomerIdData",
          value: function getCustomerIdData(valueToFilter) {
            var _this14 = this;

            console.log('get kyc');

            if (valueToFilter != '' && valueToFilter != undefined && valueToFilter != null) {
              this.apiService.getKycTaskSummaryAll(valueToFilter, this.searchText).subscribe(function (data) {
                console.log('resp data :: ', data);
                ...
                if (data != null) {
                  ...
                  _this14[value].splice(0, 0, data[0]);

                  _this14[value] = _this14[value].slice();
                  console.log('resp value :: ', _this14[value]);
                } else {
                  _this14.noDataFound = true;
                }
              });
            }
          }
          ...
          value: function updateDataOnScroll(status, data) {
            return __awaiter(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
              var result, _result4, _result5, _result6;
              ...
              return regeneratorRuntime.wrap(function _callee2$(_context2) {
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    case 0:
                      if (status == 'INITIATED') {
                        result = lodash__WEBPACK_IMPORTED_MODULE_10__["unionBy"](this.INITIATEDArr, data, 'customerId');
                        this.INITIATEDArr = result;
                      } else if (status == 'UNDER_PROCESS') {
                        _result4 = lodash__WEBPACK_IMPORTED_MODULE_10__["unionBy"](this.UNDER_PROCESSArr, data, 'customerId');
                        this.UNDER_PROCESSArr = _result4;
                      } else if (status == 'APPROVED') {
                        _result5 = lodash__WEBPACK_IMPORTED_MODULE_10__["unionBy"](this.APPROVEDArr, data, 'customerId');
                        this.APPROVEDArr = _result5;
                      } else if (status == 'REJECTED') {
                        _result6 = lodash__WEBPACK_IMPORTED_MODULE_10__["unionBy"](this.REJECTEDArr, data, 'customerId');
                        this.REJECTEDArr = _result6;
                      }
      ...
      CustOnBoardingTaskSummaryComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
        ...
        template: function CustOnBoardingTaskSummaryComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ngModelChange", function CustOnBoardingTaskSummaryComponent_Template_input_ngModelChange_9_listener($event) {
              return ctx.searchText = $event;
            })("keyup", function CustOnBoardingTaskSummaryComponent_Template_input_keyup_9_listener($event) {
              return ctx.updateSearch($event.target.value);
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("scrolled", function CustOnBoardingTaskSummaryComponent_Template_div_scrolled_26_listener($event) {
              return ctx.onScrollingFinished($event, "INITIATED");
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("scrolled", function CustOnBoardingTaskSummaryComponent_Template_div_scrolled_37_listener($event) {
              return ctx.onScrollingFinished($event, "UNDER_PROCESS");
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("scrolled", function CustOnBoardingTaskSummaryComponent_Template_div_scrolled_47_listener($event) {
              return ctx.onScrollingFinished($event, "APPROVED");
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("scrolled", function CustOnBoardingTaskSummaryComponent_Template_div_scrolled_58_listener($event) {
              return ctx.onScrollingFinished($event, "REJECTED");
            });
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](CustOnBoardingTaskSummaryComponent, [{
          ...
          return [{
            ...
            type: _tasksummary_service__WEBPACK_IMPORTED_MODULE_6__["TasksummaryService"]
          }, {
    ...
    /***/
    function GO8N(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "CustomTaskSummarySortingPipe", function () {
        return CustomTaskSummarySortingPipe;
      });
      /* harmony import */
      ...
      var CustomTaskSummarySortingPipe = /*#__PURE__*/function () {
        function CustomTaskSummarySortingPipe() {
          _classCallCheck(this, CustomTaskSummarySortingPipe);
        }

        _createClass(CustomTaskSummarySortingPipe, [{
          key: "transform",
          value: function transform(value, criteria) {
            if (!value || !criteria) return value;
            var p = criteria.property;

            var sortFn = function sortFn(a, b) {
              var value = 0;
              if (a[p] === undefined) value = -1;else if (b[p] === undefined) value = 1;else if (a[p] === null) value = -1;else if (b[p] === null) value = 1;else if (a[p] === '') value = -1;else if (b[p] === '') value = 1;else value = a[p] - b[p]; // a[p] > b[p] ? 1 : (b[p] > a[p] ? -1 : 0);

              return criteria.descending ? value * -1 : value;
            };

            var sortForAlpha = function sortForAlpha(a, b) {
              var value = 0;
              if (a[p] === undefined) value = -1;else if (b[p] === undefined) value = 1;else if (a[p] === null) value = -1;else if (b[p] === null) value = 1;else if (a[p] === '') value = -1;else if (b[p] === '') value = 1;else value = a[p].toLocaleLowerCase() > b[p].toLocaleLowerCase() ? 1 : b[p].toLocaleLowerCase() > a[p].toLocaleLowerCase() ? -1 : 0;
              return criteria.descending ? value * -1 : value;
            };

            var sortForAlphaNumeric = function sortForAlphaNumeric(a, b) {
              var value = 0;
              if (a[p] === undefined) value = -1;else if (b[p] === undefined) value = 1;else if (a[p] === null) value = -1;else if (b[p] === null) value = 1;else if (a[p] === '') value = -1;else if (b[p] === '') value = 1;else {
                var charPart = [a[p].substring(0, 4), b[p].substring(0, 4)],
                    numPart = [a[p].substring(4) * 1, b[p].substring(4) * 1]; // debugger;

                if (charPart[0] < charPart[1]) value = -1;else if (charPart[0] > charPart[1]) value = 1;else {
                  //(charPart[0] == charPart[1]){
                  if (numPart[0] < numPart[1]) value = -1;else if (numPart[0] > numPart[1]) value = 1;
                }
      ...
      CustomTaskSummarySortingPipe.ɵfac = function CustomTaskSummarySortingPipe_Factory(t) {
        return new (t || CustomTaskSummarySortingPipe)();
      };

      CustomTaskSummarySortingPipe.ɵpipe = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefinePipe"]({
        name: "customTaskSummarySorting",
        type: CustomTaskSummarySortingPipe,
        pure: false
      });
      /*@__PURE__*/

      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](CustomTaskSummarySortingPipe, [{
    ...
    /***/
    function X7Rc(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _tasks_routing__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./tasks-routing */
      "mP0/");
      /* harmony import */
      ...
      var _task_summary_task_summary_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./task-summary/task-summary.component */
      "gUBa");
      /* harmony import */
      ...
      var _approver_approver_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! ./approver/approver.component */
      "pnfF");
      /* harmony import */
      ...
      var _kyc_branch_verify_summary_kyc_branch_verify_summary_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
      /*! ./kyc-branch-verify-summary/kyc-branch-verify-summary.component */
      "yAWA");
      /* harmony import */


      var _kyc_task_summary_kyc_task_summary_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
      /*! ./kyc-task-summary/kyc-task-summary.component */
      "7R5A");
      /* harmony import */


      var _cust_on_boarding_task_summary_cust_on_boarding_task_summary_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
      /*! ./cust-on-boarding-task-summary/cust-on-boarding-task-summary.component */
      "9Iqf");
      /* harmony import */


      var _cust_on_boarding_approver_cust_on_boarding_approver_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
      /*! ./cust-on-boarding-approver/cust-on-boarding-approver.component */
      "tNxk");
      /* harmony import */
      ...
      var ngx_infinite_scroll__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(
      /*! ngx-infinite-scroll */
      "MNke");
      /* harmony import */
      ...
      var app_shared_pipes_custom_search_filter_pipe__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(
      /*! app/shared/pipes/custom-search-filter.pipe */
      "ezWl");
      /* harmony import */


      var app_shared_pipes_custom_task_summary_sorting_pipe__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(
      /*! app/shared/pipes/custom-task-summary-sorting.pipe */
      "GO8N");
      /* harmony import */
      ...
      var app_shared_shared_material_module__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(
      /*! app/shared/shared-material.module */
      "zMWy");
      /* harmony import */


      var app_shared_directives_shared_directives_module__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(
      /*! app/shared/directives/shared-directives.module */
      "mnDI");
      /* harmony import */


      var _avatar_avatar_component__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(
      /*! ./avatar/avatar.component */
      "+eAI"); // search module
      ...
      TasksModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
        type: TasksModule
      });
      TasksModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
        factory: function TasksModule_Factory(t) {
          return new (t || TasksModule)();
        },
        imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_10__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_10__["ReactiveFormsModule"], _angular_material_menu__WEBPACK_IMPORTED_MODULE_8__["MatMenuModule"], _angular_flex_layout__WEBPACK_IMPORTED_MODULE_2__["FlexLayoutModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_6__["MatIconModule"], _angular_material_card__WEBPACK_IMPORTED_MODULE_7__["MatCardModule"], ng2_search_filter__WEBPACK_IMPORTED_MODULE_24__["Ng2SearchPipeModule"], _angular_material_stepper__WEBPACK_IMPORTED_MODULE_17__["MatStepperModule"], _angular_material_divider__WEBPACK_IMPORTED_MODULE_18__["MatDividerModule"], _angular_material_form_field__WEBPACK_IMPORTED_MODULE_19__["MatFormFieldModule"], app_shared_directives_shared_directives_module__WEBPACK_IMPORTED_MODULE_29__["SharedDirectivesModule"], _angular_material_datepicker__WEBPACK_IMPORTED_MODULE_20__["MatDatepickerModule"], _angular_material_radio__WEBPACK_IMPORTED_MODULE_21__["MatRadioModule"], _angular_material_progress_spinner__WEBPACK_IMPORTED_MODULE_27__["MatProgressSpinnerModule"], ngx_infinite_scroll__WEBPACK_IMPORTED_MODULE_22__["InfiniteScrollModule"], _angular_material_paginator__WEBPACK_IMPORTED_MODULE_23__["MatPaginatorModule"], _angular_material_slide_toggle__WEBPACK_IMPORTED_MODULE_12__["MatSlideToggleModule"], ng_apexcharts__WEBPACK_IMPORTED_MODULE_11__["NgApexchartsModule"], app_shared_shared_material_module__WEBPACK_IMPORTED_MODULE_28__["SharedMaterialModule"], //TasksRoutingModule,
      ...
      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](TasksModule, {
          declarations: [_task_summary_task_summary_component__WEBPACK_IMPORTED_MODULE_5__["TaskSummaryComponent"], _approver_approver_component__WEBPACK_IMPORTED_MODULE_9__["ApproverComponent"], _kyc_branch_verify_summary_kyc_branch_verify_summary_component__WEBPACK_IMPORTED_MODULE_13__["KycBranchVerifySummaryComponent"], _kyc_task_summary_kyc_task_summary_component__WEBPACK_IMPORTED_MODULE_14__["KycTaskSummaryComponent"], _cust_on_boarding_task_summary_cust_on_boarding_task_summary_component__WEBPACK_IMPORTED_MODULE_15__["CustOnBoardingTaskSummaryComponent"], _cust_on_boarding_approver_cust_on_boarding_approver_component__WEBPACK_IMPORTED_MODULE_16__["CustOnBoardingApproverComponent"], app_shared_pipes_custom_search_filter_pipe__WEBPACK_IMPORTED_MODULE_25__["CustomSearchFilterPipe"], app_shared_pipes_custom_task_summary_sorting_pipe__WEBPACK_IMPORTED_MODULE_26__["CustomTaskSummarySortingPipe"], _avatar_avatar_component__WEBPACK_IMPORTED_MODULE_30__["AvatarComponent"]],
          imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_10__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_10__["ReactiveFormsModule"], _angular_material_menu__WEBPACK_IMPORTED_MODULE_8__["MatMenuModule"], _angular_flex_layout__WEBPACK_IMPORTED_MODULE_2__["FlexLayoutModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_6__["MatIconModule"], _angular_material_card__WEBPACK_IMPORTED_MODULE_7__["MatCardModule"], ng2_search_filter__WEBPACK_IMPORTED_MODULE_24__["Ng2SearchPipeModule"], _angular_material_stepper__WEBPACK_IMPORTED_MODULE_17__["MatStepperModule"], _angular_material_divider__WEBPACK_IMPORTED_MODULE_18__["MatDividerModule"], _angular_material_form_field__WEBPACK_IMPORTED_MODULE_19__["MatFormFieldModule"], app_shared_directives_shared_directives_module__WEBPACK_IMPORTED_MODULE_29__["SharedDirectivesModule"], _angular_material_datepicker__WEBPACK_IMPORTED_MODULE_20__["MatDatepickerModule"], _angular_material_radio__WEBPACK_IMPORTED_MODULE_21__["MatRadioModule"], _angular_material_progress_spinner__WEBPACK_IMPORTED_MODULE_27__["MatProgressSpinnerModule"], ngx_infinite_scroll__WEBPACK_IMPORTED_MODULE_22__["InfiniteScrollModule"], _angular_material_paginator__WEBPACK_IMPORTED_MODULE_23__["MatPaginatorModule"], _angular_material_slide_toggle__WEBPACK_IMPORTED_MODULE_12__["MatSlideToggleModule"], ng_apexcharts__WEBPACK_IMPORTED_MODULE_11__["NgApexchartsModule"], app_shared_shared_material_module__WEBPACK_IMPORTED_MODULE_28__["SharedMaterialModule"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterModule"]]
        });
      })();
      /*@__PURE__*/
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](TasksModule, [{
    ...
    /***/
    function ezWl(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "CustomSearchFilterPipe", function () {
        return CustomSearchFilterPipe;
      });
      /* harmony import */
      ...
      var CustomSearchFilterPipe = /*#__PURE__*/function () {
        function CustomSearchFilterPipe() {
          _classCallCheck(this, CustomSearchFilterPipe);
        }

        _createClass(CustomSearchFilterPipe, [{
          key: "transform",
          value: function transform(items, keyword, properties, radioButtonValue) {
                  ...
                  if (item[properties[i]] != undefined) {
                    if (properties[i].includes(radioButtonValue)) {
                      ...
                      if (Object(highcharts__WEBPACK_IMPORTED_MODULE_1__["isNumber"])(item[properties[i]])) {
                        ...
                        var str = item[properties[i]].toString();
      ...
      CustomSearchFilterPipe.ɵfac = function CustomSearchFilterPipe_Factory(t) {
        return new (t || CustomSearchFilterPipe)();
      };

      CustomSearchFilterPipe.ɵpipe = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefinePipe"]({
        name: "customSearchFilter",
        type: CustomSearchFilterPipe,
        pure: true
      });
      /*@__PURE__*/

      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](CustomSearchFilterPipe, [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Pipe"],
          args: [{
            name: 'customSearchFilter'
          }]
    ...
    /***/
    function gUBa(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "TaskSummaryComponent", function () {
      ...
      var _approver_approver_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ../approver/approver.component */
      "pnfF");
      /* harmony import */


      var _tasksummary_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ../tasksummary.service */
      "6rwl");
      /* harmony import */
      ...
      var _avatar_avatar_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
      /*! ../avatar/avatar.component */
      "+eAI");

      function TaskSummaryComponent_button_12_Template(rf, ctx) {
        if (rf & 1) {
          var _r6 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "button", 17);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function TaskSummaryComponent_button_12_Template_button_click_0_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r6);
      ...
      function TaskSummaryComponent_mat_card_27_div_5_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
        ...
        if (rf & 2) {
          var backlogData_r7 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
      ...
      function TaskSummaryComponent_mat_card_27_ng_template_6_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function TaskSummaryComponent_mat_card_27_Template(rf, ctx) {
        if (rf & 1) {
          var _r15 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-card", 18);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function TaskSummaryComponent_mat_card_27_Template_mat_card_click_0_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r15);

            var backlogData_r7 = ctx.$implicit;
            var i_r8 = ctx.index;

            var ctx_r14 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

            return ctx_r14.gotoapproverpage(backlogData_r7, "BACKLOG", ctx_r14.getRandomColor(i_r8 + 3));
          });
      ...
      function TaskSummaryComponent_mat_card_38_div_5_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
        ...
        if (rf & 2) {
          var ongoingData_r16 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
      ...
      function TaskSummaryComponent_mat_card_38_ng_template_6_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "img", 32);
        }
      ...
      function TaskSummaryComponent_mat_card_38_Template(rf, ctx) {
        if (rf & 1) {
          var _r24 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-card", 18);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function TaskSummaryComponent_mat_card_38_Template_mat_card_click_0_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r24);

            var ongoingData_r16 = ctx.$implicit;
            var i_r17 = ctx.index;

            var ctx_r23 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

            return ctx_r23.gotoapproverpage(ongoingData_r16, "ONGOING", ctx_r23.getRandomColor(i_r17 + 6));
          });
      ...
      function TaskSummaryComponent_mat_card_49_div_5_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
        ...
        if (rf & 2) {
          var approvedData_r25 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
      ...
      function TaskSummaryComponent_mat_card_49_ng_template_6_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "img", 32);
        }
      ...
      function TaskSummaryComponent_mat_card_49_Template(rf, ctx) {
        if (rf & 1) {
          var _r33 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-card", 18);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function TaskSummaryComponent_mat_card_49_Template_mat_card_click_0_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r33);

            var approvedData_r25 = ctx.$implicit;
            var i_r26 = ctx.index;

            var ctx_r32 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

            return ctx_r32.gotoapproverpage(approvedData_r25, "APPROVED", ctx_r32.getRandomColor(i_r26 + 9));
          });
        ...
        if (rf & 2) {
          ...
          var _r28 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](7);
      ...
      function TaskSummaryComponent_mat_card_60_div_5_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
        ...
        if (rf & 2) {
          var rejectedData_r34 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
      ...
      function TaskSummaryComponent_mat_card_60_ng_template_6_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "img", 32);
        }
      ...
      function TaskSummaryComponent_mat_card_60_Template(rf, ctx) {
        if (rf & 1) {
          var _r42 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-card", 18);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function TaskSummaryComponent_mat_card_60_Template_mat_card_click_0_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r42);

            var rejectedData_r34 = ctx.$implicit;
            var i_r35 = ctx.index;

            var ctx_r41 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

            return ctx_r41.gotoapproverpage(rejectedData_r34, "REJECTED", ctx_r41.getRandomColor(i_r35 + 12));
          });
        ...
        if (rf & 2) {
          ...
          var _r37 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](7);
      ...
      var TaskSummaryComponent = /*#__PURE__*/function () {
        function TaskSummaryComponent(dialog, sanitizer, tasksummaryService, apiService, cdr) {
          _classCallCheck(this, TaskSummaryComponent);
        ...
        _createClass(TaskSummaryComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            /* @called :: on screen load */
            this.getDataOnLoad();
          ...
          value: function _setSearchSubscription() {
            ...
            this._searchSubject.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["debounceTime"])(1000)).subscribe(function (searchValue) {
              _this15.searchKycid(searchValue);
            });
          }
          /* @method :: to load all data on screen load */
          ...
          key: "getAllAccDetails",
          value: function getAllAccDetails(status, page, size) {
            var _this16 = this;

            this.tasksummaryService.getAllAccDetails(status).subscribe(function (data) {
              console.log("Response", data);

              _this16.updateStatusResponse(status, data);
            });
          }
        }, {
          key: "updateStatusResponse",
          ...
          value: function getDataOnScroll(status, page, totalPage) {
            ...
            this.tasksummaryService.getAllAccDetailOnScroll(status, page).subscribe(function (data) {
              _this17.updateDataOnScroll(status, data.accountList);

              _this17.cdr.markForCheck();
            });
          }
        }, {
          key: "gotoapproverpage",
          value: function gotoapproverpage(data, status, colCode) {
            var _this18 = this;

            // console.log('data:: ', data);
            this.tasksummaryService.accountStatusData(status);
            localStorage.setItem('CustomerColorCode', colCode);
            var dialogRef = this.dialog.open(_approver_approver_component__WEBPACK_IMPORTED_MODULE_6__["ApproverComponent"], {
              panelClass: 'full-width-dialog',
              data: data,
              width: '80%',
              disableClose: true
          ...
          key: "getAccountData",
          value: function getAccountData(params) {
            var _this19 = this;

            console.log("params :: ", params);
            this.tasksummaryService.getSearchData(params).subscribe(function (data) {
              console.log('resp data :: ', data);

              _this19.resetSearchData();

              for (var index = 0; index < data.accountList.length; index++) {
                var element = data.accountList[index];
                console.log('element ::', element);

                _this19.searchResponseUpdate(element.status, data.accountList);
              }
            });
          }
        }, {
          ...
          value: function updateDataOnScroll(status, data) {
            if (status == 'ONGOING') {
              var result = lodash__WEBPACK_IMPORTED_MODULE_8__["unionBy"](this.ONGOINGArr, data, 'accountId');
              this.ONGOINGArr = result;
            } else if (status == 'BACKLOG') {
              var _result7 = lodash__WEBPACK_IMPORTED_MODULE_8__["unionBy"](this.BACKLOGArr, data, 'accountId');

              this.BACKLOGArr = _result7;
            } else if (status == 'APPROVED') {
              var _result8 = lodash__WEBPACK_IMPORTED_MODULE_8__["unionBy"](this.APPROVEDArr, data, 'accountId');

              this.APPROVEDArr = _result8;
            } else if (status == 'REJECTED') {
              var _result9 = lodash__WEBPACK_IMPORTED_MODULE_8__["unionBy"](this.REJECTEDArr, data, 'accountId');

              this.REJECTEDArr = _result9;
            }
      ...
      TaskSummaryComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        template: function TaskSummaryComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function TaskSummaryComponent_Template_input_ngModelChange_9_listener($event) {
              return ctx.searchText = $event;
            })("keyup", function TaskSummaryComponent_Template_input_keyup_9_listener($event) {
              return ctx.updateSearch($event.target.value);
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("scrolled", function TaskSummaryComponent_Template_div_scrolled_26_listener($event) {
              return ctx.onScrollingFinished($event, "INITIATED");
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("scrolled", function TaskSummaryComponent_Template_div_scrolled_37_listener($event) {
              return ctx.onScrollingFinished($event, "UNDER_PROCESS");
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("scrolled", function TaskSummaryComponent_Template_div_scrolled_48_listener($event) {
              return ctx.onScrollingFinished($event, "APPROVED");
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("scrolled", function TaskSummaryComponent_Template_div_scrolled_59_listener($event) {
              return ctx.onScrollingFinished($event, "REJECTED");
            });
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](TaskSummaryComponent, [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
          args: [{
          ...
          return [{
            ...
            type: _tasksummary_service__WEBPACK_IMPORTED_MODULE_7__["TasksummaryService"]
          }, {
            type: app_shared_services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"]
          }, {
            type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ChangeDetectorRef"]
    ...
    /***/
    function mP0(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _task_summary_task_summary_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./task-summary/task-summary.component */
      "gUBa");
      /* harmony import */


      var _kyc_task_summary_kyc_task_summary_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./kyc-task-summary/kyc-task-summary.component */
      "7R5A");
      /* harmony import */


      var _cust_on_boarding_task_summary_cust_on_boarding_task_summary_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./cust-on-boarding-task-summary/cust-on-boarding-task-summary.component */
      "9Iqf");
      /* harmony import */


      var _cust_on_boarding_approver_cust_on_boarding_approver_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./cust-on-boarding-approver/cust-on-boarding-approver.component */
      "tNxk");
    ...
    function pnfF(module, __webpack_exports__, __webpack_require__) {
      ...
      var app_shared_services_application_entry_stage_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      ...
      var app_shared_services_api_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! app/shared/services/api.service */
      "nm5K");
      /* harmony import */
      ...
      function ApproverComponent_mat_spinner_8_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](0, "mat-spinner");
        }
      }

      function ApproverComponent_div_9_div_3_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function ApproverComponent_div_9_div_4_img_1_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function ApproverComponent_div_9_div_4_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div", 35);
      ...
      function ApproverComponent_div_9_div_68_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function ApproverComponent_div_9_div_88_mat_card_17_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function ApproverComponent_div_9_div_88_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div");
      ...
      function ApproverComponent_div_9_div_89_mat_card_4_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "mat-card");
        ...
        if (rf & 2) {
          var mandateData_r21 = ctx.$implicit;
          var i_r22 = ctx.index;
      ...
      function ApproverComponent_div_9_div_89_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div");
      ...
      function ApproverComponent_div_9_div_90_div_16_span_1_Template(rf, ctx) {
        if (rf & 1) {
        ...
        if (rf & 2) {
          var pref_r26 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]().$implicit;
      ...
      function ApproverComponent_div_9_div_90_div_16_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function ApproverComponent_div_9_div_90_div_27_span_1_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "span");
        ...
        if (rf & 2) {
          var pref_r30 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]().$implicit;
      ...
      function ApproverComponent_div_9_div_90_div_27_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div", 23);
      ...
      function ApproverComponent_div_9_div_90_div_31_span_1_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "span");
        ...
        if (rf & 2) {
          var pref_r34 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]().$implicit;
      ...
      function ApproverComponent_div_9_div_90_div_31_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div", 23);
      ...
      function ApproverComponent_div_9_div_90_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div");
      ...
      function ApproverComponent_div_9_div_91_mat_card_4_mat_card_35_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function ApproverComponent_div_9_div_91_mat_card_4_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "mat-card");
      ...
      function ApproverComponent_div_9_div_91_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div");
      ...
      function ApproverComponent_div_9_div_102_h3_1_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function ApproverComponent_div_9_div_102_mat_card_2_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "mat-card");
        ...
        if (rf & 2) {
          var secured_r44 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]().$implicit;
      ...
      function ApproverComponent_div_9_div_102_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div");
      ...
      function ApproverComponent_div_9_div_104_div_17_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div");
      ...
      function ApproverComponent_div_9_div_104_div_18_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div");
      ...
      function ApproverComponent_div_9_div_104_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div");
      ...
      function ApproverComponent_div_9_div_106_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div");
      ...
      function ApproverComponent_div_9_div_108_mat_card_10_mat_card_3_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "mat-card");
        ...
        if (rf & 2) {
          var interestData_r54 = ctx.$implicit;
      ...
      function ApproverComponent_div_9_div_108_mat_card_10_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "mat-card");
      ...
      function ApproverComponent_div_9_div_108_mat_card_13_mat_card_3_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "mat-card");
        ...
        if (rf & 2) {
          var chargeData_r57 = ctx.$implicit;
      ...
      function ApproverComponent_div_9_div_108_mat_card_13_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "mat-card");
      ...
      function ApproverComponent_div_9_div_108_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](5, "\xA0");
      ...
      function ApproverComponent_div_9_div_141_div_1_Template(rf, ctx) {
        if (rf & 1) {
        ...
        if (rf & 2) {
          var scMapping_r60 = ctx.$implicit;
      ...
      function ApproverComponent_div_9_div_141_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div");
      ...
      function ApproverComponent_div_9_mat_card_144_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "mat-card", 18);
      ...
      function ApproverComponent_div_9_div_147_mat_card_12_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "mat-card");
      ...
      function ApproverComponent_div_9_div_147_mat_card_13_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "mat-card");
      ...
      function ApproverComponent_div_9_div_147_mat_card_14_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "mat-card");
      ...
      function ApproverComponent_div_9_div_147_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div", 13);
      ...
      function ApproverComponent_div_9_div_200_div_1_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function ApproverComponent_div_9_div_200_div_1_Template_button_click_2_listener() {
            ...
            return ctx_r65.updateApplicationStatus(ctx_r65.accountInfo, "REJECTED");
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function ApproverComponent_div_9_div_200_div_1_Template_button_click_5_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r66);

            var ctx_r67 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](3);

            return ctx_r67.updateApplicationStatus(ctx_r67.accountInfo, "APPROVED");
          });
      ...
      function ApproverComponent_div_9_div_200_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div");
      ...
      function ApproverComponent_div_9_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](97, "\xA0");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](153, "\xA0");
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtextInterpolate3"]("", ctx_r1.accInfo.prefix, "\xA0", ctx_r1.accInfo.firstName, "\xA0", ctx_r1.accInfo.lastName, "");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtextInterpolate2"]("", ctx_r1.accInfo.firstName, "\xA0", ctx_r1.accInfo.lastName, "");
      ...
      var ApproverComponent = /*#__PURE__*/function () {
        function ApproverComponent(dialogRef, data, apiService, api, ls, router, tasksummaryService, cdr, snack, sanitizer) {
        ...
        _createClass(ApproverComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.tasksummaryService.accountStatus.subscribe(function (status) {
              // console.log("status :: ", status);
              if (status === 'REJECTED') {
                _this20.approvedStatus = true;
                _this20.rejectedStatus = true;
              } else if (status === 'APPROVED') {
                _this20.approvedStatus = true;
                _this20.rejectedStatus = true;
              } else if (status === 'ONGOING') {
                _this20.approvedStatus = false;
                _this20.rejectedStatus = false;
                _this20.isOnGoing = status;
              } else if (status === 'BACKLOG') {
                _this20.approvedStatus = false;
                _this20.rejectedStatus = false;
              }
            ...
            this.getProfileImage(this.accInfo.customerId); // this.accInfo.customerId == null ? null :this.
          }
        }, {
          key: "getAccountInfoByAccountId",
          value: function getAccountInfoByAccountId(accountId) {
            var _this21 = this;

            this.tasksummaryService.getAccountInfoByAccId(accountId).subscribe(function (accInfo) {
              _this21.accountInfo = accInfo;
              console.log("backend data", _this21.accountInfo);
              _this21.loading = false;

              _this21.assignValues(_this21.accountInfo.businessProductAccServices, _this21.accountInfo.businessProductNominee, _this21.accountInfo.securedOverdraft, _this21.accountInfo.unsecuredOverdraft, _this21.accountInfo.financialDetails, _this21.accountInfo.intrestDetails, _this21.accountInfo.chargeDetails, _this21.accountInfo.qualitativeScorecard, _this21.accountInfo.assessmentReport, _this21.accountInfo.createAccFundingStage); // console.log('accInfo :: ', this.accountInfo);


              for (var key in _this21.accountInfo) {
                if (Object.prototype.hasOwnProperty.call(_this21.accountInfo, key)) {
                  var element = _this21.accountInfo[key];

                  if (key === 'businessProductAccount') {
                    _this21.accountDetails = element;

                    if (_this21.accountDetails.applicationDate) {
                      _this21.accountDetails.applicationDate = _this21.accountDetails.applicationDate.slice(0, -8);
                    }
                  }

                  if (key === 'businessProductCustomer') {
                    _this21.customerInformation = element;

                    for (var custKey in _this21.customerInformation) {
                      if (Object.prototype.hasOwnProperty.call(_this21.customerInformation, custKey)) {
                        var custEle = _this21.customerInformation[custKey];

                        if (custKey === 'data') {
                          for (var applicantKey in custEle) {
                            if (Object.prototype.hasOwnProperty.call(custEle, applicantKey)) {
                              var applicantEle = custEle[applicantKey];

                              if (custEle.length > 1) {
                                if (applicantEle.primaryCustomer) {
                                  _this21.approverName = applicantEle.firstName;
                                }
                              } else {
                                _this21.approverName = applicantEle.firstName;
                              }
          ...
          key: "assignValues",
          value: function assignValues(businessProductAccServices, nominee, securedOverdraftDetails, unsecuredOverdraftDetails, financialDetails, intrestDetails, chargeDetails, scoreCardMappingArray, assessmentReport, createAccFundingStage) {
          ...
          value: function updateApplicationStatus(formData, status) {
            var _this22 = this;

            console.log('data : ', formData.businessProductAccount.accountId);
            formData.businessProductAccount.status = status; //to send status on dialog close 
            ...
            this.tasksummaryService.updateCreateAccStatus(formDt).subscribe(function (respData) {
              ...
              if (respData.accountId != null || respData.accountId != '' || respData.accountId != "") {
                ...
                _this22.snack.open('Not able to connect to server!', 'INTERNAL SERVER ERROR', {
                  duration: 4000,
                  verticalPosition: 'top',
                  horizontalPosition: 'right'
              ...
              _this22.errorStatus = status;

              _this22.snack.open("".concat(error.error.message, " "), 'OK', {
                duration: 4000,
                verticalPosition: 'top',
                horizontalPosition: 'right'
          ...
          value: function getProfileImage(customerId) {
            ...
            this.image = null;
            this.accInfo.customerId == null ? null : this.api.getProfileDetails(customerId).subscribe(function (data) {
              // console.log(data);
              // this.profileData = data;
              // console.log(data.profileImage); 
              if (data.profileImage != null) {
                _this23.imageUrl = data.profileImage;
                console.log("imageurl", _this23.imageUrl);
                var objectURL = data.profileImage.fileUrl;
                _this23.image = _this23.sanitizer.bypassSecurityTrustUrl(objectURL);
          ...
          value: function getByAccountId(accountId) {
            ...
            this.apiService.getByAccountId(accountId).subscribe(function (resp) {
              _this24.accountdetailsForStatusUpdate = resp;

              _this24.updateAccountStatus(resp);
            });
          }
        }, {
          key: "updateAccountStatus",
          value: function updateAccountStatus(accData) {
            accData.status = this.appStatus;
            this.apiService.saveProductAccountInfo(accData).subscribe(function (updateResp) {
      ...
      ApproverComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
        ...
        template: function ApproverComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function ApproverComponent_Template_mat_icon_click_5_listener() {
              return ctx.close(ctx.accStatus);
            });
        ...
        pipes: [_angular_common__WEBPACK_IMPORTED_MODULE_12__["SlicePipe"], _angular_common__WEBPACK_IMPORTED_MODULE_12__["UpperCasePipe"]],
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](ApproverComponent, [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"],
          args: [{
          ...
          return [{
            ...
            type: app_shared_services_application_entry_stage_service__WEBPACK_IMPORTED_MODULE_3__["ApplicationEntryStageService"]
          }, {
            type: app_shared_services_api_service__WEBPACK_IMPORTED_MODULE_9__["ApiService"]
          }, {
    ...
    /***/
    function tNxk(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "CustOnBoardingApproverComponent", function () {
        return CustOnBoardingApproverComponent;
      });
      /* harmony import */
      ...
      var _tasksummary_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ../tasksummary.service */
      "6rwl");
      /* harmony import */
      ...
      function CustOnBoardingApproverComponent_mat_spinner_2_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "mat-spinner");
        }
      }

      function CustOnBoardingApproverComponent_div_9_div_3_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function CustOnBoardingApproverComponent_div_9_div_4_img_1_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function CustOnBoardingApproverComponent_div_9_div_4_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 14);
      ...
      function CustOnBoardingApproverComponent_div_9_div_12_div_44_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function CustOnBoardingApproverComponent_div_9_div_12_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function CustOnBoardingApproverComponent_div_9_div_13_div_13_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
      ...
      function CustOnBoardingApproverComponent_div_9_div_13_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 18);
      ...
      function CustOnBoardingApproverComponent_div_9_div_15_small_15_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function CustOnBoardingApproverComponent_div_9_div_15_div_16_div_1_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function CustOnBoardingApproverComponent_div_9_div_15_div_16_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
      ...
      function CustOnBoardingApproverComponent_div_9_div_15_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 18);
      ...
      function CustOnBoardingApproverComponent_div_9_div_16_div_33_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 34);
      ...
      function CustOnBoardingApproverComponent_div_9_div_16_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 18);
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](40, "\xA0\xA0\xA0\xA0 ");
      ...
      function CustOnBoardingApproverComponent_div_9_div_17_small_32_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "small", 53);
      ...
      function CustOnBoardingApproverComponent_div_9_div_17_div_33_div_4_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function CustOnBoardingApproverComponent_div_9_div_17_div_33_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
      ...
      function CustOnBoardingApproverComponent_div_9_div_17_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 18);
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](24, "\xA0\xA0\xA0\xA0 ");
      ...
      function CustOnBoardingApproverComponent_div_9_div_18_Template(rf, ctx) {
        if (rf & 1) {
          var _r24 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CustOnBoardingApproverComponent_div_9_div_18_Template_button_click_3_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r24);

            var ctx_r23 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2);

            return ctx_r23.updateApplicationStatus(ctx_r23.dataResponse, "REJECTED");
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CustOnBoardingApproverComponent_div_9_div_18_Template_button_click_6_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r24);

            var ctx_r25 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2);

            return ctx_r25.updateApplicationStatus(ctx_r25.dataResponse, "APPROVED");
          });
      ...
      function CustOnBoardingApproverComponent_div_9_Template(rf, ctx) {
        if (rf & 1) {
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate4"]("", ctx_r1.dataResponse.dataResp.prefix, "\xA0", ctx_r1.dataResponse.dataResp.firstName, "\xA0", ctx_r1.dataResponse.dataResp.middleName, "\xA0", ctx_r1.dataResponse.dataResp.lastName, " ");
      ...
      var CustOnBoardingApproverComponent = /*#__PURE__*/function () {
        function CustOnBoardingApproverComponent(tasSumService, cdr, apiService, dialogRef, dataResponse, sanitizer, snack) {
          _classCallCheck(this, CustOnBoardingApproverComponent);
          ...
          this.sanitizer = sanitizer;
          this.snack = snack; // custOnBoardingApprovet:CustOnBoardingApprover;
        ...
        _createClass(CustOnBoardingApproverComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            var _this25 = this;
            ...
            setTimeout(function () {
              ...
              console.log("dataResponse.dataResp.customerId", _this25.dataResponse.dataResp.customerId);
              console.log("dataResponse.dataResp.accountId", _this25.dataResponse.dataResp.accountId);
              _this25.customerId = _this25.dataResponse.dataResp.customerId;

              _this25.getCustomerDocumentsDetails(_this25.customerId);

              console.log(_this25.customerId);
              _this25.phoneNum = _this25.dataResponse.dataResp.phoneNumber;
              _this25.emailID = _this25.dataResponse.dataResp.primaryEmailAdress;
              console.log("Dataas", _this25.dataResponse, _this25.phoneNum, _this25.emailID);
              _this25.customerColorCode = localStorage.getItem('CustomerColorCode'); // console.log('dataResponse :: ', this.dataResponse.dataResp);
              // console.log('recordStatus :: ', this.dataResponse.recordStatus);

              _this25.imageUrl = _this25.dataResponse.dataResp.profileImage;
              _this25.status = _this25.dataResponse.dataResp.custStatus;
              _this25.errorStatus = _this25.dataResponse.dataResp.custStatus;
              _this25.userAddress_array = _this25.dataResponse.dataResp.userAddress;
              _this25.custIdProofs_array = _this25.dataResponse.dataResp.custIdProofs;
              console.log("result::", _this25.custIdProofs_array);

              if (_this25.status === 'REJECTED') {
                _this25.rejectedStatus = true;
                _this25.approvedStatus = true;
              } else if (_this25.status === 'INITIATED') {
                _this25.rejectedStatus = false;
                _this25.approvedStatus = false;
              } else if (_this25.status === 'APPROVED') {
                _this25.rejectedStatus = true;
                _this25.approvedStatus = true;
              } else if (_this25.status === 'UNDER_PROCESS') {
                _this25.rejectedStatus = true;
                _this25.approvedStatus = true;
              ...
              _this25.getProfileImage(_this25.dataResponse.dataResp.customerId);

              _this25.fetchSignatureDetails(_this25.dataResponse.dataResp.customerId);
            }, 5000);
          }
        }, {
          ...
          value: function getCustomerDocumentsDetails(customerId) {
            ...
            this.apiService.getCustomerDocuments(customerId, this.document_type).subscribe(function (result) {
              ...
              console.log(result);
              _this26.custOtherDoc_array = result;
              console.log(_this26.custOtherDoc_array);

              if (result != null) {
                _this26.documentName = _this26.custOtherDoc_array[0].fileName; // console.log("custOtherDoc_array::",this.custOtherDoc_array)
              }
            });
          }
        }, {
          ...
          value: function updateApplicationStatus(formData, status) {
            ...
            this.statusUpdate = status; // console.log('formData :: ', formData.dataResp);

            /* TO-DO: update correct api this method call */
            // console.log('customerId :: ', formData.dataResp.customerId);

            this.apiService.updateKycStatusByCustId(formData.dataResp.customerId, '', status).subscribe(function (data) {
              ...
              if (data != null) {
                ...
                _this27.snack.open("".concat(status, " "), 'OK', {
                  duration: 4000,
                  verticalPosition: 'top',
                  horizontalPosition: 'right'
                });
          ...
          value: function getProfileImage(customerId) {
            ...
            this.apiService.getProfileDetails(customerId).subscribe(function (data) {
              ...
              if (data.profileImage != null) {
                ...
                var objectURL = data.profileImage.fileUrl;
                _this28.image = _this28.sanitizer.bypassSecurityTrustUrl(objectURL);
              } // console.log(this.image,"Profile Data");
              // console.log(this.profileData.customerName,"Profile Data");
              // const blob = base64StringToBlob(this.profileData.fileData, contentType);
              // console.log(blob);
          ...
          key: "fetchSignatureDetails",
          value: function fetchSignatureDetails(customerId) {
            var _this29 = this;

            console.log("inside fetchSignatureDetails method"); // this.apiService.fetchSignatureInfo(customerId)
            // .subscribe((data:any) => {
            //    console.log(data);
            // },(error:any) => {
            //    console.log(error);
            ...
            this.apiService.getSignatureDocuments(customerId).subscribe(function (data) {
              console.log(data);
              _this29.noOFSigns = data[0].noOfSignatures;
              _this29.signatureDetails_array = data;
            }, function (error) {
              console.log(error);
            });
          }
      ...
      CustOnBoardingApproverComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        template: function CustOnBoardingApproverComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CustOnBoardingApproverComponent_Template_mat_icon_click_7_listener() {
              return ctx.close(ctx.dataResponse);
            });
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](CustOnBoardingApproverComponent, [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
          args: [{
          ...
          return [{
            type: _tasksummary_service__WEBPACK_IMPORTED_MODULE_5__["TasksummaryService"]
          }, {
            type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ChangeDetectorRef"]
          }, {
...
//# sourceMappingURL=views-tasks-tasks-module-es5.js.map