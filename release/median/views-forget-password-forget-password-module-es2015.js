...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "forgetPasswordRoutes", function() { return forgetPasswordRoutes; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _forget_password_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./forget-password.component */ "./src/app/views/forget-password/forget-password.component.ts");
...
/* harmony import */ var _login_login_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../login/login.service */ "./src/app/views/login/login.service.ts");
...
/* harmony import */ var _security_policy_security_policy_security_policy_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../security-policy/security-policy/security-policy.service */ "./src/app/views/security-policy/security-policy/security-policy.service.ts");
...
let ForgetPasswordComponent = class ForgetPasswordComponent {
    constructor(router, route, apiService, fb, loginservice, apiService1, snack) {
        this.router = router;
        this.route = route;
        ...
        this.apiService.forgetPassword(this.login1).subscribe(res => {
            ...
            if (this.var1) {
                ...
                if (this.var1[0] === 'Login success.') {
                    ...
                    sweetalert2__WEBPACK_IMPORTED_MODULE_6___default.a.fire(this.var1[0]);
                }
    ...
    getOtp(username) {
        ...
        var USERNAME = crypto_js__WEBPACK_IMPORTED_MODULE_7__["AES"].encrypt(username, "@12#90!^*NPR*g&*()$34#$");
    ...
    changePassword(newPassword, confirmPassword, userId, otp) {
        ...
        if (newPassword != confirmPassword) {
            ...
            this.loginProcessing = true;
            let encryptedAES = crypto_js__WEBPACK_IMPORTED_MODULE_7__["AES"].encrypt(newPassword, '@12#90!^*NPR*g&*()$34#$');
            let USERNAME = crypto_js__WEBPACK_IMPORTED_MODULE_7__["AES"].encrypt(userId, '@12#90!^*NPR*g&*()$34#$');
            var data = encryptedAES.toString();
...
ForgetPasswordComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./forget-password.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/views/forget-password/forget-password.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./forget-password.component.css */ "./src/app/views/forget-password/forget-password.component.css")).default]
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"],
        ...
        _login_login_service__WEBPACK_IMPORTED_MODULE_3__["LoginService"],
        _security_policy_security_policy_security_policy_service__WEBPACK_IMPORTED_MODULE_9__["SecurityPolicyService"],
...
/* harmony import */ var _forget_password_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./forget-password-routing.module */ "./src/app/views/forget-password/forget-password-routing.module.ts");
...
/* harmony import */ var _forget_password_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./forget-password.component */ "./src/app/views/forget-password/forget-password.component.ts");
/* harmony import */ var src_app_shared_components_components_module__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! src/app/shared/components/components.module */ "./src/app/shared/components/components.module.ts");
...
ForgetPasswordModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        imports: [
            ...
            src_app_shared_components_components_module__WEBPACK_IMPORTED_MODULE_9__["ComponentsModule"],
            ...
            _angular_router__WEBPACK_IMPORTED_MODULE_7__["RouterModule"].forChild(_forget_password_routing_module__WEBPACK_IMPORTED_MODULE_3__["forgetPasswordRoutes"])
        ]
    })
...
//# sourceMappingURL=views-forget-password-forget-password-module-es2015.js.map