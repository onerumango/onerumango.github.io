(function () {
  ...
  (self["webpackChunkmedian"] = self["webpackChunkmedian"] || []).push([["src_app_views_audit-logs_audit-logs_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var src_app_shared_services_account_closure_service_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      ...
      function AuditLogsComponent_div_4_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵlistener"]("change", function AuditLogsComponent_div_4_Template_select_change_3_listener($event) {
        ...
        _createClass(_AuditLogsComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.dtOptions = {
              ...
              ajax: function ajax(dataTablesParameters, callback) {
                ...
                _this60.http.get("http://192.168.0.14:9003/auditLogs/getAllAuditLogs?pageNo=".concat(0, "&pageSize=", 1000, "&sortBy=", 'creatorDtStamp')).subscribe(function (resp) {
                  _this60.auditlogdata = resp.result;
                  _this60.isLoading = false;

                  _this60.cdr.markForCheck();

                  _this60.dtTrigger.next();
          ...
          value: function getAuditLogList() {
            ...
            this.api.getAllAuditData().subscribe(function (data) {
              _this61.auditlogdata = data.result;
              _this61.isLoading = false;

              _this61.cdr.markForCheck();

              _this61.dtTrigger.next();
            });
          }
        }, {
          key: "modo",
          ...
          value: function exportAsXLSX() {
            ...
            this.auditlogdata.forEach(function (element) {
              element.timeForExport = _this62.pipe.transform(element.timeForExport, 'dd-MMM-yy').toString();
              element.updatedAt = _this62.pipe.transform(element.updatedAt, 'dd-MMM-yy').toString();
              element.creatorDtStamp = _this62.pipe.transform(element.creatorDtStamp, 'dd-MMM-yy').toString();
      ...
      _AuditLogsComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵdefineComponent"]({
        ...
        directives: [_angular_common__WEBPACK_IMPORTED_MODULE_9__.NgIf, angular_datatables__WEBPACK_IMPORTED_MODULE_7__.DataTableDirective, _angular_common__WEBPACK_IMPORTED_MODULE_9__.NgForOf],
