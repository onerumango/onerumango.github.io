        ...
        _createClass(EsignPopComponent, [{
          ...
          value: function onSubmit() {
            ...
            this.router.navigateByUrl('/', {
              ...
              _this2.router.navigate(['/home/application/digital-sign/options/', _this2.accountId]);
            });
        ...
        _createClass(UploadSignEsignComponent, [{
          ...
          value: function close1() {
            ...
            this.router.navigateByUrl('/', {
              ...
              _this6.router.navigate(['/home/application/digital-sign/options/', _this6.accountId]);
            });
          }
        }, {
          key: "openPopUp",
            ...
            if (!this.show) {
              ...
              dialogRef.afterClosed().subscribe(function (res) {
                ...
                if (res) {
                  ...
                  _this7.show = _this7.ls.setItem('enable', true);
          ...
          value: function deleteImg() {
            ...
            this.dialogService.doConfirmDialog('').subscribe(function (response) {
              if (response == "Yes") {
                ...
                _this9.apiService.deleteCustomerDoc(_this9.customerId, _this9.profileId).subscribe(function (data) {});

                _this9.disableDone = true;

                _this9.ls.setItem('enable', true);
              }
            });
          }
        }]);
