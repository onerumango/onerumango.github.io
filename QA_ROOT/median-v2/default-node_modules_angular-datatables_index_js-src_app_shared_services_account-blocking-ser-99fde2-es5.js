      ...
      var _AccountBlockingServiceService = /*#__PURE__*/function () {
        ...
        _createClass(_AccountBlockingServiceService, [{
          ...
          value: function accountBlockingQuery(formdata, userId) {
            return this.http.post("".concat(_API_URL, "/api/search/").concat(userId), formdata);
          }
        }, {
          ...
          value: function custMoreDetails() {
            return this.http.get("".concat(_API_URL, "/api/getMoreCustDetails"));
          }
        }, {
          ...
          value: function last10Transaction(custAccNo, accBranch, customerNumber) {
            return this.http.get("".concat(_API_URL, "/api/getLastTenTrans/").concat(custAccNo, "/").concat(accBranch, "/").concat(customerNumber));
          }
        }]);
