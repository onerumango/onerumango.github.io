(function () {
  ...
  (self["webpackChunkmedian"] = self["webpackChunkmedian"] || []).push([["src_app_views_email-management_email-management_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      function EmailManagementCreateComponent_div_25_Template(rf, ctx) {
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵproperty"]("ngClass", _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵpureFunction1"](6, _c0, ctx_r1.emailForm.controls.emails.invalid || ctx_r1.editFlag || i_r7 === 0));
        }
      }
      ...
      function EmailManagementCreateComponent_div_32_Template(rf, ctx) {
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵtextInterpolate1"](" ", _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵpipeBind2"](26, 8, ctx_r4.eamilAuditLog.inputTime, "MM/dd/yyyy, h:mm a"), " ");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵtextInterpolate1"](" ", _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵpipeBind2"](63, 11, ctx_r4.eamilAuditLog.verifiedTime, "MM/dd/yyyy, h:mm a"), " ");
        ...
        _createClass(_EmailManagementCreateComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.navSubscription = this.accountBlockingService.getNavParam.subscribe(function (data) {
              return _this.editAddSysResp = data;
            });
          ...
          value: function removeAddress(i, row) {
            ...
            this.accountBlockingService.deleteingParticluarRow(this.eamilAuditLog.emailType, this.loggedInUser, row.value.id).subscribe(function (deleteResp) {
              if (deleteResp == true) {
                _this5.emails.removeAt(i); //   Swal.fire({
          ...
          value: function onClickOfDeleteOfEmailManagement() {
            ...
            sweetalert2__WEBPACK_IMPORTED_MODULE_2___default().fire({
              ...
              if (result.isConfirmed === true) {
                _this6.accountBlockingService.onclickOfDeleteOfEmailManagement(_this6.selected, _this6.loggedInUser).subscribe(function (deletedRecord) {
          ...
          value: function onclickOfReopenOfEamilManagement() {
            ...
            sweetalert2__WEBPACK_IMPORTED_MODULE_2___default().fire({
              ...
              if (result.isConfirmed === true) {
                _this8.accountBlockingService.onClickOfAuthOfEmailManagement('reopen', 'Account_Block', _this8.loggedInUser).subscribe(function (reopenResp) {
                  if (reopenResp == false) {
                    // this.iziToast.show({
          ...
          value: function onclickOfCloseOfEmailManagement() {
            ...
            sweetalert2__WEBPACK_IMPORTED_MODULE_2___default().fire({
              ...
              if (result.isConfirmed === true) {
                _this9.accountBlockingService.onClickOfAuthOfEmailManagement('close', 'Account_Block', _this9.loggedInUser).subscribe(function (closeResp) {
                  if (closeResp == false) {
                    sweetalert2__WEBPACK_IMPORTED_MODULE_2___default().fire({
          ...
          value: function logValue() {
            ...
            if (this.emailCheckForSameEmail) {
              sweetalert2__WEBPACK_IMPORTED_MODULE_2___default().fire('Please Enter Different Email Id').then(function () {
                _this10.emailCheckForSameEmail = false;
              });
            }
              ...
              this.accountBlockingService.onclickOfEditOfEmailManagement(this.selected, this.loggedInUser, this.emails.value).subscribe(function (editResp) {
                ...
                if (editResp == null) {
                  ...
                  sweetalert2__WEBPACK_IMPORTED_MODULE_2___default().fire({
                    ...
                    _this10.router.navigateByUrl("/email-management");
                  });
                }
              });
            }
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      function EmailManagementComponent_tr_27_button_16_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function EmailManagementComponent_tr_27_button_17_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵlistener"]("click", function EmailManagementComponent_tr_27_button_17_Template_button_click_0_listener() {
      ...
      function EmailManagementComponent_tr_27_button_18_Template(rf, ctx) {
        if (rf & 1) {
          var _r13 = _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵgetCurrentView"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵelementStart"](0, "button", 22);

          _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵlistener"]("click", function EmailManagementComponent_tr_27_button_18_Template_button_click_0_listener() {
            ...
            return ctx_r11.reopen(email_r4);
          });
      ...
      function EmailManagementComponent_tr_27_Template(rf, ctx) {
        if (rf & 1) {
          var _r15 = _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵgetCurrentView"]();
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵlistener"]("click", function EmailManagementComponent_tr_27_Template_a_click_2_listener() {
            ...
            return ctx_r14.getEmail(email_r4);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵlistener"]("click", function EmailManagementComponent_tr_27_Template_button_click_14_listener() {
            var restoredCtx = _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵrestoreView"](_r15);
        ...
        _createClass(_EmailManagementComponent, [{
          ...
          value: function auth(email) {
            ...
            sweetalert2__WEBPACK_IMPORTED_MODULE_2___default().fire({
              ...
              if (result.isConfirmed === true) {
                ...
                email.loggedInUser = _this13.currentUser;

                _this13.accountBlockingService.onClickOfAuthOfEmailManagement('Verify', 'Account_Block', _this13.loggedInUser).subscribe(function (resp) {
                  console.log(resp);
                  _this13.eamilAuditLog = resp;
          ...
          value: function close(email) {
            ...
            sweetalert2__WEBPACK_IMPORTED_MODULE_2___default().fire({
              ...
              if (result.isConfirmed === true) {
                ...
                _this14.accountBlockingService.onClickOfAuthOfEmailManagement('close', _this14.loggedInUser, email).subscribe(function (resp) {
                  console.log(resp);
                  _this14.eamilAuditLog = resp;

                  _this14.auditlog();

                  if (_this14.eamilAuditLog) {
                    sweetalert2__WEBPACK_IMPORTED_MODULE_2___default().fire({
                      text: 'Record is Closed'
                    }).then(function () {
                      return window.location.reload();
          ...
          value: function reopen(email) {
            ...
            sweetalert2__WEBPACK_IMPORTED_MODULE_2___default().fire({
              ...
              if (result.isConfirmed === true) {
                _this15.accountBlockingService.onClickOfAuthOfEmailManagement('reopen', _this15.loggedInUser, email).subscribe(function (resp) {
                  console.log(resp);
      ...
      _EmailManagementComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵdefineComponent"]({
        ...
        decls: 28,
        vars: 4,
        consts: [[1, "pageContentMain"], [1, "pageTitleCol"], [1, "pageTitle"], [1, "dbCardStyle"], [1, "row", "g-3", "pb-3", "justify-content-end"], ["class", "col-auto", 4, "ngIf"], [1, "col-auto"], ["href", "javascript:void(0)", 1, "btn", "smBtn", "minWdSmBtn", "btnSecondary"], [1, "table-responsive"], ["datatable", "", 1, "dataTable", "table", "tableStyle", "nowrap", "vAlignMdl", 2, "width", "100%", 3, "dtOptions", "dtTrigger"], [4, "ngFor", "ngForOf"], [1, "btn", "smBtn", "minWdSmBtn", "btnPrimary", 3, "click"], [1, "primaryColor", 3, "routerLink", "click"], ["title", "Authorize", 1, "btn", 2, "color", "red", 3, "disabled", "click"], ["src", "assets/images/authorize.svg", "alt", "Authorize", 1, "summaryIcon"], ["class", "btn", "style", "color: red", "title", "Delete", 4, "ngIf"], ["class", "btn", "style", "color: red", "title", "Close", 3, "click", 4, "ngIf"], ["class", "btn", "style", "color: red", "title", "Reopen", 3, "click", 4, "ngIf"], ["title", "Delete", 1, "btn", 2, "color", "red"], ["src", "assets/images/delete.svg", "alt", "...", 1, "summaryIcon"], ["title", "Close", 1, "btn", 2, "color", "red", 3, "click"], ["src", "assets/images/CROSS1.svg", "alt", "...", 1, "summaryIcon"], ["title", "Reopen", 1, "btn", 2, "color", "red", 3, "click"], ["src", "assets/images/open.svg", "alt", "...", 1, "summaryIcon"]],
