(function () {
  ...
  (self["webpackChunkmedian"] = self["webpackChunkmedian"] || []).push([["default-node_modules_angular-datatables_index_js-node_modules_ng-select_ng-select_fesm2015_ng-20c43d"], {
    /***/
    50481:
    /*!**************************************************!*\
        ...
        _createClass(ItemsList, [{
          ...
          value: function filter(term) {
            ...
            var _loop = function _loop() {
              ...
              var _iterator = _createForOfIteratorHelper(_this4._groups.get(key)),
                  _step;
              ...
              try {
                for (_iterator.s(); !(_step = _iterator.n()).done;) {
                  ...
                  var searchItem = _this4._ngSelect.searchFn ? item.value : item;
              ...
              if (matchedItems.length > 0) {
                ...
                if (last.parent) {
                  var head = _this4._items.find(function (x) {
          ...
          value: function _flatten(groups) {
            ...
            var _loop2 = function _loop2() {
              ...
              var groupValue = _this7._ngSelect.groupValue || function () {
                if (isObjectKey) {
                  return key.value;
                }
        ...
        _createClass(NgDropdownPanelComponent, [{
          ...
          value: function _updateDropdownClass(currentPosition) {
            ...
            CSS_POSITIONS.forEach(function (position) {
              ...
              _this8._renderer.removeClass(_this8._dropdown, REMOVE_CSS_CLASS);

              _this8._renderer.removeClass(_this8._select, REMOVE_CSS_CLASS);
            });
          ...
          value: function _handleScroll() {
            ...
            this._zone.runOutsideAngular(function () {
              (0, rxjs__WEBPACK_IMPORTED_MODULE_4__.fromEvent)(_this9.scrollElementRef.nativeElement, 'scroll').pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.takeUntil)(_this9._destroy$), (0, rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.auditTime)(0, SCROLL_SCHEDULER)).subscribe(function (e) {
                var path = e.path || e.composedPath && e.composedPath();
                var scrollTop = !path || path.length === 0 ? e.target.scrollTop : path[0].scrollTop;

                _this9._onContentScrolled(scrollTop);
              });
            });
          }
        }, {
          ...
          value: function _handleOutsideClick() {
            ...
            this._zone.runOutsideAngular(function () {
              (0, rxjs__WEBPACK_IMPORTED_MODULE_7__.merge)((0, rxjs__WEBPACK_IMPORTED_MODULE_4__.fromEvent)(_this10._document, 'touchstart', {
                capture: true
              }), (0, rxjs__WEBPACK_IMPORTED_MODULE_4__.fromEvent)(_this10._document, 'mousedown', {
                capture: true
              })).pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.takeUntil)(_this10._destroy$)).subscribe(function ($event) {
                return _this10._checkToClose($event);
              });
            });
          }
        }, {
          ...
          value: function _checkToClose($event) {
            ...
            this._zone.run(function () {
              return _this11.outsideClick.emit();
            });
          }
        }, {
          key: "_onItemsChange",
          ...
          value: function _updateItems(firstChange) {
            ...
            this._zone.runOutsideAngular(function () {
              Promise.resolve().then(function () {
                var panelHeight = _this12._scrollablePanel.clientHeight;

                _this12._panelService.setDimensions(0, panelHeight);

                _this12._handleDropdownPosition();

                _this12.scrollTo(_this12.markedItem, firstChange);
              });
            });
          }
        }, {
          ...
          value: function _updateItemsRange(firstChange) {
            ...
            this._zone.runOutsideAngular(function () {
              _this13._measureDimensions().then(function () {
                if (firstChange) {
                  _this13._renderItemsRange(_this13._startOffset);

                  _this13._handleDropdownPosition();
                } else {
                  _this13._renderItemsRange();
                }
              });
            });
          }
          ...
          value: function _renderItemsRange() {
            ...
            this._zone.run(function () {
              _this14.update.emit(_this14.items.slice(range.start, range.end));
          ...
          value: function _measureDimensions() {
            ...
            return Promise.resolve().then(function () {
              var option = _this15._dropdown.querySelector("#".concat(first.htmlId));

              var optionHeight = option.clientHeight;
              _this15._virtualPadding.style.height = "".concat(optionHeight * _this15.itemsLength, "px");
              var panelHeight = _this15._scrollablePanel.clientHeight;

              _this15._panelService.setDimensions(optionHeight, panelHeight);

              return _this15._panelService.dimensions;
            });
          }
        }, {
          ...
          value: function _fireScrollToEnd(scrollTop) {
            ...
            if (scrollTop + this._dropdown.clientHeight >= padding.clientHeight - 1) {
              this._zone.run(function () {
                return _this16.scrollToEnd.emit();
              });
          ...
          value: function _setupMousedownListener() {
            ...
            this._zone.runOutsideAngular(function () {
              (0, rxjs__WEBPACK_IMPORTED_MODULE_4__.fromEvent)(_this17._dropdown, 'mousedown').pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.takeUntil)(_this17._destroy$)).subscribe(function (event) {
      ...
      var _NgSelectComponent = /*#__PURE__*/function () {
        function _NgSelectComponent(classes, autoFocus, config, newSelectionModel, _elementRef, _cd, _console) {
          ...
          this.clearItem = function (item) {
            var option = _this18.selectedItems.find(function (x) {
              return x.value === item;
            });

            _this18.unselect(option);
          };

          this.trackByOption = function (_, item) {
            if (_this18.trackByFn) {
              return _this18.trackByFn(item.value);
            }
        ...
        _createClass(_NgSelectComponent, [{
          ...
          value: function selectTag() {
            ...
            var handleTag = function handleTag(item) {
              return _this19._isTypeahead || !_this19.isOpen ? _this19.itemsList.mapItem(item, null) : _this19.itemsList.addItem(item);
            };

            if (isPromise(tag)) {
              tag.then(function (item) {
                return _this19.select(handleTag(item));
              })["catch"](function () {});
            } else if (tag) {
          ...
          value: function _setItemsFromNgOptions() {
            ...
            var mapNgOptions = function mapNgOptions(options) {
              _this20.items = options.map(function (option) {
                return {
              ...
              _this20.itemsList.setItems(_this20.items);

              if (_this20.hasValue) {
                _this20.itemsList.mapSelectedItems();
              }

              _this20.detectChanges();
            };

            var handleOptionChange = function handleOptionChange() {
              var changedOrDestroyed = (0, rxjs__WEBPACK_IMPORTED_MODULE_7__.merge)(_this20.ngOptions.changes, _this20._destroy$);
              (0, rxjs__WEBPACK_IMPORTED_MODULE_7__.merge).apply(void 0, _toConsumableArray(_this20.ngOptions.map(function (option) {
                ...
                var item = _this20.itemsList.findItem(option.value);

                item.disabled = option.disabled;
                item.label = option.label || item.label;

                _this20._cd.detectChanges();
              });
            };
            ...
            this.ngOptions.changes.pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_9__.startWith)(this.ngOptions), (0, rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.takeUntil)(this._destroy$)).subscribe(function (options) {
              _this20.bindLabel = _this20._defaultLabel;
          ...
          value: function _isValidWriteValue(value) {
            ...
            var validateBinding = function validateBinding(item) {
              if (!isDefined(_this21.compareWith) && isObject(item) && _this21.bindValue) {
                _this21._console.warn("Setting object(".concat(JSON.stringify(item), ") as your model with bindValue is not allowed unless [compareWith] is used."));
          ...
          value: function _handleWriteValue(ngModel) {
            ...
            var select = function select(val) {
              var item = _this22.itemsList.findItem(val);

              if (item) {
                _this22.itemsList.select(item);
              } else {
                var isValObject = isObject(val);
                var isPrimitive = !isValObject && !_this22.bindValue;

                if (isValObject || isPrimitive) {
                  _this22.itemsList.select(_this22.itemsList.mapItem(val, null));
                } else if (_this22.bindValue) {
                  var _item2;

                  item = (_item2 = {}, _defineProperty(_item2, _this22.bindLabel, null), _defineProperty(_item2, _this22.bindValue, val), _item2);

                  _this22.itemsList.select(_this22.itemsList.mapItem(item, null));
                }
              }
            };
          ...
          value: function _handleKeyPresses() {
            ...
            this._keyPress$.pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.takeUntil)(this._destroy$), (0, rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.tap)(function (letter) {
              return _this23._pressedKeys.push(letter);
              ...
              return _this23._pressedKeys.length > 0;
            }), (0, rxjs_operators__WEBPACK_IMPORTED_MODULE_13__.map)(function () {
              return _this23._pressedKeys.join('');
            })).subscribe(function (term) {
              var item = _this23.itemsList.findByLabel(term);

              if (item) {
                if (_this23.isOpen) {
                  _this23.itemsList.markItem(item);

                  _this23._scrollToMarked();

                  _this23._cd.markForCheck();
                } else {
                  _this23.select(item);
                }
              }

              _this23._pressedKeys = [];
            });
          }
        }, {
...
//# sourceMappingURL=default-node_modules_angular-datatables_index_js-node_modules_ng-select_ng-select_fesm2015_ng-20c43d-es5.js.map