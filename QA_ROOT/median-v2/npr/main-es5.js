(function () {
  ...
  (self["webpackChunkmedian"] = self["webpackChunkmedian"] || []).push([["main"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      function HeaderComponent_li_180_div_1_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵlistener"]("click", function HeaderComponent_li_180_div_1_Template_div_click_1_listener($event) {
        ...
        _createClass(_HeaderComponent, [{
          ...
          value: function logOut() {
            ...
            sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire({
              ...
              if (result.isConfirmed == true) {
                ...
                _this4.localStoreService.clear();
                ...
                _this4.router.navigate(['session/login']);
              }
          ...
          value: function onSelectFile(event) {
            ...
            if (event.target.files && event.target.files[0]) {
              ...
              reader.onload = function (event) {
                ...
                _this5.url = event.target.result;
                console.log(_this5.url, "URL");
              };
            }
          ...
          value: function getProfileImage(user_id) {
            ...
            this.api.getCustomerDocuments(user_id).subscribe(function (data) {
              ...
              if (data) {
                _this6.profileId = data.id;
                _this6.url = data.fileUrl;
              }
            });
          }
        }, {
          ...
          value: function changePassword() {
            ...
            sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire({
              ...
              if (result.isConfirmed == true) {
                ...
                _this7.router.navigate(['change-password']);
              }
            });
          } //   $(".ddParent").removeClass("actDD");
          //   this.router.navigate(['change-password']);
          ...
          value: function getTransactionCodeSummary() {
            ...
            this.api.gettingTransactionCodeSummary().subscribe(function (resp) {
              ...
              _this9.transactionCodeData = resp.result;
              console.log(_this9.transactionCodeData, "Transaction Code Data");

              for (var i = 0; i <= _this9.transactionCodeData.length; i++) {
                // console.log("Looooppppp")
                if (((_a = _this9.transactionCodeData[i]) === null || _a === void 0 ? void 0 : _a.verifiedStatus) == 'U') {
                  // console.log("UnAUthorized");
                  _this9.unAUthorizedUsers.push(_this9.transactionCodeData[i]);
          ...
          value: function getRecords(event, data, index) {
            ...
            this.api.gettingTransactionDatabyID(data.userId).subscribe(function (trndataResp) {
              _this10.transactionDataResp = trndataResp;
              console.log("this.transactionDataResp", _this10.transactionDataResp); //  this.unAUthorizedUsers=this.unAUthorizedUsers.length-1;

              _this10.seenData.push(_this10.transactionDataResp); // console.log(this.seenData);


              if (_this10.seenData) {
                // console.log("Seen Data Present");
                _this10.getNotifyCount(index);
              }

              if (_this10.transactionDataResp) {
                _this10.api.setSummaryDataTransactionCode({
                  userID: data.userId,
                  ...
                  formValues: _this10.transactionDataResp
                });

                _this10.router.navigate(["/system-param-maintenance/transaction-code-edit"]);
              }
            });
          }
        }]);
      ...
      _HeaderComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵdefineComponent"]({
        ...
        template: function HeaderComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵtext"](32, " \xA0\xA0 ");
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵtext"](36, " \xA0\xA0 ");
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵlistener"]("click", function HeaderComponent_Template_a_click_39_listener() {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵlistener"]("click", function HeaderComponent_Template_a_click_50_listener() {
              return ctx.closeAll();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵlistener"]("click", function HeaderComponent_Template_a_click_162_listener() {
              return ctx.openPopUp();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵlistener"]("click", function HeaderComponent_Template_a_click_182_listener() {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵlistener"]("click", function HeaderComponent_Template_a_click_186_listener() {
              return ctx.openPopUp();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵlistener"]("click", function HeaderComponent_Template_a_click_201_listener() {
              return ctx.closeAll();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵlistener"]("click", function HeaderComponent_Template_span_click_205_listener() {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵlistener"]("click", function HeaderComponent_Template_span_click_207_listener() {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵtext"](213, "\xA0\xA0\xA0\xA0\xA0 ");

            _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵelementStart"](214, "span", 71);

            _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵlistener"]("click", function HeaderComponent_Template_span_click_214_listener() {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵlistener"]("click", function HeaderComponent_Template_a_click_218_listener() {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵlistener"]("click", function HeaderComponent_Template_a_click_224_listener() {
              return ctx.logOut();
            });
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      function SidenavComponent_a_35_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵelementStart"](0, "a", 22);
      ...
      function SidenavComponent_a_47_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵelementStart"](0, "a", 22);
      ...
      function SidenavComponent_a_54_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵelementStart"](0, "a", 22);
      ...
      function SidenavComponent_a_64_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵelementStart"](0, "a", 22);
      ...
      function SidenavComponent_li_67_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵlistener"]("click", function SidenavComponent_li_67_Template_a_click_1_listener() {
            ...
            return ctx_r38.FunctionAccountBlock();
          });
      ...
      function SidenavComponent_a_69_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵelementStart"](0, "a", 22);
      ...
      function SidenavComponent_li_72_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵlistener"]("click", function SidenavComponent_li_72_Template_a_click_1_listener() {
            ...
            return ctx_r40.FunctionAmountBlock();
          });
      ...
      function SidenavComponent_a_74_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵelementStart"](0, "a", 22);
      ...
      var _c34 = "/account-closure-maintenance/account-closure-summary";
      ...
      var _SidenavComponent = /*#__PURE__*/function () {
        ...
        _createClass(_SidenavComponent, [{
          ...
          value: function ngOnInit() {
            ...
            setTimeout(function () {
              _this11.EnablescreenPermissions();

              var resizeObserver = new ResizeObserver(function (entries) {
                _this11.sidebarHeight = entries[0].target.clientHeight;

                var hideScrollbar = _this11.shouldHideSideScroll();

                if (_this11.isScrollbarHidden === hideScrollbar) return;
                _this11.isScrollbarHidden = hideScrollbar;

                _this11.toggleSideScrollbar(_this11.shouldHideSideScroll());
              });
                  ...
                  switch (_context.prev = _context.next) {
                    case 0:
                      this.roleService.fetchScreenData().subscribe(function (data) {
                        _this12.screendata = data;

                        _this12.screendata.push('amount block'); // console.log(data);
                        // console.log(this.screendata);


                        _this12.screendata.forEach(function (element) {
                          //admin
                          if (element === 'Dashboard') {
                            //  const rolescreen = true;
                            _this12.dashboardscreen = true; // console.log('rolescreen', rolescreen)
                          }

                          if (element === 'Roles') {
                            //  const rolescreen = true;
                            _this12.rolescreen = true; // console.log('rolescreen', rolescreen)
                          }

                          if (element == 'Users') {
                            _this12.userScreen = true;
                          }

                          if (element === 'Audit Logs') {
                            _this12.auditScreen = true;
                          }

                          if (element === 'Password Policy') {
                            _this12.passPolicy = true;
                          }
                          ...
                          if (element === 'Department Id Maintenance') {
                            _this12.deptcodeMaint = true;
                          }

                          if (element === 'Transaction Code Maint') {
                            _this12.trncodeMaint = true;
                          }

                          if (element === 'AcumenJournal') {
                            _this12.acumenjournal = true;
                          }

                          if (element === 'Process Monitoring') {
                            _this12.processMonitor = true;
                          }

                          if (element === 'External Systems') {
                            _this12.extSystem = true;
                          }

                          if (element === 'Process Code Mapping') {
                            _this12.processCodeMapping = true;
                          }

                          if (element === 'Excel Mapping') {
                            _this12.excelMapping = true;
                          }

                          if (element === 'Upload Excel') {
                            _this12.uploadExcel = true;
                          }

                          if (element === 'Process Excel') {
                            _this12.processExcel = true;
                          }

                          if (element === 'Modify Excel') {
                            _this12.modifyExcel = true;
                          }

                          if (element === 'Authorize Modifications') {
                            _this12.authModification = true;
                          }

                          if (element === 'Customer search') {
                            _this12.customerSearch = true;
                          } //code maintenance


                          if (element === 'Email-Management') {
                            _this12.emailManagement = true;
                          } //account closer


                          if (element === 'Initiate Account Closure') {
                            _this12.initialAccountCloser = true;
                          }

                          if (element === 'Process Account Closure') {
                            _this12.ProcessAccountCloser = true;
                          }

                          if (element === 'Acc Closure Maintenance') {
                            _this12.acClosermaint = true;
                          }

                          if (element === 'Charge Maintenance') {
                            _this12.chargeMaintenance = true;
                          }
                        });
      ...
      var _LayoutService = /*#__PURE__*/function () {
        function _LayoutService(router, breakpointObserver) {
          ...
          this.isLtLg = function () {
            return _this15.breakpointObserver.isMatched("(max-width: 1279px)");
          };

          this.isMobile = function () {
            return _this15.breakpointObserver.isMatched("(max-width: 599px)");
          };
        }
        ...
        _createClass(_AppComponent, [{
          ...
          value: function (_setTimeout) {
            ...
            this.userActivity = setTimeout(function () {
              return _this17.userInactive.next(undefined);
          ...
          value: function changeTheme() {
            ...
            $(document).on('click', '.tColor', function (e) {
              e.preventDefault();
              var bgClass = $(_this18).data("id");
              $(_this18).addClass('active').parent().siblings().find('.tColor').removeClass('active');
          ...
          value: function _check() {
            ...
            return this.jwtAuth.check().pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_1__.switchMap)(function (authenticated) {
              ...
              if (!authenticated) {
                ...
                _this19.router.navigate(["session/login"]); // Prevent the access
        ...
        _createClass(_JwtAuthService, [{
          ...
          value: function signin() {
            ...
            return (0, rxjs__WEBPACK_IMPORTED_MODULE_2__.of)({
              ...
              _this20.setUserAndToken(res.token, res.user, !!res);

              _this20.signingIn = true;
              return res;
          ...
          */
          ...
          value: function checkTokenIsValid() {
            ...
            return (0, rxjs__WEBPACK_IMPORTED_MODULE_2__.of)(_DEMO_USER).pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.map)(function (profile) {
              _this21.setUserAndToken(_this21.getJwtToken(), profile, true);

              _this21.signingIn = false;
              return profile;
            }), (0, rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.catchError)(function (error) {
        ...
        _createClass(_RoleService, [{
          ...
          value: function fetchNewRolePermissions(userIdLoggedIn) {
            ...
            this.http.get("".concat(this._fmosbaseURL, "/allRolePermissionForUser/").concat(userIdLoggedIn)).subscribe(function (data) {
              _this22.storeuserpermissions = data;
              localStorage.setItem('userPermissions', JSON.stringify(_this22.storeuserpermissions));
              console.log(_this22.storeuserpermissions);
            });
          } //dynamic roles
          ...
          value: function EnablescreenPermissions() {
            ...
            this.screenwisePermissions.next(permissionlist);
            this.screenwisePermissions.subscribe(function (message) {
              return _this23.screenpermissions = message;
            }); // console.log("screen permissions final", this.screenpermissions);
          }
        }]);
