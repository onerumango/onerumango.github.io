(function () {
  ...
  (self["webpackChunkmedian"] = self["webpackChunkmedian"] || []).push([["src_app_views_account-blocking_account-block_account-block_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      function AccountBlockingComponent_div_38_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function AccountBlockingComponent_div_39_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](0, "div", 4);
      ...
      function AccountBlockingComponent_div_44_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](0, "div", 26);
      ...
      function AccountBlockingComponent_div_45_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](0, "div", 4);
      ...
      function AccountBlockingComponent_div_47_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](0, "div", 4);
      ...
      function AccountBlockingComponent_div_48_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](0, "div", 4);
      ...
      function AccountBlockingComponent_div_49_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](0, "div", 4);
      ...
      function AccountBlockingComponent_div_54_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](0, "div", 4);
      ...
      var _AccountBlockingComponent = /*#__PURE__*/function () {
        ...
        _createClass(_AccountBlockingComponent, [{
          ...
          value: function onClickOfSubmit() {
            ...
            this.sendMailtoOpt.idnameValue = this.accountBlockForm.get("idnameValue").value;
            this.sendMailtoOpt.dobOfCustomer = this.accountBlockForm.get("dobOfCustomer").value;
            this.sendMailtoOpt.emailOfoperator = this.accountBlockForm.get("emailOfoperator").value;
            this.sendMailtoOpt.customerAddress = this.accountBlockForm.get("customerAddress").value;
            this.sendMailtoOpt.amountToBlock = this.accountBlockForm.get("amountToBlock").value;
            this.sendMailtoOpt.accountCurrency = this.accountBlockForm.get("accountCurrency").value;
            this.sendMailtoOpt.blockingstatus = this.accountBlockForm.get("blockingstatus").value;
      ...
      _AccountBlockingComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({
        ...
        template: function AccountBlockingComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("click", function AccountBlockingComponent_Template_button_click_66_listener() {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("click", function AccountBlockingComponent_Template_a_click_69_listener() {
              return ctx.exit();
            });
