...
let ChequeWithdrawalV2Page = class ChequeWithdrawalV2Page {
    ...
    upsertAccount(filteredResponseSavingAccount) {
        ...
        if (this.editMode) {
            ...
            (_d = this.form.get('chequeNumber')) === null || _d === void 0 ? void 0 : _d.patchValue(data === null || data === void 0 ? void 0 : data.chequeNumber);
            (_e = this.form.get('transactionAmount')) === null || _e === void 0 ? void 0 : _e.patchValue(data === null || data === void 0 ? void 0 : data.transactionAmount);
            (_f = this.form.get('remarks')) === null || _f === void 0 ? void 0 : _f.patchValue(data === null || data === void 0 ? void 0 : data.remarks);
            ...
            if (this.accountInfo.accountId != null) {
                (_l = this.form.get('accountNumber')) === null || _l === void 0 ? void 0 : _l.patchValue(this.accountInfo.accountId);
            }
            else {
